...
func (o *ParameterDefault) GetBooleanVariationValue() bool {
	if o == nil || o.BooleanVariationValue == nil {
		var ret bool
		return ret
	}
	return *o.BooleanVariationValue
}

// GetBooleanVariationValueOk returns a tuple with the BooleanVariationValue field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ParameterDefault) GetBooleanVariationValueOk() (*bool, bool) {
	if o == nil || o.BooleanVariationValue == nil {
		return nil, false
	}
	return o.BooleanVariationValue, true
}
...
// GetRuleClauseOk returns a tuple with the RuleClause field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ParameterDefault) GetRuleClauseOk() (*RuleClause, bool) {
	if o == nil || o.RuleClause == nil {
		return nil, false
	}
	return o.RuleClause, true
}
...
func (o ParameterDefault) MarshalJSON() ([]byte, error) {
	...
	if o.BooleanVariationValue != nil {
		toSerialize["booleanVariationValue"] = o.BooleanVariationValue
	}
	if o.RuleClause != nil {
		toSerialize["ruleClause"] = o.RuleClause
	}
...
func NewNullableParameterDefault(val *ParameterDefault) *NullableParameterDefault {
	return &NullableParameterDefault{value: val, isSet: true}
}
