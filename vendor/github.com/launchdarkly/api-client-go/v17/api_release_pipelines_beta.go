...
type ReleasePipelinesBetaApi interface {
...
If you want to delete a release pipeline that is currently the default, create a second release pipeline and set it as the default. Then delete the first release pipeline. To change the default release pipeline, use the [Update project](https://launchdarkly.com/docs/ld-docs/api/projects/patch-project) API to set the `defaultReleasePipelineKey`.
	...
	@return ApiDeleteReleasePipelineRequest
	*/
	DeleteReleasePipeline(ctx context.Context, projectKey string, pipelineKey string) ApiDeleteReleasePipelineRequest

	// DeleteReleasePipelineExecute executes the request
	DeleteReleasePipelineExecute(r ApiDeleteReleasePipelineRequest) (*http.Response, error)
...
- `env` is a string that matches an environment key. For example: `?filter=env:production`.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param projectKey The project key
	@return ApiGetAllReleasePipelinesRequest
	*/
	GetAllReleasePipelines(ctx context.Context, projectKey string) ApiGetAllReleasePipelinesRequest

	// GetAllReleasePipelinesExecute executes the request
	//  @return ReleasePipelineCollection
	GetAllReleasePipelinesExecute(r ApiGetAllReleasePipelinesRequest) (*ReleasePipelineCollection, *http.Response, error)
	...
	*/
	GetAllReleaseProgressionsForReleasePipeline(ctx context.Context, projectKey string, pipelineKey string) ApiGetAllReleaseProgressionsForReleasePipelineRequest

	// GetAllReleaseProgressionsForReleasePipelineExecute executes the request
	//  @return ReleaseProgressionCollection
	GetAllReleaseProgressionsForReleasePipelineExecute(r ApiGetAllReleaseProgressionsForReleasePipelineRequest) (*ReleaseProgressionCollection, *http.Response, error)
	...
	@param projectKey The project key
	@param pipelineKey The release pipeline key
	@return ApiGetReleasePipelineByKeyRequest
	*/
	GetReleasePipelineByKey(ctx context.Context, projectKey string, pipelineKey string) ApiGetReleasePipelineByKeyRequest

	// GetReleasePipelineByKeyExecute executes the request
	//  @return ReleasePipeline
	GetReleasePipelineByKeyExecute(r ApiGetReleasePipelineByKeyRequest) (*ReleasePipeline, *http.Response, error)
...
You can create up to 20 release pipelines per project.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param projectKey The project key
	@return ApiPostReleasePipelineRequest
	*/
	PostReleasePipeline(ctx context.Context, projectKey string) ApiPostReleasePipelineRequest

	// PostReleasePipelineExecute executes the request
	//  @return ReleasePipeline
	PostReleasePipelineExecute(r ApiPostReleasePipelineRequest) (*ReleasePipeline, *http.Response, error)
	...
	@param projectKey The project key
	@param pipelineKey The release pipeline key
	@return ApiPutReleasePipelineRequest
	*/
	PutReleasePipeline(ctx context.Context, projectKey string, pipelineKey string) ApiPutReleasePipelineRequest

	// PutReleasePipelineExecute executes the request
	//  @return ReleasePipeline
	PutReleasePipelineExecute(r ApiPutReleasePipelineRequest) (*ReleasePipeline, *http.Response, error)
}

// ReleasePipelinesBetaApiService ReleasePipelinesBetaApi service
type ReleasePipelinesBetaApiService service

type ApiDeleteReleasePipelineRequest struct {
	ctx context.Context
	ApiService ReleasePipelinesBetaApi
	projectKey string
	pipelineKey string
}

func (r ApiDeleteReleasePipelineRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteReleasePipelineExecute(r)
}
...
func (a *ReleasePipelinesBetaApiService) DeleteReleasePipelineExecute(r ApiDeleteReleasePipelineRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReleasePipelinesBetaApiService.DeleteReleasePipeline")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/projects/{projectKey}/release-pipelines/{pipelineKey}"
...
type ApiGetAllReleasePipelinesRequest struct {
	ctx context.Context
	ApiService ReleasePipelinesBetaApi
	projectKey string
	filter *string
...
func (r ApiGetAllReleasePipelinesRequest) Execute() (*ReleasePipelineCollection, *http.Response, error) {
	return r.ApiService.GetAllReleasePipelinesExecute(r)
}
...
func (a *ReleasePipelinesBetaApiService) GetAllReleasePipelinesExecute(r ApiGetAllReleasePipelinesRequest) (*ReleasePipelineCollection, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ReleasePipelineCollection
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReleasePipelinesBetaApiService.GetAllReleasePipelines")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/projects/{projectKey}/release-pipelines"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterToString(r.projectKey, "")), -1)
...
func (r ApiGetReleasePipelineByKeyRequest) Execute() (*ReleasePipeline, *http.Response, error) {
	return r.ApiService.GetReleasePipelineByKeyExecute(r)
}
...
func (a *ReleasePipelinesBetaApiService) GetReleasePipelineByKeyExecute(r ApiGetReleasePipelineByKeyRequest) (*ReleasePipeline, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ReleasePipeline
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReleasePipelinesBetaApiService.GetReleasePipelineByKey")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiPostReleasePipelineRequest struct {
	ctx context.Context
	ApiService ReleasePipelinesBetaApi
	projectKey string
...
func (r ApiPostReleasePipelineRequest) CreateReleasePipelineInput(createReleasePipelineInput CreateReleasePipelineInput) ApiPostReleasePipelineRequest {
	r.createReleasePipelineInput = &createReleasePipelineInput
	return r
}

func (r ApiPostReleasePipelineRequest) Execute() (*ReleasePipeline, *http.Response, error) {
	return r.ApiService.PostReleasePipelineExecute(r)
}
...
func (a *ReleasePipelinesBetaApiService) PostReleasePipelineExecute(r ApiPostReleasePipelineRequest) (*ReleasePipeline, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReleasePipelinesBetaApiService.PostReleasePipeline")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createReleasePipelineInput == nil {
		return localVarReturnValue, nil, reportError("createReleasePipelineInput is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createReleasePipelineInput
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
...
type ApiPutReleasePipelineRequest struct {
	ctx context.Context
	ApiService ReleasePipelinesBetaApi
	projectKey string
	pipelineKey string
...
func (r ApiPutReleasePipelineRequest) UpdateReleasePipelineInput(updateReleasePipelineInput UpdateReleasePipelineInput) ApiPutReleasePipelineRequest {
	r.updateReleasePipelineInput = &updateReleasePipelineInput
	return r
}

func (r ApiPutReleasePipelineRequest) Execute() (*ReleasePipeline, *http.Response, error) {
	return r.ApiService.PutReleasePipelineExecute(r)
}
...
Updates a release pipeline.
 ...
 @return ApiPutReleasePipelineRequest
*/
func (a *ReleasePipelinesBetaApiService) PutReleasePipeline(ctx context.Context, projectKey string, pipelineKey string) ApiPutReleasePipelineRequest {
	return ApiPutReleasePipelineRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return ReleasePipeline
func (a *ReleasePipelinesBetaApiService) PutReleasePipelineExecute(r ApiPutReleasePipelineRequest) (*ReleasePipeline, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ReleasePipelinesBetaApiService.PutReleasePipeline")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updateReleasePipelineInput == nil {
		return localVarReturnValue, nil, reportError("updateReleasePipelineInput is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateReleasePipelineInput
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
