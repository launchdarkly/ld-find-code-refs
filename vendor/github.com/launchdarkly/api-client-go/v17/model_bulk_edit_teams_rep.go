...
// GetTeamKeysOk returns a tuple with the TeamKeys field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
func NewNullableBulkEditTeamsRep(val *BulkEditTeamsRep) *NullableBulkEditTeamsRep {
	return &NullableBulkEditTeamsRep{value: val, isSet: true}
}
