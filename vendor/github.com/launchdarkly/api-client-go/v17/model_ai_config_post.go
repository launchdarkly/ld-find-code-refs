...
// AIConfigPost struct for AIConfigPost
...
type NullableAIConfigPost struct {
	value *AIConfigPost
	isSet bool
}

func (v NullableAIConfigPost) Get() *AIConfigPost {
	return v.value
}

func (v *NullableAIConfigPost) Set(val *AIConfigPost) {
	v.value = val
	v.isSet = true
}

func (v NullableAIConfigPost) IsSet() bool {
	return v.isSet
}

func (v *NullableAIConfigPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAIConfigPost(val *AIConfigPost) *NullableAIConfigPost {
	return &NullableAIConfigPost{value: val, isSet: true}
}

func (v NullableAIConfigPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAIConfigPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
