...
// AIConfigVariationPatch struct for AIConfigVariationPatch
type AIConfigVariationPatch struct {
...
func (o AIConfigVariationPatch) MarshalJSON() ([]byte, error) {
...
type NullableAIConfigVariationPatch struct {
	value *AIConfigVariationPatch
	isSet bool
}

func (v NullableAIConfigVariationPatch) Get() *AIConfigVariationPatch {
	return v.value
}

func (v *NullableAIConfigVariationPatch) Set(val *AIConfigVariationPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableAIConfigVariationPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableAIConfigVariationPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAIConfigVariationPatch(val *AIConfigVariationPatch) *NullableAIConfigVariationPatch {
	return &NullableAIConfigVariationPatch{value: val, isSet: true}
}

func (v NullableAIConfigVariationPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAIConfigVariationPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
