...
// SetLinks gets a reference to the given ParentAndSelfLinks and assigns it to the Links field.
...
// SetMaintainer gets a reference to the given AIConfigMaintainer and assigns it to the Maintainer field.
...
type NullableAIConfig struct {
	value *AIConfig
	isSet bool
}

func (v NullableAIConfig) Get() *AIConfig {
	return v.value
}

func (v *NullableAIConfig) Set(val *AIConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableAIConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableAIConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAIConfig(val *AIConfig) *NullableAIConfig {
	return &NullableAIConfig{value: val, isSet: true}
}

func (v NullableAIConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAIConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
