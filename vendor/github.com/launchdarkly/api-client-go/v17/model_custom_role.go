...
type CustomRole struct {
	...
	AssignedTo *AssignedToRep `json:"assignedTo,omitempty"`
	// If created from a preset, the preset bundle version
	PresetBundleVersion *int32 `json:"_presetBundleVersion,omitempty"`
	// If created from a preset, the read-only statements copied from the preset
	PresetStatements []Statement `json:"_presetStatements,omitempty"`
}
...
func (o *CustomRole) GetResourceCategory() string {
	if o == nil || o.ResourceCategory == nil {
		var ret string
		return ret
	}
...
// GetResourceCategoryOk returns a tuple with the ResourceCategory field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetResourceCategory gets a reference to the given string and assigns it to the ResourceCategory field.
...
// SetAssignedTo gets a reference to the given AssignedToRep and assigns it to the AssignedTo field.
func (o *CustomRole) SetAssignedTo(v AssignedToRep) {
	o.AssignedTo = &v
}

// GetPresetBundleVersion returns the PresetBundleVersion field value if set, zero value otherwise.
func (o *CustomRole) GetPresetBundleVersion() int32 {
	if o == nil || o.PresetBundleVersion == nil {
		var ret int32
		return ret
	}
	return *o.PresetBundleVersion
}

// GetPresetBundleVersionOk returns a tuple with the PresetBundleVersion field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CustomRole) GetPresetBundleVersionOk() (*int32, bool) {
	if o == nil || o.PresetBundleVersion == nil {
		return nil, false
	}
	return o.PresetBundleVersion, true
}
...
// SetPresetBundleVersion gets a reference to the given int32 and assigns it to the PresetBundleVersion field.
func (o *CustomRole) SetPresetBundleVersion(v int32) {
	o.PresetBundleVersion = &v
}

// GetPresetStatements returns the PresetStatements field value if set, zero value otherwise.
func (o *CustomRole) GetPresetStatements() []Statement {
	if o == nil || o.PresetStatements == nil {
		var ret []Statement
		return ret
	}
	return o.PresetStatements
}

// GetPresetStatementsOk returns a tuple with the PresetStatements field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CustomRole) GetPresetStatementsOk() ([]Statement, bool) {
	if o == nil || o.PresetStatements == nil {
		return nil, false
	}
	return o.PresetStatements, true
}
...
// SetPresetStatements gets a reference to the given []Statement and assigns it to the PresetStatements field.
func (o *CustomRole) SetPresetStatements(v []Statement) {
	o.PresetStatements = v
}
...
func (o CustomRole) MarshalJSON() ([]byte, error) {
	...
	if o.ResourceCategory != nil {
		toSerialize["resourceCategory"] = o.ResourceCategory
	}
	if o.AssignedTo != nil {
		toSerialize["assignedTo"] = o.AssignedTo
	}
	if o.PresetBundleVersion != nil {
		toSerialize["_presetBundleVersion"] = o.PresetBundleVersion
	}
	if o.PresetStatements != nil {
		toSerialize["_presetStatements"] = o.PresetStatements
	}
