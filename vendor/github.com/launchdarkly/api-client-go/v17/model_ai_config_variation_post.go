...
// AIConfigVariationPost struct for AIConfigVariationPost
type AIConfigVariationPost struct {
	Key string `json:"key"`
...
func (o AIConfigVariationPost) MarshalJSON() ([]byte, error) {
...
type NullableAIConfigVariationPost struct {
	value *AIConfigVariationPost
	isSet bool
}

func (v NullableAIConfigVariationPost) Get() *AIConfigVariationPost {
	return v.value
}

func (v *NullableAIConfigVariationPost) Set(val *AIConfigVariationPost) {
	v.value = val
	v.isSet = true
}

func (v NullableAIConfigVariationPost) IsSet() bool {
	return v.isSet
}

func (v *NullableAIConfigVariationPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAIConfigVariationPost(val *AIConfigVariationPost) *NullableAIConfigVariationPost {
	return &NullableAIConfigVariationPost{value: val, isSet: true}
}

func (v NullableAIConfigVariationPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAIConfigVariationPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
