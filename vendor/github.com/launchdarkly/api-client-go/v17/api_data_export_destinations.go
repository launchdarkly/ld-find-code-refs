...
type DataExportDestinationsApi interface {
	...
	*/
	DeleteDestination(ctx context.Context, projectKey string, environmentKey string, id string) ApiDeleteDestinationRequest

	// DeleteDestinationExecute executes the request
	DeleteDestinationExecute(r ApiDeleteDestinationRequest) (*http.Response, error)
	...
	*/
	GetDestination(ctx context.Context, projectKey string, environmentKey string, id string) ApiGetDestinationRequest

	// GetDestinationExecute executes the request
	//  @return Destination
	GetDestinationExecute(r ApiGetDestinationRequest) (*Destination, *http.Response, error)
	...
	*/
	...
	//  @return Destinations
	GetDestinationsExecute(r ApiGetDestinationsRequest) (*Destinations, *http.Response, error)
	...
	*/
	PatchDestination(ctx context.Context, projectKey string, environmentKey string, id string) ApiPatchDestinationRequest

	// PatchDestinationExecute executes the request
	//  @return Destination
	PatchDestinationExecute(r ApiPatchDestinationRequest) (*Destination, *http.Response, error)
...
* `snowflakeHostAddress`: Your Snowflake account URL.
	...
	*/
	PostDestination(ctx context.Context, projectKey string, environmentKey string) ApiPostDestinationRequest

	// PostDestinationExecute executes the request
	//  @return Destination
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiPostGenerateWarehouseDestinationKeyPairRequest
	*/
	PostGenerateWarehouseDestinationKeyPair(ctx context.Context) ApiPostGenerateWarehouseDestinationKeyPairRequest

	// PostGenerateWarehouseDestinationKeyPairExecute executes the request
	//  @return GenerateWarehouseDestinationKeyPairPostRep
	PostGenerateWarehouseDestinationKeyPairExecute(r ApiPostGenerateWarehouseDestinationKeyPairRequest) (*GenerateWarehouseDestinationKeyPairPostRep, *http.Response, error)
}
...
func (a *DataExportDestinationsApiService) DeleteDestinationExecute(r ApiDeleteDestinationRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/destinations/{projectKey}/{environmentKey}/{id}"
...
func (r ApiPostDestinationRequest) DestinationPost(destinationPost DestinationPost) ApiPostDestinationRequest {
	r.destinationPost = &destinationPost
	return r
}
...
func (a *DataExportDestinationsApiService) PostDestinationExecute(r ApiPostDestinationRequest) (*Destination, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/destinations/{projectKey}/{environmentKey}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterToString(r.projectKey, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", url.PathEscape(parameterToString(r.environmentKey, "")), -1)
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.destinationPost == nil {
		return localVarReturnValue, nil, reportError("destinationPost is required and must be specified")
	}
...
type ApiPostGenerateWarehouseDestinationKeyPairRequest struct {
	ctx context.Context
	ApiService DataExportDestinationsApi
}

func (r ApiPostGenerateWarehouseDestinationKeyPairRequest) Execute() (*GenerateWarehouseDestinationKeyPairPostRep, *http.Response, error) {
	return r.ApiService.PostGenerateWarehouseDestinationKeyPairExecute(r)
}
...
Generate key pair to allow Data Export to authenticate into a Snowflake warehouse destination
 ...
 @return ApiPostGenerateWarehouseDestinationKeyPairRequest
*/
func (a *DataExportDestinationsApiService) PostGenerateWarehouseDestinationKeyPair(ctx context.Context) ApiPostGenerateWarehouseDestinationKeyPairRequest {
	return ApiPostGenerateWarehouseDestinationKeyPairRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return GenerateWarehouseDestinationKeyPairPostRep
func (a *DataExportDestinationsApiService) PostGenerateWarehouseDestinationKeyPairExecute(r ApiPostGenerateWarehouseDestinationKeyPairRequest) (*GenerateWarehouseDestinationKeyPairPostRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GenerateWarehouseDestinationKeyPairPostRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DataExportDestinationsApiService.PostGenerateWarehouseDestinationKeyPair")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/destinations/generate-warehouse-destination-key-pair"
