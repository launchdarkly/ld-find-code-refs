...
// CallerIdentityRep struct for CallerIdentityRep
type CallerIdentityRep struct {
...
// GetAuthKind returns the AuthKind field value if set, zero value otherwise.
func (o *CallerIdentityRep) GetAuthKind() string {
	if o == nil || o.AuthKind == nil {
		var ret string
		return ret
	}
	return *o.AuthKind
...
// GetAuthKindOk returns a tuple with the AuthKind field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CallerIdentityRep) GetAuthKindOk() (*string, bool) {
	if o == nil || o.AuthKind == nil {
		return nil, false
	}
	return o.AuthKind, true
}
...
// SetAuthKind gets a reference to the given string and assigns it to the AuthKind field.
func (o *CallerIdentityRep) SetAuthKind(v string) {
	o.AuthKind = &v
}

// GetTokenKind returns the TokenKind field value if set, zero value otherwise.
func (o *CallerIdentityRep) GetTokenKind() string {
	if o == nil || o.TokenKind == nil {
		var ret string
		return ret
	}
	return *o.TokenKind
...
// GetTokenKindOk returns a tuple with the TokenKind field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CallerIdentityRep) GetTokenKindOk() (*string, bool) {
	if o == nil || o.TokenKind == nil {
		return nil, false
	}
	return o.TokenKind, true
}
...
// SetTokenKind gets a reference to the given string and assigns it to the TokenKind field.
...
func (o CallerIdentityRep) MarshalJSON() ([]byte, error) {
	...
	if o.AuthKind != nil {
		toSerialize["authKind"] = o.AuthKind
	}
	if o.TokenKind != nil {
		toSerialize["tokenKind"] = o.TokenKind
	}
	if o.ClientId != nil {
...
type NullableCallerIdentityRep struct {
	value *CallerIdentityRep
	isSet bool
}

func (v NullableCallerIdentityRep) Get() *CallerIdentityRep {
	return v.value
}

func (v *NullableCallerIdentityRep) Set(val *CallerIdentityRep) {
	v.value = val
	v.isSet = true
}

func (v NullableCallerIdentityRep) IsSet() bool {
	return v.isSet
}

func (v *NullableCallerIdentityRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCallerIdentityRep(val *CallerIdentityRep) *NullableCallerIdentityRep {
	return &NullableCallerIdentityRep{value: val, isSet: true}
}

func (v NullableCallerIdentityRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCallerIdentityRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
