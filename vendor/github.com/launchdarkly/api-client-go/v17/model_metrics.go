...
type Metrics struct {
	...
	// Deprecated
	GenerationCount *int32 `json:"generationCount,omitempty"`
	// Number of successful generations
	GenerationSuccessCount *int32 `json:"generationSuccessCount,omitempty"`
	// Number of generations with errors
	GenerationErrorCount *int32 `json:"generationErrorCount,omitempty"`
	ThumbsUp *int32 `json:"thumbsUp,omitempty"`
	ThumbsDown *int32 `json:"thumbsDown,omitempty"`
	DurationMs *int32 `json:"durationMs,omitempty"`
	TimeToFirstTokenMs *int32 `json:"timeToFirstTokenMs,omitempty"`
	// A value between 0 and 1 representing satisfaction rating
	SatisfactionRating *float32 `json:"satisfactionRating,omitempty"`
...
// GetGenerationCount returns the GenerationCount field value if set, zero value otherwise.
// Deprecated
func (o *Metrics) GetGenerationCount() int32 {
	if o == nil || o.GenerationCount == nil {
		var ret int32
		return ret
	}
	return *o.GenerationCount
}

// GetGenerationCountOk returns a tuple with the GenerationCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
// Deprecated
...
// SetGenerationCount gets a reference to the given int32 and assigns it to the GenerationCount field.
// Deprecated
func (o *Metrics) SetGenerationCount(v int32) {
	o.GenerationCount = &v
}

// GetGenerationSuccessCount returns the GenerationSuccessCount field value if set, zero value otherwise.
func (o *Metrics) GetGenerationSuccessCount() int32 {
	if o == nil || o.GenerationSuccessCount == nil {
		var ret int32
		return ret
	}
	return *o.GenerationSuccessCount
}

// GetGenerationSuccessCountOk returns a tuple with the GenerationSuccessCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Metrics) GetGenerationSuccessCountOk() (*int32, bool) {
	if o == nil || o.GenerationSuccessCount == nil {
		return nil, false
	}
	return o.GenerationSuccessCount, true
}
...
// SetGenerationSuccessCount gets a reference to the given int32 and assigns it to the GenerationSuccessCount field.
func (o *Metrics) SetGenerationSuccessCount(v int32) {
	o.GenerationSuccessCount = &v
}

// GetGenerationErrorCount returns the GenerationErrorCount field value if set, zero value otherwise.
func (o *Metrics) GetGenerationErrorCount() int32 {
	if o == nil || o.GenerationErrorCount == nil {
		var ret int32
		return ret
	}
	return *o.GenerationErrorCount
}

// GetGenerationErrorCountOk returns a tuple with the GenerationErrorCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Metrics) GetGenerationErrorCountOk() (*int32, bool) {
	if o == nil || o.GenerationErrorCount == nil {
		return nil, false
	}
	return o.GenerationErrorCount, true
}
...
// SetGenerationErrorCount gets a reference to the given int32 and assigns it to the GenerationErrorCount field.
func (o *Metrics) SetGenerationErrorCount(v int32) {
	o.GenerationErrorCount = &v
}

// GetThumbsUp returns the ThumbsUp field value if set, zero value otherwise.
func (o *Metrics) GetThumbsUp() int32 {
	if o == nil || o.ThumbsUp == nil {
		var ret int32
		return ret
	}
	return *o.ThumbsUp
...
// GetThumbsUpOk returns a tuple with the ThumbsUp field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetThumbsUp gets a reference to the given int32 and assigns it to the ThumbsUp field.
func (o *Metrics) SetThumbsUp(v int32) {
	o.ThumbsUp = &v
}

// GetThumbsDown returns the ThumbsDown field value if set, zero value otherwise.
func (o *Metrics) GetThumbsDown() int32 {
	if o == nil || o.ThumbsDown == nil {
		var ret int32
		return ret
	}
	return *o.ThumbsDown
...
// GetThumbsDownOk returns a tuple with the ThumbsDown field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetThumbsDown gets a reference to the given int32 and assigns it to the ThumbsDown field.
...
// GetTimeToFirstTokenMs returns the TimeToFirstTokenMs field value if set, zero value otherwise.
func (o *Metrics) GetTimeToFirstTokenMs() int32 {
	if o == nil || o.TimeToFirstTokenMs == nil {
		var ret int32
		return ret
	}
	return *o.TimeToFirstTokenMs
}

// GetTimeToFirstTokenMsOk returns a tuple with the TimeToFirstTokenMs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Metrics) GetTimeToFirstTokenMsOk() (*int32, bool) {
	if o == nil || o.TimeToFirstTokenMs == nil {
		return nil, false
	}
	return o.TimeToFirstTokenMs, true
}
...
// SetTimeToFirstTokenMs gets a reference to the given int32 and assigns it to the TimeToFirstTokenMs field.
func (o *Metrics) SetTimeToFirstTokenMs(v int32) {
	o.TimeToFirstTokenMs = &v
}

// GetSatisfactionRating returns the SatisfactionRating field value if set, zero value otherwise.
func (o *Metrics) GetSatisfactionRating() float32 {
	if o == nil || o.SatisfactionRating == nil {
		var ret float32
		return ret
	}
	return *o.SatisfactionRating
}

// GetSatisfactionRatingOk returns a tuple with the SatisfactionRating field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Metrics) GetSatisfactionRatingOk() (*float32, bool) {
	if o == nil || o.SatisfactionRating == nil {
		return nil, false
	}
	return o.SatisfactionRating, true
}
...
// SetInputCost gets a reference to the given float64 and assigns it to the InputCost field.
...
// SetOutputCost gets a reference to the given float64 and assigns it to the OutputCost field.
...
func (o Metrics) MarshalJSON() ([]byte, error) {
	...
	if o.GenerationCount != nil {
		toSerialize["generationCount"] = o.GenerationCount
	}
	if o.GenerationSuccessCount != nil {
		toSerialize["generationSuccessCount"] = o.GenerationSuccessCount
	}
	if o.GenerationErrorCount != nil {
		toSerialize["generationErrorCount"] = o.GenerationErrorCount
	}
	if o.ThumbsUp != nil {
	...
	if o.TimeToFirstTokenMs != nil {
		toSerialize["timeToFirstTokenMs"] = o.TimeToFirstTokenMs
	}
	if o.SatisfactionRating != nil {
		toSerialize["satisfactionRating"] = o.SatisfactionRating
	}
	if o.InputCost != nil {
		toSerialize["inputCost"] = o.InputCost
	}
	if o.OutputCost != nil {
