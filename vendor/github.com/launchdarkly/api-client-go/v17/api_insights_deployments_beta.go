...
type InsightsDeploymentsBetaApi interface {
	...
	@return ApiCreateDeploymentEventRequest
	*/
	CreateDeploymentEvent(ctx context.Context) ApiCreateDeploymentEventRequest

	// CreateDeploymentEventExecute executes the request
	CreateDeploymentEventExecute(r ApiCreateDeploymentEventRequest) (*http.Response, error)
...
For example, use `?expand=pullRequests` to include the `pullRequests` field in the response. By default, this field is **not** included in the response.
	...
	*/
	GetDeployment(ctx context.Context, deploymentID string) ApiGetDeploymentRequest

	// GetDeploymentExecute executes the request
	//  @return DeploymentRep
	GetDeploymentExecute(r ApiGetDeploymentRequest) (*DeploymentRep, *http.Response, error)
...
For example, use `?expand=pullRequests` to include the `pullRequests` field in the response. By default, this field is **not** included in the response.
	...
	*/
	...
	GetDeploymentsExecute(r ApiGetDeploymentsRequest) (*DeploymentCollectionRep, *http.Response, error)
	...
	*/
	UpdateDeployment(ctx context.Context, deploymentID string) ApiUpdateDeploymentRequest

	// UpdateDeploymentExecute executes the request
	//  @return DeploymentRep
	UpdateDeploymentExecute(r ApiUpdateDeploymentRequest) (*DeploymentRep, *http.Response, error)
}

// InsightsDeploymentsBetaApiService InsightsDeploymentsBetaApi service
type InsightsDeploymentsBetaApiService service

type ApiCreateDeploymentEventRequest struct {
	ctx context.Context
	ApiService InsightsDeploymentsBetaApi
...
func (r ApiCreateDeploymentEventRequest) PostDeploymentEventInput(postDeploymentEventInput PostDeploymentEventInput) ApiCreateDeploymentEventRequest {
	r.postDeploymentEventInput = &postDeploymentEventInput
	return r
}

func (r ApiCreateDeploymentEventRequest) Execute() (*http.Response, error) {
	return r.ApiService.CreateDeploymentEventExecute(r)
}
...
func (a *InsightsDeploymentsBetaApiService) CreateDeploymentEventExecute(r ApiCreateDeploymentEventRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InsightsDeploymentsBetaApiService.CreateDeploymentEvent")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/engineering-insights/deployment-events"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.postDeploymentEventInput == nil {
		return nil, reportError("postDeploymentEventInput is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.postDeploymentEventInput
	if r.ctx != nil {
...
func (a *InsightsDeploymentsBetaApiService) GetDeploymentExecute(r ApiGetDeploymentRequest) (*DeploymentRep, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DeploymentRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InsightsDeploymentsBetaApiService.GetDeployment")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/engineering-insights/deployments/{deploymentID}"
...
func (a *InsightsDeploymentsBetaApiService) GetDeploymentsExecute(r ApiGetDeploymentsRequest) (*DeploymentCollectionRep, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DeploymentCollectionRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InsightsDeploymentsBetaApiService.GetDeployments")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/engineering-insights/deployments"
...
func (a *InsightsDeploymentsBetaApiService) UpdateDeploymentExecute(r ApiUpdateDeploymentRequest) (*DeploymentRep, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InsightsDeploymentsBetaApiService.UpdateDeployment")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
