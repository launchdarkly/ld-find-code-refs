...
func (o *ReviewOutput) GetServiceTokenId() string {
	if o == nil || o.ServiceTokenId == nil {
		var ret string
		return ret
	}
	return *o.ServiceTokenId
}

// GetServiceTokenIdOk returns a tuple with the ServiceTokenId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReviewOutput) GetServiceTokenIdOk() (*string, bool) {
	if o == nil || o.ServiceTokenId == nil {
		return nil, false
	}
	return o.ServiceTokenId, true
}
...
func NewNullableReviewOutput(val *ReviewOutput) *NullableReviewOutput {
	return &NullableReviewOutput{value: val, isSet: true}
}
