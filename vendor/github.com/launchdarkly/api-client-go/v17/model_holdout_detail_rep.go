...
// HoldoutDetailRep struct for HoldoutDetailRep
type HoldoutDetailRep struct {
	Id string `json:"_id"`
	Status string `json:"status"`
	Description *string `json:"description,omitempty"`
	// The percentage of traffic allocated to this holdout.
	HoldoutAmount string `json:"holdoutAmount"`
	...
	BaseExperiment Experiment `json:"baseExperiment"`
	RelatedExperiments []Experiment `json:"relatedExperiments,omitempty"`
}
...
// GetHoldoutAmount returns the HoldoutAmount field value
...
// GetHoldoutAmountOk returns a tuple with the HoldoutAmount field value
// and a boolean to check if the value has been set.
...
// SetHoldoutAmount sets field value
func (o *HoldoutDetailRep) SetHoldoutAmount(v string) {
	o.HoldoutAmount = v
}

// GetIsDirty returns the IsDirty field value if set, zero value otherwise.
func (o *HoldoutDetailRep) GetIsDirty() bool {
	if o == nil || o.IsDirty == nil {
		var ret bool
		return ret
	}
	return *o.IsDirty
...
// SetIsDirty gets a reference to the given bool and assigns it to the IsDirty field.
...
// GetBaseExperiment returns the BaseExperiment field value
func (o *HoldoutDetailRep) GetBaseExperiment() Experiment {
	...
	return o.BaseExperiment
}

// GetBaseExperimentOk returns a tuple with the BaseExperiment field value
// and a boolean to check if the value has been set.
func (o *HoldoutDetailRep) GetBaseExperimentOk() (*Experiment, bool) {
	if o == nil {
		return nil, false
	}
	return &o.BaseExperiment, true
}

// SetBaseExperiment sets field value
func (o *HoldoutDetailRep) SetBaseExperiment(v Experiment) {
	o.BaseExperiment = v
}

// GetRelatedExperiments returns the RelatedExperiments field value if set, zero value otherwise.
func (o *HoldoutDetailRep) GetRelatedExperiments() []Experiment {
	if o == nil || o.RelatedExperiments == nil {
		var ret []Experiment
		return ret
	}
	return o.RelatedExperiments
}

// GetRelatedExperimentsOk returns a tuple with the RelatedExperiments field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HoldoutDetailRep) GetRelatedExperimentsOk() ([]Experiment, bool) {
	if o == nil || o.RelatedExperiments == nil {
		return nil, false
	}
	return o.RelatedExperiments, true
}
...
// SetRelatedExperiments gets a reference to the given []Experiment and assigns it to the RelatedExperiments field.
func (o *HoldoutDetailRep) SetRelatedExperiments(v []Experiment) {
	o.RelatedExperiments = v
}

func (o HoldoutDetailRep) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["baseExperiment"] = o.BaseExperiment
	}
	if o.RelatedExperiments != nil {
		toSerialize["relatedExperiments"] = o.RelatedExperiments
	}
	return json.Marshal(toSerialize)
}

type NullableHoldoutDetailRep struct {
	value *HoldoutDetailRep
	isSet bool
}

func (v NullableHoldoutDetailRep) Get() *HoldoutDetailRep {
	return v.value
}

func (v *NullableHoldoutDetailRep) Set(val *HoldoutDetailRep) {
	v.value = val
	v.isSet = true
}

func (v NullableHoldoutDetailRep) IsSet() bool {
	return v.isSet
}

func (v *NullableHoldoutDetailRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHoldoutDetailRep(val *HoldoutDetailRep) *NullableHoldoutDetailRep {
	return &NullableHoldoutDetailRep{value: val, isSet: true}
}

func (v NullableHoldoutDetailRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHoldoutDetailRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
