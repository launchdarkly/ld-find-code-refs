...
LaunchDarkly uses a resource specifier syntax to name resources or collections of resources. To learn more, read [About the resource specifier syntax](https://launchdarkly.com/docs/home/account/role-resources#about-the-resource-specifier-syntax).
	...
	*/
	GetAuditLogEntries(ctx context.Context) ApiGetAuditLogEntriesRequest

	// GetAuditLogEntriesExecute executes the request
	//  @return AuditLogEntryListingRepCollection
	GetAuditLogEntriesExecute(r ApiGetAuditLogEntriesRequest) (*AuditLogEntryListingRepCollection, *http.Response, error)
...
- `currentVersion`: a JSON representation of the current version of the entity
	...
	*/
	GetAuditLogEntry(ctx context.Context, id string) ApiGetAuditLogEntryRequest

	// GetAuditLogEntryExecute executes the request
	//  @return AuditLogEntryRep
	GetAuditLogEntryExecute(r ApiGetAuditLogEntryRequest) (*AuditLogEntryRep, *http.Response, error)

	/*
	PostAuditLogEntries Search audit log entries
...
LaunchDarkly uses a resource specifier syntax to name resources or collections of resources. To learn more, read [About the resource specifier syntax](https://launchdarkly.com/docs/home/account/role-resources#about-the-resource-specifier-syntax).
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiPostAuditLogEntriesRequest
	*/
	PostAuditLogEntries(ctx context.Context) ApiPostAuditLogEntriesRequest
...
type ApiPostAuditLogEntriesRequest struct {
	ctx context.Context
	ApiService AuditLogApi
	before *int64
	after *int64
...
func (r ApiPostAuditLogEntriesRequest) Before(before int64) ApiPostAuditLogEntriesRequest {
	r.before = &before
	return r
}

// A timestamp filter, expressed as a Unix epoch time in milliseconds. All entries returned occurred after the timestamp.
func (r ApiPostAuditLogEntriesRequest) After(after int64) ApiPostAuditLogEntriesRequest {
	r.after = &after
	return r
}

// Text to search for. You can search for the full or partial name of the resource.
func (r ApiPostAuditLogEntriesRequest) Q(q string) ApiPostAuditLogEntriesRequest {
	r.q = &q
	return r
}

// A limit on the number of audit log entries that return. Set between 1 and 20. The default is 10.
func (r ApiPostAuditLogEntriesRequest) Limit(limit int64) ApiPostAuditLogEntriesRequest {
	r.limit = &limit
	return r
}

func (r ApiPostAuditLogEntriesRequest) StatementPost(statementPost []StatementPost) ApiPostAuditLogEntriesRequest {
	r.statementPost = &statementPost
	return r
}

func (r ApiPostAuditLogEntriesRequest) Execute() (*AuditLogEntryListingRepCollection, *http.Response, error) {
	return r.ApiService.PostAuditLogEntriesExecute(r)
}
...
LaunchDarkly uses a resource specifier syntax to name resources or collections of resources. To learn more, read [About the resource specifier syntax](https://launchdarkly.com/docs/home/account/role-resources#about-the-resource-specifier-syntax).
 ...
 @return ApiPostAuditLogEntriesRequest
*/
func (a *AuditLogApiService) PostAuditLogEntries(ctx context.Context) ApiPostAuditLogEntriesRequest {
	return ApiPostAuditLogEntriesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return AuditLogEntryListingRepCollection
func (a *AuditLogApiService) PostAuditLogEntriesExecute(r ApiPostAuditLogEntriesRequest) (*AuditLogEntryListingRepCollection, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuditLogApiService.PostAuditLogEntries")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
