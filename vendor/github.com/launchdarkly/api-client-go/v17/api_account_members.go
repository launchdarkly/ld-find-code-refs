...
type AccountMembersApi interface {
	...
	*/
	DeleteMember(ctx context.Context, id string) ApiDeleteMemberRequest

	// DeleteMemberExecute executes the request
	DeleteMemberExecute(r ApiDeleteMemberRequest) (*http.Response, error)
...
For example, `expand=roleAttributes` includes `roleAttributes` field in the response.
	...
	*/
	GetMember(ctx context.Context, id string) ApiGetMemberRequest

	// GetMemberExecute executes the request
	//  @return Member
	GetMemberExecute(r ApiGetMemberRequest) (*Member, *http.Response, error)
...
For example, `expand=roleAttributes` includes `roleAttributes` field in the response.
	...
	*/
	GetMembers(ctx context.Context) ApiGetMembersRequest

	// GetMembersExecute executes the request
	//  @return Members
	GetMembersExecute(r ApiGetMembersRequest) (*Members, *http.Response, error)
...
When SAML SSO or SCIM is enabled for the account, account members are managed in the Identity Provider (IdP). Requests to update account members will succeed, but the IdP will override the update shortly afterwards.
	...
	*/
	PatchMember(ctx context.Context, id string) ApiPatchMemberRequest

	// PatchMemberExecute executes the request
	//  @return Member
	PatchMemberExecute(r ApiPatchMemberRequest) (*Member, *http.Response, error)
	...
	*/
	PostMemberTeams(ctx context.Context, id string) ApiPostMemberTeamsRequest

	// PostMemberTeamsExecute executes the request
	//  @return Member
	PostMemberTeamsExecute(r ApiPostMemberTeamsRequest) (*Member, *http.Response, error)
...
A request that fails for one of the above reasons returns an HTTP response code of 400 (Bad Request).
	...
	*/
	PostMembers(ctx context.Context) ApiPostMembersRequest

	// PostMembersExecute executes the request
	//  @return Members
	PostMembersExecute(r ApiPostMembersRequest) (*Members, *http.Response, error)
}
...
func (a *AccountMembersApiService) DeleteMemberExecute(r ApiDeleteMemberRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountMembersApiService.DeleteMember")
	if err != nil {
...
func (r ApiGetMemberRequest) Expand(expand string) ApiGetMemberRequest {
	r.expand = &expand
	return r
}
...
func (a *AccountMembersApiService) GetMemberExecute(r ApiGetMemberRequest) (*Member, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountMembersApiService.GetMember")
	if err != nil {
...
// A comma-separated list of properties that can reveal additional information in the response.
func (r ApiGetMembersRequest) Expand(expand string) ApiGetMembersRequest {
	r.expand = &expand
	return r
}
...
func (a *AccountMembersApiService) GetMembersExecute(r ApiGetMembersRequest) (*Members, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountMembersApiService.GetMembers")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *AccountMembersApiService) PatchMemberExecute(r ApiPatchMemberRequest) (*Member, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountMembersApiService.PatchMember")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiPostMemberTeamsRequest) Execute() (*Member, *http.Response, error) {
	return r.ApiService.PostMemberTeamsExecute(r)
}
...
func (a *AccountMembersApiService) PostMemberTeamsExecute(r ApiPostMemberTeamsRequest) (*Member, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountMembersApiService.PostMemberTeams")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/members/{id}/teams"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterToString(r.id, "")), -1)
...
func (a *AccountMembersApiService) PostMembersExecute(r ApiPostMembersRequest) (*Members, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountMembersApiService.PostMembers")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.newMemberForm == nil {
		return localVarReturnValue, nil, reportError("newMemberForm is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.newMemberForm
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
