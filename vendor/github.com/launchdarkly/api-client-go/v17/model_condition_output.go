...
// GetNotifyMemberIdsOk returns a tuple with the NotifyMemberIds field value
// and a boolean to check if the value has been set.
...
// GetAllReviewsOk returns a tuple with the AllReviews field value
// and a boolean to check if the value has been set.
...
func (o ConditionOutput) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["_execution"] = o.Execution
	}
...
func NewNullableConditionOutput(val *ConditionOutput) *NullableConditionOutput {
	return &NullableConditionOutput{value: val, isSet: true}
}
