...
// PhaseInfo struct for PhaseInfo
...
// GetReleaseCount returns the ReleaseCount field value
...
// GetReleaseCountOk returns a tuple with the ReleaseCount field value
// and a boolean to check if the value has been set.
...
// SetReleaseCount sets field value
func (o *PhaseInfo) SetReleaseCount(v int32) {
	o.ReleaseCount = v
}

func (o PhaseInfo) MarshalJSON() ([]byte, error) {
...
type NullablePhaseInfo struct {
	value *PhaseInfo
	isSet bool
}

func (v NullablePhaseInfo) Get() *PhaseInfo {
	return v.value
}

func (v *NullablePhaseInfo) Set(val *PhaseInfo) {
	v.value = val
	v.isSet = true
}

func (v NullablePhaseInfo) IsSet() bool {
	return v.isSet
}

func (v *NullablePhaseInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePhaseInfo(val *PhaseInfo) *NullablePhaseInfo {
	return &NullablePhaseInfo{value: val, isSet: true}
}

func (v NullablePhaseInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePhaseInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
