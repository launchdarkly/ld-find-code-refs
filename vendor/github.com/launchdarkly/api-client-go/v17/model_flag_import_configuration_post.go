...
// FlagImportConfigurationPost struct for FlagImportConfigurationPost
type FlagImportConfigurationPost struct {
...
func NewFlagImportConfigurationPost(config map[string]interface{}) *FlagImportConfigurationPost {
	this := FlagImportConfigurationPost{}
	this.Config = config
	return &this
}
...
func (o FlagImportConfigurationPost) MarshalJSON() ([]byte, error) {
...
type NullableFlagImportConfigurationPost struct {
	value *FlagImportConfigurationPost
	isSet bool
}

func (v NullableFlagImportConfigurationPost) Get() *FlagImportConfigurationPost {
	return v.value
}

func (v *NullableFlagImportConfigurationPost) Set(val *FlagImportConfigurationPost) {
	v.value = val
	v.isSet = true
}

func (v NullableFlagImportConfigurationPost) IsSet() bool {
	return v.isSet
}

func (v *NullableFlagImportConfigurationPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlagImportConfigurationPost(val *FlagImportConfigurationPost) *NullableFlagImportConfigurationPost {
	return &NullableFlagImportConfigurationPost{value: val, isSet: true}
}

func (v NullableFlagImportConfigurationPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlagImportConfigurationPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
