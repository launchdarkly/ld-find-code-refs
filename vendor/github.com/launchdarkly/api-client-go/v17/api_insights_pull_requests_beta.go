...
type InsightsPullRequestsBetaApi interface {
...
For example, use `?expand=deployments` to include the `deployments` field in the response. By default, this field is **not** included in the response.
	...
	*/
	GetPullRequests(ctx context.Context) ApiGetPullRequestsRequest

	// GetPullRequestsExecute executes the request
	//  @return PullRequestCollectionRep
	GetPullRequestsExecute(r ApiGetPullRequestsRequest) (*PullRequestCollectionRep, *http.Response, error)
}
...
type ApiGetPullRequestsRequest struct {
	ctx context.Context
	ApiService InsightsPullRequestsBetaApi
	projectKey *string
...
func (a *InsightsPullRequestsBetaApiService) GetPullRequestsExecute(r ApiGetPullRequestsRequest) (*PullRequestCollectionRep, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *PullRequestCollectionRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InsightsPullRequestsBetaApiService.GetPullRequests")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/engineering-insights/pull-requests"
