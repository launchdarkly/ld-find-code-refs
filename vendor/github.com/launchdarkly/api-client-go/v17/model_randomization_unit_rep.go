...
type RandomizationUnitRep struct {
	...
	StandardRandomizationUnit *string `json:"standardRandomizationUnit,omitempty"`
	...
	DisplayName *string `json:"_displayName,omitempty"`
}
...
func (o *RandomizationUnitRep) GetStandardRandomizationUnit() string {
	if o == nil || o.StandardRandomizationUnit == nil {
		var ret string
		return ret
	}
	return *o.StandardRandomizationUnit
}

// GetStandardRandomizationUnitOk returns a tuple with the StandardRandomizationUnit field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RandomizationUnitRep) GetStandardRandomizationUnitOk() (*string, bool) {
	if o == nil || o.StandardRandomizationUnit == nil {
		return nil, false
	}
	return o.StandardRandomizationUnit, true
}
...
func (o RandomizationUnitRep) MarshalJSON() ([]byte, error) {
	...
	if o.StandardRandomizationUnit != nil {
		toSerialize["standardRandomizationUnit"] = o.StandardRandomizationUnit
	}
	if o.Default != nil {
		toSerialize["default"] = o.Default
	}
	if o.Hidden != nil {
		toSerialize["_hidden"] = o.Hidden
	}
	if o.DisplayName != nil {
		toSerialize["_displayName"] = o.DisplayName
	}
	return json.Marshal(toSerialize)
}

type NullableRandomizationUnitRep struct {
	value *RandomizationUnitRep
	isSet bool
}
...
func NewNullableRandomizationUnitRep(val *RandomizationUnitRep) *NullableRandomizationUnitRep {
	return &NullableRandomizationUnitRep{value: val, isSet: true}
}
