...
type FlagLinksBetaApi interface {
	...
	*/
	CreateFlagLink(ctx context.Context, projectKey string, featureFlagKey string) ApiCreateFlagLinkRequest

	// CreateFlagLinkExecute executes the request
	//  @return FlagLinkRep
	CreateFlagLinkExecute(r ApiCreateFlagLinkRequest) (*FlagLinkRep, *http.Response, error)
	...
	*/
	DeleteFlagLink(ctx context.Context, projectKey string, featureFlagKey string, id string) ApiDeleteFlagLinkRequest

	// DeleteFlagLinkExecute executes the request
	DeleteFlagLinkExecute(r ApiDeleteFlagLinkRequest) (*http.Response, error)
	...
	*/
	GetFlagLinks(ctx context.Context, projectKey string, featureFlagKey string) ApiGetFlagLinksRequest

	// GetFlagLinksExecute executes the request
	//  @return FlagLinkCollectionRep
	GetFlagLinksExecute(r ApiGetFlagLinksRequest) (*FlagLinkCollectionRep, *http.Response, error)
	...
	*/
	UpdateFlagLink(ctx context.Context, projectKey string, featureFlagKey string, id string) ApiUpdateFlagLinkRequest

	// UpdateFlagLinkExecute executes the request
	//  @return FlagLinkRep
	UpdateFlagLinkExecute(r ApiUpdateFlagLinkRequest) (*FlagLinkRep, *http.Response, error)
}
...
func (a *FlagLinksBetaApiService) CreateFlagLinkExecute(r ApiCreateFlagLinkRequest) (*FlagLinkRep, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *FlagLinkRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FlagLinksBetaApiService.CreateFlagLink")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/flag-links/projects/{projectKey}/flags/{featureFlagKey}"
	...
	if r.flagLinkPost == nil {
		return localVarReturnValue, nil, reportError("flagLinkPost is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.flagLinkPost
	if r.ctx != nil {
...
func (r ApiDeleteFlagLinkRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteFlagLinkExecute(r)
}
...
func (a *FlagLinksBetaApiService) DeleteFlagLinkExecute(r ApiDeleteFlagLinkRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FlagLinksBetaApiService.DeleteFlagLink")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/flag-links/projects/{projectKey}/flags/{featureFlagKey}/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterToString(r.projectKey, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagKey"+"}", url.PathEscape(parameterToString(r.featureFlagKey, "")), -1)
...
func (r ApiGetFlagLinksRequest) Execute() (*FlagLinkCollectionRep, *http.Response, error) {
	return r.ApiService.GetFlagLinksExecute(r)
}
...
func (a *FlagLinksBetaApiService) GetFlagLinksExecute(r ApiGetFlagLinksRequest) (*FlagLinkCollectionRep, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *FlagLinkCollectionRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FlagLinksBetaApiService.GetFlagLinks")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateFlagLinkRequest) Execute() (*FlagLinkRep, *http.Response, error) {
	return r.ApiService.UpdateFlagLinkExecute(r)
}
...
func (a *FlagLinksBetaApiService) UpdateFlagLinkExecute(r ApiUpdateFlagLinkRequest) (*FlagLinkRep, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FlagLinksBetaApiService.UpdateFlagLink")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
