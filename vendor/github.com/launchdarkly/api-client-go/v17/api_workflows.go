...
type WorkflowsApi interface {
	...
	*/
	DeleteWorkflow(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, workflowId string) ApiDeleteWorkflowRequest
	...
	*/
	GetCustomWorkflow(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, workflowId string) ApiGetCustomWorkflowRequest

	// GetCustomWorkflowExecute executes the request
	//  @return CustomWorkflowOutput
	GetCustomWorkflowExecute(r ApiGetCustomWorkflowRequest) (*CustomWorkflowOutput, *http.Response, error)
	...
	*/
	GetWorkflows(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string) ApiGetWorkflowsRequest

	// GetWorkflowsExecute executes the request
	//  @return CustomWorkflowsListingOutput
	GetWorkflowsExecute(r ApiGetWorkflowsRequest) (*CustomWorkflowsListingOutput, *http.Response, error)
...
If there are any steps in the template that are not applicable to the target resource, the workflow will not be created, and the `meta` property will be included in the response body detailing which parameters need to be updated.
	...
	*/
	PostWorkflow(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string) ApiPostWorkflowRequest

	// PostWorkflowExecute executes the request
	//  @return CustomWorkflowOutput
	PostWorkflowExecute(r ApiPostWorkflowRequest) (*CustomWorkflowOutput, *http.Response, error)
}
...
func (a *WorkflowsApiService) DeleteWorkflowExecute(r ApiDeleteWorkflowRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/workflows/{workflowId}"
	...
	localVarPath = strings.Replace(localVarPath, "{"+"workflowId"+"}", url.PathEscape(parameterToString(r.workflowId, "")), -1)
...
func (r ApiGetCustomWorkflowRequest) Execute() (*CustomWorkflowOutput, *http.Response, error) {
	return r.ApiService.GetCustomWorkflowExecute(r)
}
...
func (a *WorkflowsApiService) GetCustomWorkflowExecute(r ApiGetCustomWorkflowRequest) (*CustomWorkflowOutput, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CustomWorkflowOutput
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsApiService.GetCustomWorkflow")
	if err != nil {
...
func (r ApiGetWorkflowsRequest) Limit(limit int64) ApiGetWorkflowsRequest {
	r.limit = &limit
	return r
}
...
func (r ApiGetWorkflowsRequest) Offset(offset int64) ApiGetWorkflowsRequest {
	r.offset = &offset
	return r
}
...
func (a *WorkflowsApiService) GetWorkflowsExecute(r ApiGetWorkflowsRequest) (*CustomWorkflowsListingOutput, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CustomWorkflowsListingOutput
	)
	...
	localVarPath := localBasePath + "/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/workflows"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterToString(r.projectKey, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagKey"+"}", url.PathEscape(parameterToString(r.featureFlagKey, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", url.PathEscape(parameterToString(r.environmentKey, "")), -1)
...
func (r ApiPostWorkflowRequest) CustomWorkflowInput(customWorkflowInput CustomWorkflowInput) ApiPostWorkflowRequest {
	r.customWorkflowInput = &customWorkflowInput
	return r
}
...
func (a *WorkflowsApiService) PostWorkflowExecute(r ApiPostWorkflowRequest) (*CustomWorkflowOutput, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsApiService.PostWorkflow")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.customWorkflowInput == nil {
		return localVarReturnValue, nil, reportError("customWorkflowInput is required and must be specified")
	}

	if r.templateKey != nil {
		localVarQueryParams.Add("templateKey", parameterToString(*r.templateKey, ""))
	}
	if r.dryRun != nil {
	...
	// body params
	localVarPostBody = r.customWorkflowInput
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
