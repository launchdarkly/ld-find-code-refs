...
// TagsCollection struct for TagsCollection
type TagsCollection struct {
	// List of tags
	Items []string `json:"items"`
	Links map[string]TagsLink `json:"_links"`
...
func (o TagsCollection) MarshalJSON() ([]byte, error) {
...
type NullableTagsCollection struct {
	value *TagsCollection
	isSet bool
}

func (v NullableTagsCollection) Get() *TagsCollection {
	return v.value
}

func (v *NullableTagsCollection) Set(val *TagsCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableTagsCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableTagsCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagsCollection(val *TagsCollection) *NullableTagsCollection {
	return &NullableTagsCollection{value: val, isSet: true}
}

func (v NullableTagsCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagsCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
