...
type MetricGroupCollectionRep struct {
	// An array of metric groups
	Items []MetricGroupRep `json:"items"`
...
type NullableMetricGroupCollectionRep struct {
	value *MetricGroupCollectionRep
	isSet bool
}
...
func NewNullableMetricGroupCollectionRep(val *MetricGroupCollectionRep) *NullableMetricGroupCollectionRep {
	return &NullableMetricGroupCollectionRep{value: val, isSet: true}
}
