...
type IterationRep struct {
	...
	PrimaryMetric *DependentMetricOrMetricGroupRep `json:"primaryMetric,omitempty"`
	PrimarySingleMetric *MetricV2Rep `json:"primarySingleMetric,omitempty"`
	PrimaryFunnel *DependentMetricGroupRepWithMetrics `json:"primaryFunnel,omitempty"`
...
func (o *IterationRep) GetWinningTreatmentId() string {
	if o == nil || o.WinningTreatmentId == nil {
		var ret string
		return ret
	}
	return *o.WinningTreatmentId
}

// GetWinningTreatmentIdOk returns a tuple with the WinningTreatmentId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IterationRep) GetWinningTreatmentIdOk() (*string, bool) {
	if o == nil || o.WinningTreatmentId == nil {
		return nil, false
	}
	return o.WinningTreatmentId, true
}
...
func (o *IterationRep) GetCanReshuffleTraffic() bool {
	...
	return *o.CanReshuffleTraffic
}

// GetCanReshuffleTrafficOk returns a tuple with the CanReshuffleTraffic field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IterationRep) GetCanReshuffleTrafficOk() (*bool, bool) {
	if o == nil || o.CanReshuffleTraffic == nil {
		return nil, false
	}
	return o.CanReshuffleTraffic, true
}
...
func (o *IterationRep) GetPrimaryMetric() DependentMetricOrMetricGroupRep {
	if o == nil || o.PrimaryMetric == nil {
		var ret DependentMetricOrMetricGroupRep
		return ret
	}
...
func (o *IterationRep) GetPrimarySingleMetric() MetricV2Rep {
	if o == nil || o.PrimarySingleMetric == nil {
		var ret MetricV2Rep
		return ret
	}
	return *o.PrimarySingleMetric
}

// GetPrimarySingleMetricOk returns a tuple with the PrimarySingleMetric field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IterationRep) GetPrimarySingleMetricOk() (*MetricV2Rep, bool) {
	if o == nil || o.PrimarySingleMetric == nil {
		return nil, false
	}
	return o.PrimarySingleMetric, true
}
...
func (o *IterationRep) GetPrimaryFunnel() DependentMetricGroupRepWithMetrics {
	if o == nil || o.PrimaryFunnel == nil {
		var ret DependentMetricGroupRepWithMetrics
		return ret
	}
	return *o.PrimaryFunnel
}

// GetPrimaryFunnelOk returns a tuple with the PrimaryFunnel field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IterationRep) GetPrimaryFunnelOk() (*DependentMetricGroupRepWithMetrics, bool) {
	if o == nil || o.PrimaryFunnel == nil {
		return nil, false
	}
	return o.PrimaryFunnel, true
}
...
// GetLayerSnapshot returns the LayerSnapshot field value if set, zero value otherwise.
func (o *IterationRep) GetLayerSnapshot() LayerSnapshotRep {
	if o == nil || o.LayerSnapshot == nil {
		var ret LayerSnapshotRep
		return ret
	}
	return *o.LayerSnapshot
}

// GetLayerSnapshotOk returns a tuple with the LayerSnapshot field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IterationRep) GetLayerSnapshotOk() (*LayerSnapshotRep, bool) {
	if o == nil || o.LayerSnapshot == nil {
		return nil, false
	}
	return o.LayerSnapshot, true
}
...
// SetLayerSnapshot gets a reference to the given LayerSnapshotRep and assigns it to the LayerSnapshot field.
...
func (o IterationRep) MarshalJSON() ([]byte, error) {
	...
	if o.PrimarySingleMetric != nil {
		toSerialize["primarySingleMetric"] = o.PrimarySingleMetric
	}
	if o.PrimaryFunnel != nil {
		toSerialize["primaryFunnel"] = o.PrimaryFunnel
	}
...
func NewNullableIterationRep(val *IterationRep) *NullableIterationRep {
	return &NullableIterationRep{value: val, isSet: true}
}
