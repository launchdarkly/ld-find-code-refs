...
// ReleaserAudienceConfigInput struct for ReleaserAudienceConfigInput
type ReleaserAudienceConfigInput struct {
	// UUID of the audience.
	AudienceId *string `json:"audienceId,omitempty"`
	ReleaseGuardianConfiguration *ReleaseGuardianConfigurationInput `json:"releaseGuardianConfiguration,omitempty"`
...
func NewReleaserAudienceConfigInput() *ReleaserAudienceConfigInput {
	this := ReleaserAudienceConfigInput{}
	return &this
}
...
// GetReleaseGuardianConfiguration returns the ReleaseGuardianConfiguration field value if set, zero value otherwise.
func (o *ReleaserAudienceConfigInput) GetReleaseGuardianConfiguration() ReleaseGuardianConfigurationInput {
	if o == nil || o.ReleaseGuardianConfiguration == nil {
		var ret ReleaseGuardianConfigurationInput
		return ret
	}
	return *o.ReleaseGuardianConfiguration
}

// GetReleaseGuardianConfigurationOk returns a tuple with the ReleaseGuardianConfiguration field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReleaserAudienceConfigInput) GetReleaseGuardianConfigurationOk() (*ReleaseGuardianConfigurationInput, bool) {
	if o == nil || o.ReleaseGuardianConfiguration == nil {
		return nil, false
	}
	return o.ReleaseGuardianConfiguration, true
}
...
// SetReleaseGuardianConfiguration gets a reference to the given ReleaseGuardianConfigurationInput and assigns it to the ReleaseGuardianConfiguration field.
func (o *ReleaserAudienceConfigInput) SetReleaseGuardianConfiguration(v ReleaseGuardianConfigurationInput) {
	o.ReleaseGuardianConfiguration = &v
}
...
func (o *ReleaserAudienceConfigInput) GetNotifyTeamKeys() []string {
	if o == nil || o.NotifyTeamKeys == nil {
		var ret []string
		return ret
	}
	return o.NotifyTeamKeys
}

// GetNotifyTeamKeysOk returns a tuple with the NotifyTeamKeys field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReleaserAudienceConfigInput) GetNotifyTeamKeysOk() ([]string, bool) {
	if o == nil || o.NotifyTeamKeys == nil {
		return nil, false
	}
	return o.NotifyTeamKeys, true
}
...
func (o ReleaserAudienceConfigInput) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.AudienceId != nil {
		toSerialize["audienceId"] = o.AudienceId
	}
	if o.ReleaseGuardianConfiguration != nil {
		toSerialize["releaseGuardianConfiguration"] = o.ReleaseGuardianConfiguration
	}
	if o.NotifyMemberIds != nil {
		toSerialize["notifyMemberIds"] = o.NotifyMemberIds
	}
	if o.NotifyTeamKeys != nil {
		toSerialize["notifyTeamKeys"] = o.NotifyTeamKeys
	}
	return json.Marshal(toSerialize)
}

type NullableReleaserAudienceConfigInput struct {
	value *ReleaserAudienceConfigInput
	isSet bool
}

func (v NullableReleaserAudienceConfigInput) Get() *ReleaserAudienceConfigInput {
	return v.value
}

func (v *NullableReleaserAudienceConfigInput) Set(val *ReleaserAudienceConfigInput) {
	v.value = val
	v.isSet = true
}

func (v NullableReleaserAudienceConfigInput) IsSet() bool {
	return v.isSet
}

func (v *NullableReleaserAudienceConfigInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReleaserAudienceConfigInput(val *ReleaserAudienceConfigInput) *NullableReleaserAudienceConfigInput {
	return &NullableReleaserAudienceConfigInput{value: val, isSet: true}
}

func (v NullableReleaserAudienceConfigInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReleaserAudienceConfigInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
