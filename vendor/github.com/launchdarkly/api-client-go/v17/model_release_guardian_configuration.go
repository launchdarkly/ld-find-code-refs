...
// ReleaseGuardianConfiguration struct for ReleaseGuardianConfiguration
type ReleaseGuardianConfiguration struct {
	// The monitoring window in milliseconds
	MonitoringWindowMilliseconds int64 `json:"monitoringWindowMilliseconds"`
	// The rollout weight percentage
	RolloutWeight int32 `json:"rolloutWeight"`
...
// GetMonitoringWindowMilliseconds returns the MonitoringWindowMilliseconds field value
...
// GetMonitoringWindowMillisecondsOk returns a tuple with the MonitoringWindowMilliseconds field value
...
// GetRolloutWeightOk returns a tuple with the RolloutWeight field value
// and a boolean to check if the value has been set.
...
// SetRolloutWeight sets field value
...
func (o ReleaseGuardianConfiguration) MarshalJSON() ([]byte, error) {
...
type NullableReleaseGuardianConfiguration struct {
	value *ReleaseGuardianConfiguration
	isSet bool
}

func (v NullableReleaseGuardianConfiguration) Get() *ReleaseGuardianConfiguration {
	return v.value
}

func (v *NullableReleaseGuardianConfiguration) Set(val *ReleaseGuardianConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableReleaseGuardianConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableReleaseGuardianConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReleaseGuardianConfiguration(val *ReleaseGuardianConfiguration) *NullableReleaseGuardianConfiguration {
	return &NullableReleaseGuardianConfiguration{value: val, isSet: true}
}

func (v NullableReleaseGuardianConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReleaseGuardianConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
