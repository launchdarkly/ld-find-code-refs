...
// GetTrueDisplayNameOk returns a tuple with the TrueDisplayName field value
...
// GetFalseDisplayNameOk returns a tuple with the FalseDisplayName field value
// and a boolean to check if the value has been set.
...
// GetTrueDescriptionOk returns a tuple with the TrueDescription field value
// and a boolean to check if the value has been set.
...
// GetFalseDescriptionOk returns a tuple with the FalseDescription field value
// and a boolean to check if the value has been set.
...
// GetOnVariationOk returns a tuple with the OnVariation field value
// and a boolean to check if the value has been set.
...
// GetOffVariationOk returns a tuple with the OffVariation field value
// and a boolean to check if the value has been set.
...
func NewNullableBooleanFlagDefaults(val *BooleanFlagDefaults) *NullableBooleanFlagDefaults {
	return &NullableBooleanFlagDefaults{value: val, isSet: true}
}
