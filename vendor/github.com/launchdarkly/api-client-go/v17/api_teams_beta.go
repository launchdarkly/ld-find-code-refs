...
```
	...
	*/
	PatchTeams(ctx context.Context) ApiPatchTeamsRequest

	// PatchTeamsExecute executes the request
	//  @return BulkEditTeamsRep
	PatchTeamsExecute(r ApiPatchTeamsRequest) (*BulkEditTeamsRep, *http.Response, error)
}
...
func (r ApiPatchTeamsRequest) TeamsPatchInput(teamsPatchInput TeamsPatchInput) ApiPatchTeamsRequest {
	r.teamsPatchInput = &teamsPatchInput
	return r
}

func (r ApiPatchTeamsRequest) Execute() (*BulkEditTeamsRep, *http.Response, error) {
	return r.ApiService.PatchTeamsExecute(r)
}
...
func (a *TeamsBetaApiService) PatchTeamsExecute(r ApiPatchTeamsRequest) (*BulkEditTeamsRep, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *BulkEditTeamsRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TeamsBetaApiService.PatchTeams")
	if err != nil {
	...
	if r.teamsPatchInput == nil {
		return localVarReturnValue, nil, reportError("teamsPatchInput is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.teamsPatchInput
	if r.ctx != nil {
