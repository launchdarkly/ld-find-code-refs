...
type FlagEventCollectionRep struct {
	// The total number of flag events
	TotalCount int32 `json:"totalCount"`
	// A list of flag events
	Items []FlagEventRep `json:"items"`
...
func NewNullableFlagEventCollectionRep(val *FlagEventCollectionRep) *NullableFlagEventCollectionRep {
	return &NullableFlagEventCollectionRep{value: val, isSet: true}
}
