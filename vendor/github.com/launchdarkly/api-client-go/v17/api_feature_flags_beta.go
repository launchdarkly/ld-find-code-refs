...
type FeatureFlagsBetaApi interface {
...
List dependent flags across all environments for the flag specified in the path parameters. A dependent flag is a flag that uses another flag as a prerequisite. To learn more, read [Flag prerequisites](https://launchdarkly.com/docs/home/flags/prereqs).
	...
	*/
	GetDependentFlags(ctx context.Context, projectKey string, featureFlagKey string) ApiGetDependentFlagsRequest

	// GetDependentFlagsExecute executes the request
	//  @return MultiEnvironmentDependentFlags
	GetDependentFlagsExecute(r ApiGetDependentFlagsRequest) (*MultiEnvironmentDependentFlags, *http.Response, error)
...
List dependent flags across all environments for the flag specified in the path parameters. A dependent flag is a flag that uses another flag as a prerequisite. To learn more, read [Flag prerequisites](https://launchdarkly.com/docs/home/flags/prereqs).
	...
	*/
	GetDependentFlagsByEnv(ctx context.Context, projectKey string, environmentKey string, featureFlagKey string) ApiGetDependentFlagsByEnvRequest

	// GetDependentFlagsByEnvExecute executes the request
	//  @return DependentFlagsByEnvironment
	GetDependentFlagsByEnvExecute(r ApiGetDependentFlagsByEnvRequest) (*DependentFlagsByEnvironment, *http.Response, error)
}
...
type ApiGetDependentFlagsRequest struct {
	ctx context.Context
	ApiService FeatureFlagsBetaApi
	projectKey string
