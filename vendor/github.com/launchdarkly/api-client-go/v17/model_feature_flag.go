...
func (o *FeatureFlag) GetEnvironments() map[string]FeatureFlagConfig {
	if o == nil || o.Environments == nil {
		var ret map[string]FeatureFlagConfig
		return ret
	}
...
// SetEnvironments gets a reference to the given map[string]FeatureFlagConfig and assigns it to the Environments field.
