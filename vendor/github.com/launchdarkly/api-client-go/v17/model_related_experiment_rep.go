...
// RelatedExperimentRep struct for RelatedExperimentRep
type RelatedExperimentRep struct {
...
func (o RelatedExperimentRep) MarshalJSON() ([]byte, error) {
...
type NullableRelatedExperimentRep struct {
	value *RelatedExperimentRep
	isSet bool
}

func (v NullableRelatedExperimentRep) Get() *RelatedExperimentRep {
	return v.value
}

func (v *NullableRelatedExperimentRep) Set(val *RelatedExperimentRep) {
	v.value = val
	v.isSet = true
}

func (v NullableRelatedExperimentRep) IsSet() bool {
	return v.isSet
}

func (v *NullableRelatedExperimentRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRelatedExperimentRep(val *RelatedExperimentRep) *NullableRelatedExperimentRep {
	return &NullableRelatedExperimentRep{value: val, isSet: true}
}

func (v NullableRelatedExperimentRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRelatedExperimentRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
