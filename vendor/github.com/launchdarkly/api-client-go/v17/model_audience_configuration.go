...
// AudienceConfiguration struct for AudienceConfiguration
type AudienceConfiguration struct {
	...
	ReleaseGuardianConfiguration *ReleaseGuardianConfiguration `json:"releaseGuardianConfiguration,omitempty"`
}
...
func (o *AudienceConfiguration) GetReleaseGuardianConfiguration() ReleaseGuardianConfiguration {
	if o == nil || o.ReleaseGuardianConfiguration == nil {
		var ret ReleaseGuardianConfiguration
		return ret
	}
...
// SetReleaseGuardianConfiguration gets a reference to the given ReleaseGuardianConfiguration and assigns it to the ReleaseGuardianConfiguration field.
...
func (o AudienceConfiguration) MarshalJSON() ([]byte, error) {
...
type NullableAudienceConfiguration struct {
	value *AudienceConfiguration
	isSet bool
}

func (v NullableAudienceConfiguration) Get() *AudienceConfiguration {
	return v.value
}

func (v *NullableAudienceConfiguration) Set(val *AudienceConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableAudienceConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableAudienceConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAudienceConfiguration(val *AudienceConfiguration) *NullableAudienceConfiguration {
	return &NullableAudienceConfiguration{value: val, isSet: true}
}

func (v NullableAudienceConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAudienceConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
