...
type MetricsBetaApi interface {
	...
	@return ApiCreateMetricGroupRequest
	*/
	CreateMetricGroup(ctx context.Context, projectKey string) ApiCreateMetricGroupRequest

	// CreateMetricGroupExecute executes the request
	//  @return MetricGroupRep
	CreateMetricGroupExecute(r ApiCreateMetricGroupRequest) (*MetricGroupRep, *http.Response, error)
	...
	*/
	...
	// DeleteMetricGroupExecute executes the request
	DeleteMetricGroupExecute(r ApiDeleteMetricGroupRequest) (*http.Response, error)
...
For example, `expand=experiments` includes the `experiments` field in the response.
	...
	*/
	...
	// GetMetricGroupExecute executes the request
	//  @return MetricGroupRep
	GetMetricGroupExecute(r ApiGetMetricGroupRequest) (*MetricGroupRep, *http.Response, error)
...
`filter=experimentStatus equals 'not_started' and query equals 'metric name'`
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param projectKey The project key
	@return ApiGetMetricGroupsRequest
	*/
	GetMetricGroups(ctx context.Context, projectKey string) ApiGetMetricGroupsRequest

	// GetMetricGroupsExecute executes the request
	//  @return MetricGroupCollectionRep
	GetMetricGroupsExecute(r ApiGetMetricGroupsRequest) (*MetricGroupCollectionRep, *http.Response, error)
	...
	@param projectKey The project key
	@param metricGroupKey The metric group key
	@return ApiPatchMetricGroupRequest
	*/
	PatchMetricGroup(ctx context.Context, projectKey string, metricGroupKey string) ApiPatchMetricGroupRequest

	// PatchMetricGroupExecute executes the request
	//  @return MetricGroupRep
	PatchMetricGroupExecute(r ApiPatchMetricGroupRequest) (*MetricGroupRep, *http.Response, error)
}

// MetricsBetaApiService MetricsBetaApi service
type MetricsBetaApiService service

type ApiCreateMetricGroupRequest struct {
	ctx context.Context
	ApiService MetricsBetaApi
	projectKey string
...
func (r ApiCreateMetricGroupRequest) MetricGroupPost(metricGroupPost MetricGroupPost) ApiCreateMetricGroupRequest {
	r.metricGroupPost = &metricGroupPost
	return r
}

func (r ApiCreateMetricGroupRequest) Execute() (*MetricGroupRep, *http.Response, error) {
	return r.ApiService.CreateMetricGroupExecute(r)
}
...
func (a *MetricsBetaApiService) CreateMetricGroupExecute(r ApiCreateMetricGroupRequest) (*MetricGroupRep, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *MetricGroupRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetricsBetaApiService.CreateMetricGroup")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/projects/{projectKey}/metric-groups"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterToString(r.projectKey, "")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.metricGroupPost == nil {
		return localVarReturnValue, nil, reportError("metricGroupPost is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.metricGroupPost
	if r.ctx != nil {
...
type ApiDeleteMetricGroupRequest struct {
	ctx context.Context
	ApiService MetricsBetaApi
	projectKey string
...
func (r ApiDeleteMetricGroupRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteMetricGroupExecute(r)
}
...
func (a *MetricsBetaApiService) DeleteMetricGroupExecute(r ApiDeleteMetricGroupRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetricsBetaApiService.DeleteMetricGroup")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/projects/{projectKey}/metric-groups/{metricGroupKey}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterToString(r.projectKey, "")), -1)
...
type ApiGetMetricGroupRequest struct {
	ctx context.Context
	ApiService MetricsBetaApi
	projectKey string
	metricGroupKey string
...
func (r ApiGetMetricGroupRequest) Execute() (*MetricGroupRep, *http.Response, error) {
	return r.ApiService.GetMetricGroupExecute(r)
}
...
func (a *MetricsBetaApiService) GetMetricGroupExecute(r ApiGetMetricGroupRequest) (*MetricGroupRep, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetricsBetaApiService.GetMetricGroup")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetMetricGroupsRequest struct {
	ctx context.Context
	ApiService MetricsBetaApi
	projectKey string
	filter *string
...
func (r ApiGetMetricGroupsRequest) Filter(filter string) ApiGetMetricGroupsRequest {
	r.filter = &filter
	return r
}
...
func (r ApiGetMetricGroupsRequest) Sort(sort string) ApiGetMetricGroupsRequest {
	r.sort = &sort
	return r
}
...
func (r ApiGetMetricGroupsRequest) Limit(limit int64) ApiGetMetricGroupsRequest {
	r.limit = &limit
	return r
}
...
func (r ApiGetMetricGroupsRequest) Offset(offset int64) ApiGetMetricGroupsRequest {
	r.offset = &offset
	return r
}

func (r ApiGetMetricGroupsRequest) Execute() (*MetricGroupCollectionRep, *http.Response, error) {
	return r.ApiService.GetMetricGroupsExecute(r)
}
...
func (a *MetricsBetaApiService) GetMetricGroupsExecute(r ApiGetMetricGroupsRequest) (*MetricGroupCollectionRep, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *MetricGroupCollectionRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetricsBetaApiService.GetMetricGroups")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiPatchMetricGroupRequest struct {
	ctx context.Context
	ApiService MetricsBetaApi
	projectKey string
	metricGroupKey string
...
func (r ApiPatchMetricGroupRequest) Execute() (*MetricGroupRep, *http.Response, error) {
	return r.ApiService.PatchMetricGroupExecute(r)
}
...
func (a *MetricsBetaApiService) PatchMetricGroupExecute(r ApiPatchMetricGroupRequest) (*MetricGroupRep, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetricsBetaApiService.PatchMetricGroup")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
