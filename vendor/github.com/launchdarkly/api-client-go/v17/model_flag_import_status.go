...
// FlagImportStatus struct for FlagImportStatus
type FlagImportStatus struct {
	// The current status of the import integrations related import job
	Status *string `json:"status,omitempty"`
	LastImport *int64 `json:"lastImport,omitempty"`
	LastError *int64 `json:"lastError,omitempty"`
	Errors []StatusResponse `json:"errors,omitempty"`
}
...
// SetLastImport gets a reference to the given int64 and assigns it to the LastImport field.
...
// SetErrors gets a reference to the given []StatusResponse and assigns it to the Errors field.
func (o *FlagImportStatus) SetErrors(v []StatusResponse) {
	o.Errors = v
}

func (o FlagImportStatus) MarshalJSON() ([]byte, error) {
...
type NullableFlagImportStatus struct {
	value *FlagImportStatus
	isSet bool
}

func (v NullableFlagImportStatus) Get() *FlagImportStatus {
	return v.value
}

func (v *NullableFlagImportStatus) Set(val *FlagImportStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableFlagImportStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableFlagImportStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlagImportStatus(val *FlagImportStatus) *NullableFlagImportStatus {
	return &NullableFlagImportStatus{value: val, isSet: true}
}

func (v NullableFlagImportStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlagImportStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
