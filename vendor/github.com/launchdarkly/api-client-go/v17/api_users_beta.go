...
Get all in-use user attributes in the specified environment. The set of in-use attributes typically consists of all attributes seen within the past 30 days.
	...
	Deprecated
	*/
	GetUserAttributeNames(ctx context.Context, projectKey string, environmentKey string) ApiGetUserAttributeNamesRequest

	// GetUserAttributeNamesExecute executes the request
	//  @return UserAttributeNamesRep
	// Deprecated
	GetUserAttributeNamesExecute(r ApiGetUserAttributeNamesRequest) (*UserAttributeNamesRep, *http.Response, error)
}
...
func (a *UsersBetaApiService) GetUserAttributeNamesExecute(r ApiGetUserAttributeNamesRequest) (*UserAttributeNamesRep, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *UserAttributeNamesRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersBetaApiService.GetUserAttributeNames")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/user-attributes/{projectKey}/{environmentKey}"
