...
// GetNamingConvention returns the NamingConvention field value if set, zero value otherwise.
func (o *ProjectPost) GetNamingConvention() NamingConvention {
	if o == nil || o.NamingConvention == nil {
		var ret NamingConvention
		return ret
	}
	return *o.NamingConvention
}

// GetNamingConventionOk returns a tuple with the NamingConvention field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ProjectPost) GetNamingConventionOk() (*NamingConvention, bool) {
	if o == nil || o.NamingConvention == nil {
		return nil, false
	}
	return o.NamingConvention, true
}
...
// SetNamingConvention gets a reference to the given NamingConvention and assigns it to the NamingConvention field.
...
func (o ProjectPost) MarshalJSON() ([]byte, error) {
	...
	if o.NamingConvention != nil {
		toSerialize["namingConvention"] = o.NamingConvention
	}
