...
type ContextInstanceRecord struct {
	...
	AnonymousKinds []string `json:"anonymousKinds,omitempty"`
...
func (o *ContextInstanceRecord) GetAnonymousKinds() []string {
	if o == nil || o.AnonymousKinds == nil {
		var ret []string
		return ret
	}
	return o.AnonymousKinds
}

// GetAnonymousKindsOk returns a tuple with the AnonymousKinds field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ContextInstanceRecord) GetAnonymousKindsOk() ([]string, bool) {
	if o == nil || o.AnonymousKinds == nil {
		return nil, false
	}
	return o.AnonymousKinds, true
}
...
func (o ContextInstanceRecord) MarshalJSON() ([]byte, error) {
	...
	if o.AnonymousKinds != nil {
		toSerialize["anonymousKinds"] = o.AnonymousKinds
	}
	if o.Context != nil {
...
func NewNullableContextInstanceRecord(val *ContextInstanceRecord) *NullableContextInstanceRecord {
	return &NullableContextInstanceRecord{value: val, isSet: true}
}
