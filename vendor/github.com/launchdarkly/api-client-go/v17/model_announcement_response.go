...
type AnnouncementResponse struct {
	...
	Access *AnnouncementAccessRep `json:"_access,omitempty"`
	Links AnnouncementResponseLinks `json:"_links"`
}
...
// GetIsDismissible returns the IsDismissible field value
...
// GetIsDismissibleOk returns a tuple with the IsDismissible field value
// and a boolean to check if the value has been set.
...
// SetIsDismissible sets field value
...
// SetAccess gets a reference to the given AnnouncementAccessRep and assigns it to the Access field.
...
func (o *AnnouncementResponse) GetLinks() AnnouncementResponseLinks {
	if o == nil {
		var ret AnnouncementResponseLinks
		return ret
	}
...
func (o AnnouncementResponse) MarshalJSON() ([]byte, error) {
...
type NullableAnnouncementResponse struct {
	value *AnnouncementResponse
	isSet bool
}

func (v NullableAnnouncementResponse) Get() *AnnouncementResponse {
	return v.value
}

func (v *NullableAnnouncementResponse) Set(val *AnnouncementResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAnnouncementResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAnnouncementResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnnouncementResponse(val *AnnouncementResponse) *NullableAnnouncementResponse {
	return &NullableAnnouncementResponse{value: val, isSet: true}
}

func (v NullableAnnouncementResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAnnouncementResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
