...
type RelayProxyConfigurationsApi interface {
	...
	*/
	...
	DeleteRelayAutoConfigExecute(r ApiDeleteRelayAutoConfigRequest) (*http.Response, error)
	...
	*/
	GetRelayProxyConfig(ctx context.Context, id string) ApiGetRelayProxyConfigRequest

	// GetRelayProxyConfigExecute executes the request
	//  @return RelayAutoConfigRep
	GetRelayProxyConfigExecute(r ApiGetRelayProxyConfigRequest) (*RelayAutoConfigRep, *http.Response, error)
	...
	*/
	GetRelayProxyConfigs(ctx context.Context) ApiGetRelayProxyConfigsRequest

	// GetRelayProxyConfigsExecute executes the request
	//  @return RelayAutoConfigCollectionRep
	GetRelayProxyConfigsExecute(r ApiGetRelayProxyConfigsRequest) (*RelayAutoConfigCollectionRep, *http.Response, error)
	...
	*/
	PatchRelayAutoConfig(ctx context.Context, id string) ApiPatchRelayAutoConfigRequest

	// PatchRelayAutoConfigExecute executes the request
	//  @return RelayAutoConfigRep
	PatchRelayAutoConfigExecute(r ApiPatchRelayAutoConfigRequest) (*RelayAutoConfigRep, *http.Response, error)
	...
	*/
	PostRelayAutoConfig(ctx context.Context) ApiPostRelayAutoConfigRequest

	// PostRelayAutoConfigExecute executes the request
	//  @return RelayAutoConfigRep
	PostRelayAutoConfigExecute(r ApiPostRelayAutoConfigRequest) (*RelayAutoConfigRep, *http.Response, error)
	...
	*/
	ResetRelayAutoConfig(ctx context.Context, id string) ApiResetRelayAutoConfigRequest

	// ResetRelayAutoConfigExecute executes the request
	//  @return RelayAutoConfigRep
	ResetRelayAutoConfigExecute(r ApiResetRelayAutoConfigRequest) (*RelayAutoConfigRep, *http.Response, error)
}
...
type ApiDeleteRelayAutoConfigRequest struct {
	ctx context.Context
	ApiService RelayProxyConfigurationsApi
	id string
}

func (r ApiDeleteRelayAutoConfigRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteRelayAutoConfigExecute(r)
}
...
func (a *RelayProxyConfigurationsApiService) DeleteRelayAutoConfigExecute(r ApiDeleteRelayAutoConfigRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RelayProxyConfigurationsApiService.DeleteRelayAutoConfig")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/account/relay-auto-configs/{id}"
...
func (r ApiGetRelayProxyConfigRequest) Execute() (*RelayAutoConfigRep, *http.Response, error) {
	return r.ApiService.GetRelayProxyConfigExecute(r)
}
...
func (a *RelayProxyConfigurationsApiService) GetRelayProxyConfigExecute(r ApiGetRelayProxyConfigRequest) (*RelayAutoConfigRep, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *RelayAutoConfigRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RelayProxyConfigurationsApiService.GetRelayProxyConfig")
	if err != nil {
...
func (r ApiGetRelayProxyConfigsRequest) Execute() (*RelayAutoConfigCollectionRep, *http.Response, error) {
	return r.ApiService.GetRelayProxyConfigsExecute(r)
}
...
func (a *RelayProxyConfigurationsApiService) GetRelayProxyConfigsExecute(r ApiGetRelayProxyConfigsRequest) (*RelayAutoConfigCollectionRep, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *RelayAutoConfigCollectionRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RelayProxyConfigurationsApiService.GetRelayProxyConfigs")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/account/relay-auto-configs"
...
func (r ApiPatchRelayAutoConfigRequest) Execute() (*RelayAutoConfigRep, *http.Response, error) {
	return r.ApiService.PatchRelayAutoConfigExecute(r)
}
...
func (a *RelayProxyConfigurationsApiService) PatchRelayAutoConfigExecute(r ApiPatchRelayAutoConfigRequest) (*RelayAutoConfigRep, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RelayProxyConfigurationsApiService.PatchRelayAutoConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiPostRelayAutoConfigRequest) RelayAutoConfigPost(relayAutoConfigPost RelayAutoConfigPost) ApiPostRelayAutoConfigRequest {
	r.relayAutoConfigPost = &relayAutoConfigPost
	return r
}

func (r ApiPostRelayAutoConfigRequest) Execute() (*RelayAutoConfigRep, *http.Response, error) {
	return r.ApiService.PostRelayAutoConfigExecute(r)
}
...
func (a *RelayProxyConfigurationsApiService) PostRelayAutoConfigExecute(r ApiPostRelayAutoConfigRequest) (*RelayAutoConfigRep, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RelayProxyConfigurationsApiService.PostRelayAutoConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.relayAutoConfigPost == nil {
		return localVarReturnValue, nil, reportError("relayAutoConfigPost is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.relayAutoConfigPost
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
...
func (r ApiResetRelayAutoConfigRequest) Execute() (*RelayAutoConfigRep, *http.Response, error) {
	return r.ApiService.ResetRelayAutoConfigExecute(r)
}
...
func (a *RelayProxyConfigurationsApiService) ResetRelayAutoConfigExecute(r ApiResetRelayAutoConfigRequest) (*RelayAutoConfigRep, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RelayProxyConfigurationsApiService.ResetRelayAutoConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/account/relay-auto-configs/{id}/reset"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterToString(r.id, "")), -1)
