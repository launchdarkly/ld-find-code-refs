...
func (o *FeatureFlags) GetTotalCountWithDifferences() int32 {
	if o == nil || o.TotalCountWithDifferences == nil {
		var ret int32
		return ret
	}
	return *o.TotalCountWithDifferences
}

// GetTotalCountWithDifferencesOk returns a tuple with the TotalCountWithDifferences field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FeatureFlags) GetTotalCountWithDifferencesOk() (*int32, bool) {
	if o == nil || o.TotalCountWithDifferences == nil {
		return nil, false
	}
	return o.TotalCountWithDifferences, true
}
...
func (o FeatureFlags) MarshalJSON() ([]byte, error) {
	...
	if o.TotalCountWithDifferences != nil {
		toSerialize["totalCountWithDifferences"] = o.TotalCountWithDifferences
	}
