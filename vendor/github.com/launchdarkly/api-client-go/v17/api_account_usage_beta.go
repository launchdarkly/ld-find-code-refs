...
type AccountUsageBetaApi interface {
	...
	*/
	GetEvaluationsUsage(ctx context.Context, projectKey string, environmentKey string, featureFlagKey string) ApiGetEvaluationsUsageRequest

	// GetEvaluationsUsageExecute executes the request
	//  @return SeriesListRep
	GetEvaluationsUsageExecute(r ApiGetEvaluationsUsageRequest) (*SeriesListRep, *http.Response, error)
	...
	*/
	GetMauSdksByType(ctx context.Context) ApiGetMauSdksByTypeRequest

	// GetMauSdksByTypeExecute executes the request
	//  @return SdkListRep
	GetMauSdksByTypeExecute(r ApiGetMauSdksByTypeRequest) (*SdkListRep, *http.Response, error)
	...
	*/
	GetStreamUsage(ctx context.Context, source string) ApiGetStreamUsageRequest

	// GetStreamUsageExecute executes the request
	//  @return SeriesListRep
	GetStreamUsageExecute(r ApiGetStreamUsageRequest) (*SeriesListRep, *http.Response, error)
	...
	*/
	GetStreamUsageBySdkVersion(ctx context.Context, source string) ApiGetStreamUsageBySdkVersionRequest

	// GetStreamUsageBySdkVersionExecute executes the request
	//  @return SeriesListRep
	GetStreamUsageBySdkVersionExecute(r ApiGetStreamUsageBySdkVersionRequest) (*SeriesListRep, *http.Response, error)
...
func (r ApiGetEvaluationsUsageRequest) Execute() (*SeriesListRep, *http.Response, error) {
	return r.ApiService.GetEvaluationsUsageExecute(r)
}
...
func (a *AccountUsageBetaApiService) GetEvaluationsUsageExecute(r ApiGetEvaluationsUsageRequest) (*SeriesListRep, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountUsageBetaApiService.GetEvaluationsUsage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *AccountUsageBetaApiService) GetEventsUsageExecute(r ApiGetEventsUsageRequest) (*SeriesListRep, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountUsageBetaApiService.GetEventsUsage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetExperimentationKeysUsageRequest struct {
	ctx context.Context
	ApiService AccountUsageBetaApi
	from *string
	to *string
...
func (a *AccountUsageBetaApiService) GetExperimentationKeysUsageExecute(r ApiGetExperimentationKeysUsageRequest) (*SeriesIntervalsRep, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/usage/experimentation-keys"
...
func (r ApiGetMauSdksByTypeRequest) Execute() (*SdkListRep, *http.Response, error) {
	return r.ApiService.GetMauSdksByTypeExecute(r)
}
...
func (a *AccountUsageBetaApiService) GetMauSdksByTypeExecute(r ApiGetMauSdksByTypeRequest) (*SdkListRep, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SdkListRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountUsageBetaApiService.GetMauSdksByType")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/usage/mau/sdks"
...
func (r ApiGetMauUsageRequest) AggregationType(aggregationType string) ApiGetMauUsageRequest {
...
func (r ApiGetMauUsageRequest) ContextKind(contextKind string) ApiGetMauUsageRequest {
	r.contextKind = &contextKind
	return r
}

func (r ApiGetMauUsageRequest) Execute() (*SeriesListRep, *http.Response, error) {
	return r.ApiService.GetMauUsageExecute(r)
}
...
func (a *AccountUsageBetaApiService) GetMauUsageExecute(r ApiGetMauUsageRequest) (*SeriesListRep, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountUsageBetaApiService.GetMauUsage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/usage/mau"
...
func (r ApiGetMauUsageByCategoryRequest) Execute() (*SeriesListRep, *http.Response, error) {
	return r.ApiService.GetMauUsageByCategoryExecute(r)
}
...
func (a *AccountUsageBetaApiService) GetMauUsageByCategoryExecute(r ApiGetMauUsageByCategoryRequest) (*SeriesListRep, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountUsageBetaApiService.GetMauUsageByCategory")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/usage/mau/bycategory"
...
func (r ApiGetStreamUsageRequest) Execute() (*SeriesListRep, *http.Response, error) {
	return r.ApiService.GetStreamUsageExecute(r)
}
...
func (a *AccountUsageBetaApiService) GetStreamUsageExecute(r ApiGetStreamUsageRequest) (*SeriesListRep, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountUsageBetaApiService.GetStreamUsage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetStreamUsageBySdkVersionRequest) Execute() (*SeriesListRep, *http.Response, error) {
	return r.ApiService.GetStreamUsageBySdkVersionExecute(r)
}
...
func (a *AccountUsageBetaApiService) GetStreamUsageBySdkVersionExecute(r ApiGetStreamUsageBySdkVersionRequest) (*SeriesListRep, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountUsageBetaApiService.GetStreamUsageBySdkVersion")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetStreamUsageSdkversionRequest) Execute() (*SdkVersionListRep, *http.Response, error) {
	return r.ApiService.GetStreamUsageSdkversionExecute(r)
}
...
func (a *AccountUsageBetaApiService) GetStreamUsageSdkversionExecute(r ApiGetStreamUsageSdkversionRequest) (*SdkVersionListRep, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SdkVersionListRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountUsageBetaApiService.GetStreamUsageSdkversion")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
