...
type ProjectsApi interface {
	...
	*/
	DeleteProject(ctx context.Context, projectKey string) ApiDeleteProjectRequest
	...
	*/
	GetFlagDefaultsByProject(ctx context.Context, projectKey string) ApiGetFlagDefaultsByProjectRequest

	// GetFlagDefaultsByProjectExecute executes the request
	//  @return FlagDefaultsRep
	GetFlagDefaultsByProjectExecute(r ApiGetFlagDefaultsByProjectRequest) (*FlagDefaultsRep, *http.Response, error)
...
For example, `expand=environments` includes the `environments` field for the project in the response.
	...
	*/
	GetProject(ctx context.Context, projectKey string) ApiGetProjectRequest
...
For example, `expand=environments` includes the `environments` field for each project in the response.
	...
	*/
	...
	//  @return Projects
	GetProjectsExecute(r ApiGetProjectsRequest) (*Projects, *http.Response, error)
	...
	*/
	PatchFlagDefaultsByProject(ctx context.Context, projectKey string) ApiPatchFlagDefaultsByProjectRequest

	// PatchFlagDefaultsByProjectExecute executes the request
	//  @return UpsertPayloadRep
	PatchFlagDefaultsByProjectExecute(r ApiPatchFlagDefaultsByProjectRequest) (*UpsertPayloadRep, *http.Response, error)
	...
	*/
	PatchProject(ctx context.Context, projectKey string) ApiPatchProjectRequest

	// PatchProjectExecute executes the request
	//  @return ProjectRep
	PatchProjectExecute(r ApiPatchProjectRequest) (*ProjectRep, *http.Response, error)
	...
	*/
	PostProject(ctx context.Context) ApiPostProjectRequest

	// PostProjectExecute executes the request
	//  @return ProjectRep
	PostProjectExecute(r ApiPostProjectRequest) (*ProjectRep, *http.Response, error)
	...
	*/
	...
	// PutFlagDefaultsByProjectExecute executes the request
	//  @return UpsertPayloadRep
	PutFlagDefaultsByProjectExecute(r ApiPutFlagDefaultsByProjectRequest) (*UpsertPayloadRep, *http.Response, error)
}
...
func (r ApiGetFlagDefaultsByProjectRequest) Execute() (*FlagDefaultsRep, *http.Response, error) {
	return r.ApiService.GetFlagDefaultsByProjectExecute(r)
}
...
func (a *ProjectsApiService) GetFlagDefaultsByProjectExecute(r ApiGetFlagDefaultsByProjectRequest) (*FlagDefaultsRep, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *FlagDefaultsRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectsApiService.GetFlagDefaultsByProject")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/projects/{projectKey}/flag-defaults"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterToString(r.projectKey, "")), -1)
...
func (r ApiPatchFlagDefaultsByProjectRequest) Execute() (*UpsertPayloadRep, *http.Response, error) {
	return r.ApiService.PatchFlagDefaultsByProjectExecute(r)
}
...
func (a *ProjectsApiService) PatchFlagDefaultsByProjectExecute(r ApiPatchFlagDefaultsByProjectRequest) (*UpsertPayloadRep, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *UpsertPayloadRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectsApiService.PatchFlagDefaultsByProject")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiPutFlagDefaultsByProjectRequest) UpsertFlagDefaultsPayload(upsertFlagDefaultsPayload UpsertFlagDefaultsPayload) ApiPutFlagDefaultsByProjectRequest {
	r.upsertFlagDefaultsPayload = &upsertFlagDefaultsPayload
	return r
}

func (r ApiPutFlagDefaultsByProjectRequest) Execute() (*UpsertPayloadRep, *http.Response, error) {
	return r.ApiService.PutFlagDefaultsByProjectExecute(r)
}
...
func (a *ProjectsApiService) PutFlagDefaultsByProjectExecute(r ApiPutFlagDefaultsByProjectRequest) (*UpsertPayloadRep, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectsApiService.PutFlagDefaultsByProject")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.upsertFlagDefaultsPayload == nil {
		return localVarReturnValue, nil, reportError("upsertFlagDefaultsPayload is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.upsertFlagDefaultsPayload
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
