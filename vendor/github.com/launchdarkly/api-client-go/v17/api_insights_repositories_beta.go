...
type InsightsRepositoriesBetaApi interface {
	...
	@return ApiAssociateRepositoriesAndProjectsRequest
	*/
	AssociateRepositoriesAndProjects(ctx context.Context) ApiAssociateRepositoriesAndProjectsRequest

	// AssociateRepositoriesAndProjectsExecute executes the request
	//  @return InsightsRepositoryProjectCollection
	AssociateRepositoriesAndProjectsExecute(r ApiAssociateRepositoriesAndProjectsRequest) (*InsightsRepositoryProjectCollection, *http.Response, error)
	...
	@return ApiDeleteRepositoryProjectRequest
	*/
	DeleteRepositoryProject(ctx context.Context, repositoryKey string, projectKey string) ApiDeleteRepositoryProjectRequest

	// DeleteRepositoryProjectExecute executes the request
	DeleteRepositoryProjectExecute(r ApiDeleteRepositoryProjectRequest) (*http.Response, error)
...
For example, use `?expand=projects` to include the `projects` field in the response. By default, this field is **not** included in the response.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetInsightsRepositoriesRequest
	*/
	GetInsightsRepositories(ctx context.Context) ApiGetInsightsRepositoriesRequest

	// GetInsightsRepositoriesExecute executes the request
	//  @return InsightsRepositoryCollection
	GetInsightsRepositoriesExecute(r ApiGetInsightsRepositoriesRequest) (*InsightsRepositoryCollection, *http.Response, error)
}

// InsightsRepositoriesBetaApiService InsightsRepositoriesBetaApi service
type InsightsRepositoriesBetaApiService service

type ApiAssociateRepositoriesAndProjectsRequest struct {
	ctx context.Context
	ApiService InsightsRepositoriesBetaApi
...
func (r ApiAssociateRepositoriesAndProjectsRequest) InsightsRepositoryProjectMappings(insightsRepositoryProjectMappings InsightsRepositoryProjectMappings) ApiAssociateRepositoriesAndProjectsRequest {
	r.insightsRepositoryProjectMappings = &insightsRepositoryProjectMappings
	return r
}

func (r ApiAssociateRepositoriesAndProjectsRequest) Execute() (*InsightsRepositoryProjectCollection, *http.Response, error) {
	return r.ApiService.AssociateRepositoriesAndProjectsExecute(r)
}
...
func (a *InsightsRepositoriesBetaApiService) AssociateRepositoriesAndProjectsExecute(r ApiAssociateRepositoriesAndProjectsRequest) (*InsightsRepositoryProjectCollection, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *InsightsRepositoryProjectCollection
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InsightsRepositoriesBetaApiService.AssociateRepositoriesAndProjects")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/engineering-insights/repositories/projects"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.insightsRepositoryProjectMappings == nil {
		return localVarReturnValue, nil, reportError("insightsRepositoryProjectMappings is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.insightsRepositoryProjectMappings
	if r.ctx != nil {
...
type ApiDeleteRepositoryProjectRequest struct {
	ctx context.Context
	ApiService InsightsRepositoriesBetaApi
...
func (r ApiDeleteRepositoryProjectRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteRepositoryProjectExecute(r)
}
...
func (a *InsightsRepositoriesBetaApiService) DeleteRepositoryProjectExecute(r ApiDeleteRepositoryProjectRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InsightsRepositoriesBetaApiService.DeleteRepositoryProject")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/engineering-insights/repositories/{repositoryKey}/projects/{projectKey}"
	localVarPath = strings.Replace(localVarPath, "{"+"repositoryKey"+"}", url.PathEscape(parameterToString(r.repositoryKey, "")), -1)
...
type ApiGetInsightsRepositoriesRequest struct {
	ctx context.Context
	ApiService InsightsRepositoriesBetaApi
	expand *string
}
...
func (r ApiGetInsightsRepositoriesRequest) Execute() (*InsightsRepositoryCollection, *http.Response, error) {
	return r.ApiService.GetInsightsRepositoriesExecute(r)
}
...
func (a *InsightsRepositoriesBetaApiService) GetInsightsRepositoriesExecute(r ApiGetInsightsRepositoriesRequest) (*InsightsRepositoryCollection, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *InsightsRepositoryCollection
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InsightsRepositoriesBetaApiService.GetInsightsRepositories")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/engineering-insights/repositories"
