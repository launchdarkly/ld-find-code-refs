...
type RandomizationSettingsRep struct {
	// The project ID
...
type NullableRandomizationSettingsRep struct {
	value *RandomizationSettingsRep
	isSet bool
}
...
func NewNullableRandomizationSettingsRep(val *RandomizationSettingsRep) *NullableRandomizationSettingsRep {
	return &NullableRandomizationSettingsRep{value: val, isSet: true}
}
