...
type OtherApi interface {
	...
	/*
	GetCallerIdentity Identify the caller
	...
	@return ApiGetCallerIdentityRequest
	*/
	GetCallerIdentity(ctx context.Context) ApiGetCallerIdentityRequest

	// GetCallerIdentityExecute executes the request
	//  @return CallerIdentityRep
	GetCallerIdentityExecute(r ApiGetCallerIdentityRequest) (*CallerIdentityRep, *http.Response, error)
	...
	*/
	GetIps(ctx context.Context) ApiGetIpsRequest

	// GetIpsExecute executes the request
	//  @return IpList
	GetIpsExecute(r ApiGetIpsRequest) (*IpList, *http.Response, error)
	...
	*/
	GetOpenapiSpec(ctx context.Context) ApiGetOpenapiSpecRequest

	// GetOpenapiSpecExecute executes the request
	GetOpenapiSpecExecute(r ApiGetOpenapiSpecRequest) (*http.Response, error)
	...
	*/
	GetRoot(ctx context.Context) ApiGetRootRequest

	// GetRootExecute executes the request
	//  @return RootResponse
	GetRootExecute(r ApiGetRootRequest) (*RootResponse, *http.Response, error)
	...
	*/
	...
	//  @return VersionsRep
	GetVersionsExecute(r ApiGetVersionsRequest) (*VersionsRep, *http.Response, error)
}

// OtherApiService OtherApi service
type OtherApiService service

type ApiGetCallerIdentityRequest struct {
	ctx context.Context
	ApiService OtherApi
}

func (r ApiGetCallerIdentityRequest) Execute() (*CallerIdentityRep, *http.Response, error) {
	return r.ApiService.GetCallerIdentityExecute(r)
}
...
Get basic information about the identity used (session cookie, API token, SDK keys, etc.) to call the API
 ...
 @return ApiGetCallerIdentityRequest
*/
func (a *OtherApiService) GetCallerIdentity(ctx context.Context) ApiGetCallerIdentityRequest {
	return ApiGetCallerIdentityRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return CallerIdentityRep
func (a *OtherApiService) GetCallerIdentityExecute(r ApiGetCallerIdentityRequest) (*CallerIdentityRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CallerIdentityRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OtherApiService.GetCallerIdentity")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/caller-identity"
...
func (a *OtherApiService) GetVersionsExecute(r ApiGetVersionsRequest) (*VersionsRep, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *VersionsRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OtherApiService.GetVersions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/versions"
