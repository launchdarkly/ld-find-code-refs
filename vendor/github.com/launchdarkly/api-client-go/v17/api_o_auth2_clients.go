...
type OAuth2ClientsApi interface {
	...
	*/
	CreateOAuth2Client(ctx context.Context) ApiCreateOAuth2ClientRequest

	// CreateOAuth2ClientExecute executes the request
	//  @return Client
	CreateOAuth2ClientExecute(r ApiCreateOAuth2ClientRequest) (*Client, *http.Response, error)
	...
	*/
	DeleteOAuthClient(ctx context.Context, clientId string) ApiDeleteOAuthClientRequest

	// DeleteOAuthClientExecute executes the request
	DeleteOAuthClientExecute(r ApiDeleteOAuthClientRequest) (*http.Response, error)
	...
	*/
	GetOAuthClientById(ctx context.Context, clientId string) ApiGetOAuthClientByIdRequest

	// GetOAuthClientByIdExecute executes the request
	//  @return Client
	GetOAuthClientByIdExecute(r ApiGetOAuthClientByIdRequest) (*Client, *http.Response, error)
	...
	*/
	GetOAuthClients(ctx context.Context) ApiGetOAuthClientsRequest

	// GetOAuthClientsExecute executes the request
	//  @return ClientCollection
	GetOAuthClientsExecute(r ApiGetOAuthClientsRequest) (*ClientCollection, *http.Response, error)
	...
	*/
	PatchOAuthClient(ctx context.Context, clientId string) ApiPatchOAuthClientRequest

	// PatchOAuthClientExecute executes the request
	//  @return Client
	PatchOAuthClientExecute(r ApiPatchOAuthClientRequest) (*Client, *http.Response, error)
}
...
func (r ApiCreateOAuth2ClientRequest) OauthClientPost(oauthClientPost OauthClientPost) ApiCreateOAuth2ClientRequest {
	r.oauthClientPost = &oauthClientPost
	return r
}
...
func (a *OAuth2ClientsApiService) CreateOAuth2ClientExecute(r ApiCreateOAuth2ClientRequest) (*Client, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuth2ClientsApiService.CreateOAuth2Client")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/oauth/clients"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.oauthClientPost == nil {
		return localVarReturnValue, nil, reportError("oauthClientPost is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.oauthClientPost
	if r.ctx != nil {
...
func (a *OAuth2ClientsApiService) DeleteOAuthClientExecute(r ApiDeleteOAuthClientRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuth2ClientsApiService.DeleteOAuthClient")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/oauth/clients/{clientId}"
...
func (a *OAuth2ClientsApiService) GetOAuthClientByIdExecute(r ApiGetOAuthClientByIdRequest) (*Client, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuth2ClientsApiService.GetOAuthClientById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *OAuth2ClientsApiService) GetOAuthClientsExecute(r ApiGetOAuthClientsRequest) (*ClientCollection, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuth2ClientsApiService.GetOAuthClients")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *OAuth2ClientsApiService) PatchOAuthClientExecute(r ApiPatchOAuthClientRequest) (*Client, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuth2ClientsApiService.PatchOAuthClient")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
