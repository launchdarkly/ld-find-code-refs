...
type Endpoint struct {
	Headers []HeaderItems `json:"headers,omitempty"`
	HmacSignature *HMACSignature `json:"hmacSignature,omitempty"`
...
// SetHeaders gets a reference to the given []HeaderItems and assigns it to the Headers field.
func (o *Endpoint) SetHeaders(v []HeaderItems) {
	o.Headers = v
}

// GetHmacSignature returns the HmacSignature field value if set, zero value otherwise.
func (o *Endpoint) GetHmacSignature() HMACSignature {
	if o == nil || o.HmacSignature == nil {
		var ret HMACSignature
		return ret
	}
	return *o.HmacSignature
}

// GetHmacSignatureOk returns a tuple with the HmacSignature field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Endpoint) GetHmacSignatureOk() (*HMACSignature, bool) {
	if o == nil || o.HmacSignature == nil {
		return nil, false
	}
	return o.HmacSignature, true
}
...
// SetHmacSignature gets a reference to the given HMACSignature and assigns it to the HmacSignature field.
...
func (o Endpoint) MarshalJSON() ([]byte, error) {
	...
	if o.HmacSignature != nil {
		toSerialize["hmacSignature"] = o.HmacSignature
	}
	if o.Method != nil {
