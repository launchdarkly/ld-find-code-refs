...
// HoldoutRep struct for HoldoutRep
type HoldoutRep struct {
	Id string `json:"_id"`
	...
	Experiments []RelatedExperimentRep `json:"experiments,omitempty"`
}
...
// SetExperiments gets a reference to the given []RelatedExperimentRep and assigns it to the Experiments field.
func (o *HoldoutRep) SetExperiments(v []RelatedExperimentRep) {
	o.Experiments = v
}

func (o HoldoutRep) MarshalJSON() ([]byte, error) {
...
type NullableHoldoutRep struct {
	value *HoldoutRep
	isSet bool
}

func (v NullableHoldoutRep) Get() *HoldoutRep {
	return v.value
}

func (v *NullableHoldoutRep) Set(val *HoldoutRep) {
	v.value = val
	v.isSet = true
}

func (v NullableHoldoutRep) IsSet() bool {
	return v.isSet
}

func (v *NullableHoldoutRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHoldoutRep(val *HoldoutRep) *NullableHoldoutRep {
	return &NullableHoldoutRep{value: val, isSet: true}
}

func (v NullableHoldoutRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHoldoutRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
