...
// AiConfigsAccessAllowedReason struct for AiConfigsAccessAllowedReason
type AiConfigsAccessAllowedReason struct {
...
func NewAiConfigsAccessAllowedReason(effect string) *AiConfigsAccessAllowedReason {
	this := AiConfigsAccessAllowedReason{}
	this.Effect = effect
	return &this
}
...
func (o AiConfigsAccessAllowedReason) MarshalJSON() ([]byte, error) {
...
type NullableAiConfigsAccessAllowedReason struct {
	value *AiConfigsAccessAllowedReason
	isSet bool
}

func (v NullableAiConfigsAccessAllowedReason) Get() *AiConfigsAccessAllowedReason {
	return v.value
}

func (v *NullableAiConfigsAccessAllowedReason) Set(val *AiConfigsAccessAllowedReason) {
	v.value = val
	v.isSet = true
}

func (v NullableAiConfigsAccessAllowedReason) IsSet() bool {
	return v.isSet
}

func (v *NullableAiConfigsAccessAllowedReason) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAiConfigsAccessAllowedReason(val *AiConfigsAccessAllowedReason) *NullableAiConfigsAccessAllowedReason {
	return &NullableAiConfigsAccessAllowedReason{value: val, isSet: true}
}

func (v NullableAiConfigsAccessAllowedReason) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAiConfigsAccessAllowedReason) UnmarshalJSON(src []byte) error {
	v.isSet = true
