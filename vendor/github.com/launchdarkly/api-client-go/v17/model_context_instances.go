...
type ContextInstances struct {
	...
	Items []ContextInstanceRecord `json:"items"`
}
...
func (o ContextInstances) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["_environmentId"] = o.EnvironmentId
	}
...
func NewNullableContextInstances(val *ContextInstances) *NullableContextInstances {
	return &NullableContextInstances{value: val, isSet: true}
}
