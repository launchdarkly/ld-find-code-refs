...
type FlagRep struct {
	...
	NotInExperimentVariationId *string `json:"notInExperimentVariationId,omitempty"`
...
func (o *FlagRep) GetTargetingRule() string {
	if o == nil || o.TargetingRule == nil {
		var ret string
		return ret
	}
	return *o.TargetingRule
}

// GetTargetingRuleOk returns a tuple with the TargetingRule field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FlagRep) GetTargetingRuleOk() (*string, bool) {
	if o == nil || o.TargetingRule == nil {
		return nil, false
	}
	return o.TargetingRule, true
}
...
func (o *FlagRep) GetTargetingRuleDescription() string {
	if o == nil || o.TargetingRuleDescription == nil {
		var ret string
		return ret
	}
	return *o.TargetingRuleDescription
}

// GetTargetingRuleDescriptionOk returns a tuple with the TargetingRuleDescription field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FlagRep) GetTargetingRuleDescriptionOk() (*string, bool) {
	if o == nil || o.TargetingRuleDescription == nil {
		return nil, false
	}
	return o.TargetingRuleDescription, true
}
...
func (o *FlagRep) GetTargetingRuleClauses() []interface{} {
	if o == nil || o.TargetingRuleClauses == nil {
		var ret []interface{}
		return ret
	}
	return o.TargetingRuleClauses
}

// GetTargetingRuleClausesOk returns a tuple with the TargetingRuleClauses field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FlagRep) GetTargetingRuleClausesOk() ([]interface{}, bool) {
	if o == nil || o.TargetingRuleClauses == nil {
		return nil, false
	}
	return o.TargetingRuleClauses, true
}
...
func (o *FlagRep) GetFlagConfigVersion() int32 {
	if o == nil || o.FlagConfigVersion == nil {
		var ret int32
		return ret
	}
	return *o.FlagConfigVersion
}

// GetFlagConfigVersionOk returns a tuple with the FlagConfigVersion field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FlagRep) GetFlagConfigVersionOk() (*int32, bool) {
	if o == nil || o.FlagConfigVersion == nil {
		return nil, false
	}
	return o.FlagConfigVersion, true
}
...
func (o *FlagRep) SetFlagConfigVersion(v int32) {
	o.FlagConfigVersion = &v
}

// GetNotInExperimentVariationId returns the NotInExperimentVariationId field value if set, zero value otherwise.
func (o *FlagRep) GetNotInExperimentVariationId() string {
	if o == nil || o.NotInExperimentVariationId == nil {
		var ret string
		return ret
	}
	return *o.NotInExperimentVariationId
}

// GetNotInExperimentVariationIdOk returns a tuple with the NotInExperimentVariationId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FlagRep) GetNotInExperimentVariationIdOk() (*string, bool) {
	if o == nil || o.NotInExperimentVariationId == nil {
		return nil, false
	}
	return o.NotInExperimentVariationId, true
}
...
// SetNotInExperimentVariationId gets a reference to the given string and assigns it to the NotInExperimentVariationId field.
func (o *FlagRep) SetNotInExperimentVariationId(v string) {
	o.NotInExperimentVariationId = &v
}
...
func (o FlagRep) MarshalJSON() ([]byte, error) {
	...
	if o.TargetingRule != nil {
		toSerialize["targetingRule"] = o.TargetingRule
	}
	if o.TargetingRuleDescription != nil {
		toSerialize["targetingRuleDescription"] = o.TargetingRuleDescription
	}
	if o.TargetingRuleClauses != nil {
		toSerialize["targetingRuleClauses"] = o.TargetingRuleClauses
	}
	if o.FlagConfigVersion != nil {
		toSerialize["flagConfigVersion"] = o.FlagConfigVersion
	}
	if o.NotInExperimentVariationId != nil {
		toSerialize["notInExperimentVariationId"] = o.NotInExperimentVariationId
	}
	if true {
...
func NewNullableFlagRep(val *FlagRep) *NullableFlagRep {
	return &NullableFlagRep{value: val, isSet: true}
}
