...
// AnnouncementPatchOperation struct for AnnouncementPatchOperation
type AnnouncementPatchOperation struct {
...
func (o AnnouncementPatchOperation) MarshalJSON() ([]byte, error) {
...
type NullableAnnouncementPatchOperation struct {
	value *AnnouncementPatchOperation
	isSet bool
}

func (v NullableAnnouncementPatchOperation) Get() *AnnouncementPatchOperation {
	return v.value
}

func (v *NullableAnnouncementPatchOperation) Set(val *AnnouncementPatchOperation) {
	v.value = val
	v.isSet = true
}

func (v NullableAnnouncementPatchOperation) IsSet() bool {
	return v.isSet
}

func (v *NullableAnnouncementPatchOperation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnnouncementPatchOperation(val *AnnouncementPatchOperation) *NullableAnnouncementPatchOperation {
	return &NullableAnnouncementPatchOperation{value: val, isSet: true}
}

func (v NullableAnnouncementPatchOperation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAnnouncementPatchOperation) UnmarshalJSON(src []byte) error {
	v.isSet = true
