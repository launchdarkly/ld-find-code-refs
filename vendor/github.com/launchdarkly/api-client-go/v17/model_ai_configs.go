...
// AIConfigs struct for AIConfigs
...
func (o AIConfigs) MarshalJSON() ([]byte, error) {
...
type NullableAIConfigs struct {
	value *AIConfigs
	isSet bool
}

func (v NullableAIConfigs) Get() *AIConfigs {
	return v.value
}

func (v *NullableAIConfigs) Set(val *AIConfigs) {
	v.value = val
	v.isSet = true
}

func (v NullableAIConfigs) IsSet() bool {
	return v.isSet
}

func (v *NullableAIConfigs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAIConfigs(val *AIConfigs) *NullableAIConfigs {
	return &NullableAIConfigs{value: val, isSet: true}
}

func (v NullableAIConfigs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAIConfigs) UnmarshalJSON(src []byte) error {
	v.isSet = true
