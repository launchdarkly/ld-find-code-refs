...
// AnnouncementAccessDeniedReason struct for AnnouncementAccessDeniedReason
type AnnouncementAccessDeniedReason struct {
...
func (o AnnouncementAccessDeniedReason) MarshalJSON() ([]byte, error) {
...
type NullableAnnouncementAccessDeniedReason struct {
	value *AnnouncementAccessDeniedReason
	isSet bool
}

func (v NullableAnnouncementAccessDeniedReason) Get() *AnnouncementAccessDeniedReason {
	return v.value
}

func (v *NullableAnnouncementAccessDeniedReason) Set(val *AnnouncementAccessDeniedReason) {
	v.value = val
	v.isSet = true
}

func (v NullableAnnouncementAccessDeniedReason) IsSet() bool {
	return v.isSet
}

func (v *NullableAnnouncementAccessDeniedReason) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnnouncementAccessDeniedReason(val *AnnouncementAccessDeniedReason) *NullableAnnouncementAccessDeniedReason {
	return &NullableAnnouncementAccessDeniedReason{value: val, isSet: true}
}

func (v NullableAnnouncementAccessDeniedReason) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAnnouncementAccessDeniedReason) UnmarshalJSON(src []byte) error {
	v.isSet = true
