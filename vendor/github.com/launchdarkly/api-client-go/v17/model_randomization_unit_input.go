...
type RandomizationUnitInput struct {
	...
	StandardRandomizationUnit string `json:"standardRandomizationUnit"`
}
...
// GetRandomizationUnitOk returns a tuple with the RandomizationUnit field value
...
// GetStandardRandomizationUnitOk returns a tuple with the StandardRandomizationUnit field value
// and a boolean to check if the value has been set.
...
func NewNullableRandomizationUnitInput(val *RandomizationUnitInput) *NullableRandomizationUnitInput {
	return &NullableRandomizationUnitInput{value: val, isSet: true}
}
