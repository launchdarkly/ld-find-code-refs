...
// UpdateReleasePipelineInput struct for UpdateReleasePipelineInput
type UpdateReleasePipelineInput struct {
...
func NewUpdateReleasePipelineInput(name string, phases []CreatePhaseInput) *UpdateReleasePipelineInput {
	this := UpdateReleasePipelineInput{}
	this.Name = name
	this.Phases = phases
	return &this
}
...
func (o UpdateReleasePipelineInput) MarshalJSON() ([]byte, error) {
...
type NullableUpdateReleasePipelineInput struct {
	value *UpdateReleasePipelineInput
	isSet bool
}

func (v NullableUpdateReleasePipelineInput) Get() *UpdateReleasePipelineInput {
	return v.value
}

func (v *NullableUpdateReleasePipelineInput) Set(val *UpdateReleasePipelineInput) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateReleasePipelineInput) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateReleasePipelineInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateReleasePipelineInput(val *UpdateReleasePipelineInput) *NullableUpdateReleasePipelineInput {
	return &NullableUpdateReleasePipelineInput{value: val, isSet: true}
}

func (v NullableUpdateReleasePipelineInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateReleasePipelineInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
