...
// AiConfigsAccessDeniedReason struct for AiConfigsAccessDeniedReason
type AiConfigsAccessDeniedReason struct {
...
func NewAiConfigsAccessDeniedReason(effect string) *AiConfigsAccessDeniedReason {
	this := AiConfigsAccessDeniedReason{}
	this.Effect = effect
	return &this
}
...
func (o AiConfigsAccessDeniedReason) MarshalJSON() ([]byte, error) {
...
type NullableAiConfigsAccessDeniedReason struct {
	value *AiConfigsAccessDeniedReason
	isSet bool
}

func (v NullableAiConfigsAccessDeniedReason) Get() *AiConfigsAccessDeniedReason {
	return v.value
}

func (v *NullableAiConfigsAccessDeniedReason) Set(val *AiConfigsAccessDeniedReason) {
	v.value = val
	v.isSet = true
}

func (v NullableAiConfigsAccessDeniedReason) IsSet() bool {
	return v.isSet
}

func (v *NullableAiConfigsAccessDeniedReason) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAiConfigsAccessDeniedReason(val *AiConfigsAccessDeniedReason) *NullableAiConfigsAccessDeniedReason {
	return &NullableAiConfigsAccessDeniedReason{value: val, isSet: true}
}

func (v NullableAiConfigsAccessDeniedReason) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAiConfigsAccessDeniedReason) UnmarshalJSON(src []byte) error {
	v.isSet = true
