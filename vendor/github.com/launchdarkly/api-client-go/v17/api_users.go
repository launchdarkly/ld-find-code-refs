...
Delete a user by key.
	...
	Deprecated
	*/
	DeleteUser(ctx context.Context, projectKey string, environmentKey string, userKey string) ApiDeleteUserRequest
...
To paginate through results, follow the `next` link in the `_links` object. To learn more, read [Representations](https://launchdarkly.com/docs/ld-docs/api#representations).
	...
	Deprecated
	*/
	GetSearchUsers(ctx context.Context, projectKey string, environmentKey string) ApiGetSearchUsersRequest

	// GetSearchUsersExecute executes the request
	//  @return Users
	// Deprecated
	GetSearchUsersExecute(r ApiGetSearchUsersRequest) (*Users, *http.Response, error)
...
Get a user by key. The `user` object contains all attributes sent in `variation` calls for that key.
	...
	Deprecated
	*/
	GetUser(ctx context.Context, projectKey string, environmentKey string, userKey string) ApiGetUserRequest

	// GetUserExecute executes the request
	//  @return UserRecord
	// Deprecated
	GetUserExecute(r ApiGetUserRequest) (*UserRecord, *http.Response, error)
...
Each page displays users up to a set `limit`. The default is 20. To page through, follow the `next` link in the `_links` object. To learn more, read [Representations](https://launchdarkly.com/docs/ld-docs/api#representations).
	...
	Deprecated
	*/
	GetUsers(ctx context.Context, projectKey string, environmentKey string) ApiGetUsersRequest

	// GetUsersExecute executes the request
	//  @return UsersRep
	// Deprecated
	GetUsersExecute(r ApiGetUsersRequest) (*UsersRep, *http.Response, error)
}
