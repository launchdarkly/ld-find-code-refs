...
// AnnouncementPaginatedLinks struct for AnnouncementPaginatedLinks
type AnnouncementPaginatedLinks struct {
	First *AnnouncementLink `json:"first,omitempty"`
	Last *AnnouncementLink `json:"last,omitempty"`
	Next *AnnouncementLink `json:"next,omitempty"`
	Prev *AnnouncementLink `json:"prev,omitempty"`
	Self AnnouncementLink `json:"self"`
}
...
func NewAnnouncementPaginatedLinks(self AnnouncementLink) *AnnouncementPaginatedLinks {
	this := AnnouncementPaginatedLinks{}
	this.Self = self
	return &this
}
...
// SetFirst gets a reference to the given AnnouncementLink and assigns it to the First field.
...
// SetLast gets a reference to the given AnnouncementLink and assigns it to the Last field.
...
// SetNext gets a reference to the given AnnouncementLink and assigns it to the Next field.
...
// SetPrev gets a reference to the given AnnouncementLink and assigns it to the Prev field.
...
func (o AnnouncementPaginatedLinks) MarshalJSON() ([]byte, error) {
...
type NullableAnnouncementPaginatedLinks struct {
	value *AnnouncementPaginatedLinks
	isSet bool
}

func (v NullableAnnouncementPaginatedLinks) Get() *AnnouncementPaginatedLinks {
	return v.value
}

func (v *NullableAnnouncementPaginatedLinks) Set(val *AnnouncementPaginatedLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableAnnouncementPaginatedLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableAnnouncementPaginatedLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnnouncementPaginatedLinks(val *AnnouncementPaginatedLinks) *NullableAnnouncementPaginatedLinks {
	return &NullableAnnouncementPaginatedLinks{value: val, isSet: true}
}

func (v NullableAnnouncementPaginatedLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAnnouncementPaginatedLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
