...
// HoldoutPostRequest struct for HoldoutPostRequest
type HoldoutPostRequest struct {
	...
	Holdoutamount *string `json:"holdoutamount,omitempty"`
...
func (o *HoldoutPostRequest) GetRandomizationunit() string {
	if o == nil || o.Randomizationunit == nil {
		var ret string
		return ret
	}
	return *o.Randomizationunit
}

// GetRandomizationunitOk returns a tuple with the Randomizationunit field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HoldoutPostRequest) GetRandomizationunitOk() (*string, bool) {
	if o == nil || o.Randomizationunit == nil {
		return nil, false
	}
	return o.Randomizationunit, true
}
...
// GetHoldoutamount returns the Holdoutamount field value if set, zero value otherwise.
func (o *HoldoutPostRequest) GetHoldoutamount() string {
	if o == nil || o.Holdoutamount == nil {
		var ret string
		return ret
	}
	return *o.Holdoutamount
}

// GetHoldoutamountOk returns a tuple with the Holdoutamount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HoldoutPostRequest) GetHoldoutamountOk() (*string, bool) {
	if o == nil || o.Holdoutamount == nil {
		return nil, false
	}
	return o.Holdoutamount, true
}
...
// SetHoldoutamount gets a reference to the given string and assigns it to the Holdoutamount field.
func (o *HoldoutPostRequest) SetHoldoutamount(v string) {
	o.Holdoutamount = &v
}

// GetPrimarymetrickey returns the Primarymetrickey field value if set, zero value otherwise.
func (o *HoldoutPostRequest) GetPrimarymetrickey() string {
	if o == nil || o.Primarymetrickey == nil {
		var ret string
		return ret
	}
	return *o.Primarymetrickey
}

// GetPrimarymetrickeyOk returns a tuple with the Primarymetrickey field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HoldoutPostRequest) GetPrimarymetrickeyOk() (*string, bool) {
	if o == nil || o.Primarymetrickey == nil {
		return nil, false
	}
	return o.Primarymetrickey, true
}
...
// SetPrimarymetrickey gets a reference to the given string and assigns it to the Primarymetrickey field.
func (o *HoldoutPostRequest) SetPrimarymetrickey(v string) {
	o.Primarymetrickey = &v
}
...
// SetMetrics gets a reference to the given []MetricInput and assigns it to the Metrics field.
func (o *HoldoutPostRequest) SetMetrics(v []MetricInput) {
	o.Metrics = v
}

// GetPrerequisiteflagkey returns the Prerequisiteflagkey field value if set, zero value otherwise.
func (o *HoldoutPostRequest) GetPrerequisiteflagkey() string {
	if o == nil || o.Prerequisiteflagkey == nil {
		var ret string
		return ret
	}
	return *o.Prerequisiteflagkey
}

// GetPrerequisiteflagkeyOk returns a tuple with the Prerequisiteflagkey field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HoldoutPostRequest) GetPrerequisiteflagkeyOk() (*string, bool) {
	if o == nil || o.Prerequisiteflagkey == nil {
		return nil, false
	}
	return o.Prerequisiteflagkey, true
}
...
// SetPrerequisiteflagkey gets a reference to the given string and assigns it to the Prerequisiteflagkey field.
func (o *HoldoutPostRequest) SetPrerequisiteflagkey(v string) {
	o.Prerequisiteflagkey = &v
}
...
func (o HoldoutPostRequest) MarshalJSON() ([]byte, error) {
	...
	if o.Holdoutamount != nil {
		toSerialize["holdoutamount"] = o.Holdoutamount
	}
	if o.Primarymetrickey != nil {
		toSerialize["primarymetrickey"] = o.Primarymetrickey
	}
	if o.Metrics != nil {
		toSerialize["metrics"] = o.Metrics
	}
	if o.Prerequisiteflagkey != nil {
		toSerialize["prerequisiteflagkey"] = o.Prerequisiteflagkey
	}
...
type NullableHoldoutPostRequest struct {
	value *HoldoutPostRequest
	isSet bool
}

func (v NullableHoldoutPostRequest) Get() *HoldoutPostRequest {
	return v.value
}

func (v *NullableHoldoutPostRequest) Set(val *HoldoutPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableHoldoutPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableHoldoutPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHoldoutPostRequest(val *HoldoutPostRequest) *NullableHoldoutPostRequest {
	return &NullableHoldoutPostRequest{value: val, isSet: true}
}

func (v NullableHoldoutPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHoldoutPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
