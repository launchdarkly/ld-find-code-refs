...
func (o *UserSegmentRule) GetRolloutContextKind() string {
	if o == nil || o.RolloutContextKind == nil {
		var ret string
		return ret
	}
	return *o.RolloutContextKind
}

// GetRolloutContextKindOk returns a tuple with the RolloutContextKind field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserSegmentRule) GetRolloutContextKindOk() (*string, bool) {
	if o == nil || o.RolloutContextKind == nil {
		return nil, false
	}
	return o.RolloutContextKind, true
}
...
func (o UserSegmentRule) MarshalJSON() ([]byte, error) {
	...
	if o.RolloutContextKind != nil {
		toSerialize["rolloutContextKind"] = o.RolloutContextKind
	}
	if o.BucketBy != nil {
...
func NewNullableUserSegmentRule(val *UserSegmentRule) *NullableUserSegmentRule {
	return &NullableUserSegmentRule{value: val, isSet: true}
}
