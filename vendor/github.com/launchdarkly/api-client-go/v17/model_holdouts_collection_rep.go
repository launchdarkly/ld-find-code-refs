...
// HoldoutsCollectionRep struct for HoldoutsCollectionRep
type HoldoutsCollectionRep struct {
	Items []SimpleHoldoutRep `json:"items,omitempty"`
...
// SetItems gets a reference to the given []SimpleHoldoutRep and assigns it to the Items field.
...
func (o HoldoutsCollectionRep) MarshalJSON() ([]byte, error) {
...
type NullableHoldoutsCollectionRep struct {
	value *HoldoutsCollectionRep
	isSet bool
}

func (v NullableHoldoutsCollectionRep) Get() *HoldoutsCollectionRep {
	return v.value
}

func (v *NullableHoldoutsCollectionRep) Set(val *HoldoutsCollectionRep) {
	v.value = val
	v.isSet = true
}

func (v NullableHoldoutsCollectionRep) IsSet() bool {
	return v.isSet
}

func (v *NullableHoldoutsCollectionRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHoldoutsCollectionRep(val *HoldoutsCollectionRep) *NullableHoldoutsCollectionRep {
	return &NullableHoldoutsCollectionRep{value: val, isSet: true}
}

func (v NullableHoldoutsCollectionRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHoldoutsCollectionRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
