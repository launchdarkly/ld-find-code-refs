...
// MaintainerMember struct for MaintainerMember
type MaintainerMember struct {
	Id string `json:"_id"`
...
func (o MaintainerMember) MarshalJSON() ([]byte, error) {
...
type NullableMaintainerMember struct {
	value *MaintainerMember
	isSet bool
}

func (v NullableMaintainerMember) Get() *MaintainerMember {
	return v.value
}

func (v *NullableMaintainerMember) Set(val *MaintainerMember) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintainerMember) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintainerMember) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintainerMember(val *MaintainerMember) *NullableMaintainerMember {
	return &NullableMaintainerMember{value: val, isSet: true}
}

func (v NullableMaintainerMember) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMaintainerMember) UnmarshalJSON(src []byte) error {
	v.isSet = true
