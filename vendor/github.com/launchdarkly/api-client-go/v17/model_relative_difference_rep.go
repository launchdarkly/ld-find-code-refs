...
func (o *RelativeDifferenceRep) GetFromTreatmentId() string {
	...
	return *o.FromTreatmentId
}

// GetFromTreatmentIdOk returns a tuple with the FromTreatmentId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RelativeDifferenceRep) GetFromTreatmentIdOk() (*string, bool) {
	if o == nil || o.FromTreatmentId == nil {
		return nil, false
	}
	return o.FromTreatmentId, true
}
...
func NewNullableRelativeDifferenceRep(val *RelativeDifferenceRep) *NullableRelativeDifferenceRep {
	return &NullableRelativeDifferenceRep{value: val, isSet: true}
}
