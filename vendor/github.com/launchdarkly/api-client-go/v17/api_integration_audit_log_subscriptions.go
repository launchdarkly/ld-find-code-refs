...
type IntegrationAuditLogSubscriptionsApi interface {
	...
	*/
	CreateSubscription(ctx context.Context, integrationKey string) ApiCreateSubscriptionRequest

	// CreateSubscriptionExecute executes the request
	//  @return Integration
	CreateSubscriptionExecute(r ApiCreateSubscriptionRequest) (*Integration, *http.Response, error)
	...
	*/
	DeleteSubscription(ctx context.Context, integrationKey string, id string) ApiDeleteSubscriptionRequest
	...
	*/
	GetSubscriptionByID(ctx context.Context, integrationKey string, id string) ApiGetSubscriptionByIDRequest

	// GetSubscriptionByIDExecute executes the request
	//  @return Integration
	GetSubscriptionByIDExecute(r ApiGetSubscriptionByIDRequest) (*Integration, *http.Response, error)
	...
	*/
	GetSubscriptions(ctx context.Context, integrationKey string) ApiGetSubscriptionsRequest

	// GetSubscriptionsExecute executes the request
	//  @return Integrations
	GetSubscriptionsExecute(r ApiGetSubscriptionsRequest) (*Integrations, *http.Response, error)
	...
	*/
	UpdateSubscription(ctx context.Context, integrationKey string, id string) ApiUpdateSubscriptionRequest

	// UpdateSubscriptionExecute executes the request
	//  @return Integration
	UpdateSubscriptionExecute(r ApiUpdateSubscriptionRequest) (*Integration, *http.Response, error)
}
...
type ApiCreateSubscriptionRequest struct {
	ctx context.Context
	ApiService IntegrationAuditLogSubscriptionsApi
