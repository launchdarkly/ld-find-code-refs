...
type ApplicationVersionsCollectionRep struct {
	// The location and content type of related resources
	Links *map[string]Link `json:"_links,omitempty"`
	// A list of the versions for this application
	Items []ApplicationVersionRep `json:"items,omitempty"`
...
func NewApplicationVersionsCollectionRep() *ApplicationVersionsCollectionRep {
	this := ApplicationVersionsCollectionRep{}
	return &this
}
...
type NullableApplicationVersionsCollectionRep struct {
	value *ApplicationVersionsCollectionRep
	isSet bool
}
...
func NewNullableApplicationVersionsCollectionRep(val *ApplicationVersionsCollectionRep) *NullableApplicationVersionsCollectionRep {
	return &NullableApplicationVersionsCollectionRep{value: val, isSet: true}
}
