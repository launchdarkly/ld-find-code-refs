...
type ReleasePhase struct {
	...
	StartedDate *int64 `json:"_startedDate,omitempty"`
...
// SetStartedDate gets a reference to the given int64 and assigns it to the StartedDate field.
...
func (o ReleasePhase) MarshalJSON() ([]byte, error) {
	...
	if o.CompletionDate != nil {
		toSerialize["_completionDate"] = o.CompletionDate
	}
	if o.CompletedBy != nil {
		toSerialize["_completedBy"] = o.CompletedBy
	}
	if true {
		toSerialize["_audiences"] = o.Audiences
	}
	if o.Status != nil {
	...
	if o.StartedDate != nil {
		toSerialize["_startedDate"] = o.StartedDate
	}
...
func NewNullableReleasePhase(val *ReleasePhase) *NullableReleasePhase {
	return &NullableReleasePhase{value: val, isSet: true}
}
