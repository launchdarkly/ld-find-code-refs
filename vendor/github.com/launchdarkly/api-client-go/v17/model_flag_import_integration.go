...
// FlagImportIntegration struct for FlagImportIntegration
type FlagImportIntegration struct {
	Links FlagImportIntegrationLinks `json:"_links"`
	// The integration ID
	Id string `json:"_id"`
	// The integration key
	...
	Status FlagImportStatus `json:"_status"`
}
...
func (o *FlagImportIntegration) GetLinks() FlagImportIntegrationLinks {
	if o == nil {
		var ret FlagImportIntegrationLinks
		return ret
	}
...
func (o FlagImportIntegration) MarshalJSON() ([]byte, error) {
...
type NullableFlagImportIntegration struct {
	value *FlagImportIntegration
	isSet bool
}

func (v NullableFlagImportIntegration) Get() *FlagImportIntegration {
	return v.value
}

func (v *NullableFlagImportIntegration) Set(val *FlagImportIntegration) {
	v.value = val
	v.isSet = true
}

func (v NullableFlagImportIntegration) IsSet() bool {
	return v.isSet
}

func (v *NullableFlagImportIntegration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlagImportIntegration(val *FlagImportIntegration) *NullableFlagImportIntegration {
	return &NullableFlagImportIntegration{value: val, isSet: true}
}

func (v NullableFlagImportIntegration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlagImportIntegration) UnmarshalJSON(src []byte) error {
	v.isSet = true
