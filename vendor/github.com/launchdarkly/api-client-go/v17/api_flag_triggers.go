...
type FlagTriggersApi interface {
	...
	*/
	CreateTriggerWorkflow(ctx context.Context, projectKey string, environmentKey string, featureFlagKey string) ApiCreateTriggerWorkflowRequest

	// CreateTriggerWorkflowExecute executes the request
	//  @return TriggerWorkflowRep
	CreateTriggerWorkflowExecute(r ApiCreateTriggerWorkflowRequest) (*TriggerWorkflowRep, *http.Response, error)
	...
	*/
	DeleteTriggerWorkflow(ctx context.Context, projectKey string, environmentKey string, featureFlagKey string, id string) ApiDeleteTriggerWorkflowRequest

	// DeleteTriggerWorkflowExecute executes the request
	DeleteTriggerWorkflowExecute(r ApiDeleteTriggerWorkflowRequest) (*http.Response, error)
	...
	*/
	...
	//  @return TriggerWorkflowRep
	GetTriggerWorkflowByIdExecute(r ApiGetTriggerWorkflowByIdRequest) (*TriggerWorkflowRep, *http.Response, error)
	...
	*/
	GetTriggerWorkflows(ctx context.Context, projectKey string, environmentKey string, featureFlagKey string) ApiGetTriggerWorkflowsRequest

	// GetTriggerWorkflowsExecute executes the request
	//  @return TriggerWorkflowCollectionRep
	GetTriggerWorkflowsExecute(r ApiGetTriggerWorkflowsRequest) (*TriggerWorkflowCollectionRep, *http.Response, error)
...
```
	...
	*/
	PatchTriggerWorkflow(ctx context.Context, projectKey string, environmentKey string, featureFlagKey string, id string) ApiPatchTriggerWorkflowRequest

	// PatchTriggerWorkflowExecute executes the request
	//  @return TriggerWorkflowRep
	PatchTriggerWorkflowExecute(r ApiPatchTriggerWorkflowRequest) (*TriggerWorkflowRep, *http.Response, error)
}
...
func (a *FlagTriggersApiService) CreateTriggerWorkflowExecute(r ApiCreateTriggerWorkflowRequest) (*TriggerWorkflowRep, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *TriggerWorkflowRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FlagTriggersApiService.CreateTriggerWorkflow")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/flags/{projectKey}/{featureFlagKey}/triggers/{environmentKey}"
	...
	if r.triggerPost == nil {
		return localVarReturnValue, nil, reportError("triggerPost is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.triggerPost
	if r.ctx != nil {
...
func (r ApiDeleteTriggerWorkflowRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteTriggerWorkflowExecute(r)
}
...
func (a *FlagTriggersApiService) DeleteTriggerWorkflowExecute(r ApiDeleteTriggerWorkflowRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FlagTriggersApiService.DeleteTriggerWorkflow")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/flags/{projectKey}/{featureFlagKey}/triggers/{environmentKey}/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterToString(r.projectKey, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", url.PathEscape(parameterToString(r.environmentKey, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagKey"+"}", url.PathEscape(parameterToString(r.featureFlagKey, "")), -1)
...
func (r ApiGetTriggerWorkflowByIdRequest) Execute() (*TriggerWorkflowRep, *http.Response, error) {
	return r.ApiService.GetTriggerWorkflowByIdExecute(r)
}
...
func (a *FlagTriggersApiService) GetTriggerWorkflowByIdExecute(r ApiGetTriggerWorkflowByIdRequest) (*TriggerWorkflowRep, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FlagTriggersApiService.GetTriggerWorkflowById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetTriggerWorkflowsRequest) Execute() (*TriggerWorkflowCollectionRep, *http.Response, error) {
	return r.ApiService.GetTriggerWorkflowsExecute(r)
}
...
func (a *FlagTriggersApiService) GetTriggerWorkflowsExecute(r ApiGetTriggerWorkflowsRequest) (*TriggerWorkflowCollectionRep, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *TriggerWorkflowCollectionRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FlagTriggersApiService.GetTriggerWorkflows")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiPatchTriggerWorkflowRequest) FlagTriggerInput(flagTriggerInput FlagTriggerInput) ApiPatchTriggerWorkflowRequest {
	r.flagTriggerInput = &flagTriggerInput
	return r
}

func (r ApiPatchTriggerWorkflowRequest) Execute() (*TriggerWorkflowRep, *http.Response, error) {
	return r.ApiService.PatchTriggerWorkflowExecute(r)
}
...
func (a *FlagTriggersApiService) PatchTriggerWorkflowExecute(r ApiPatchTriggerWorkflowRequest) (*TriggerWorkflowRep, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FlagTriggersApiService.PatchTriggerWorkflow")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.flagTriggerInput == nil {
		return localVarReturnValue, nil, reportError("flagTriggerInput is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.flagTriggerInput
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
