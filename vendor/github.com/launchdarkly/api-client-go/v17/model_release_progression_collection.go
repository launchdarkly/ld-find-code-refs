...
// ReleaseProgressionCollection struct for ReleaseProgressionCollection
type ReleaseProgressionCollection struct {
	...
	Items []ReleaseProgression `json:"items"`
...
func NewReleaseProgressionCollection(activeCount int32, completedCount int32, items []ReleaseProgression, phases []PhaseInfo, totalCount int32, links map[string]Link) *ReleaseProgressionCollection {
	this := ReleaseProgressionCollection{}
...
func (o ReleaseProgressionCollection) MarshalJSON() ([]byte, error) {
...
type NullableReleaseProgressionCollection struct {
	value *ReleaseProgressionCollection
	isSet bool
}

func (v NullableReleaseProgressionCollection) Get() *ReleaseProgressionCollection {
	return v.value
}

func (v *NullableReleaseProgressionCollection) Set(val *ReleaseProgressionCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableReleaseProgressionCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableReleaseProgressionCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReleaseProgressionCollection(val *ReleaseProgressionCollection) *NullableReleaseProgressionCollection {
	return &NullableReleaseProgressionCollection{value: val, isSet: true}
}

func (v NullableReleaseProgressionCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReleaseProgressionCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
