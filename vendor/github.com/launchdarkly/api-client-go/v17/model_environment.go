...
type Environment struct {
	...
	ResourceApprovalSettings *map[string]ApprovalSettings `json:"resourceApprovalSettings,omitempty"`
...
// GetMobileKeyOk returns a tuple with the MobileKey field value
// and a boolean to check if the value has been set.
...
// GetDefaultTrackEventsOk returns a tuple with the DefaultTrackEvents field value
// and a boolean to check if the value has been set.
...
// GetResourceApprovalSettings returns the ResourceApprovalSettings field value if set, zero value otherwise.
func (o *Environment) GetResourceApprovalSettings() map[string]ApprovalSettings {
	if o == nil || o.ResourceApprovalSettings == nil {
		var ret map[string]ApprovalSettings
		return ret
	}
	return *o.ResourceApprovalSettings
}

// GetResourceApprovalSettingsOk returns a tuple with the ResourceApprovalSettings field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Environment) GetResourceApprovalSettingsOk() (*map[string]ApprovalSettings, bool) {
	if o == nil || o.ResourceApprovalSettings == nil {
		return nil, false
	}
	return o.ResourceApprovalSettings, true
}
...
// SetResourceApprovalSettings gets a reference to the given map[string]ApprovalSettings and assigns it to the ResourceApprovalSettings field.
func (o *Environment) SetResourceApprovalSettings(v map[string]ApprovalSettings) {
	o.ResourceApprovalSettings = &v
}
...
func (o Environment) MarshalJSON() ([]byte, error) {
	...
	if o.ResourceApprovalSettings != nil {
		toSerialize["resourceApprovalSettings"] = o.ResourceApprovalSettings
	}
	if true {
