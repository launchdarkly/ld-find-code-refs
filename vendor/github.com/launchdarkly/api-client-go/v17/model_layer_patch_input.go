...
// LayerPatchInput struct for LayerPatchInput
...
func (o LayerPatchInput) MarshalJSON() ([]byte, error) {
...
type NullableLayerPatchInput struct {
	value *LayerPatchInput
	isSet bool
}

func (v NullableLayerPatchInput) Get() *LayerPatchInput {
	return v.value
}

func (v *NullableLayerPatchInput) Set(val *LayerPatchInput) {
	v.value = val
	v.isSet = true
}

func (v NullableLayerPatchInput) IsSet() bool {
	return v.isSet
}

func (v *NullableLayerPatchInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLayerPatchInput(val *LayerPatchInput) *NullableLayerPatchInput {
	return &NullableLayerPatchInput{value: val, isSet: true}
}

func (v NullableLayerPatchInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLayerPatchInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
