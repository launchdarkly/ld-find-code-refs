...
type ApplicationsBetaApi interface {
	...
	*/
	DeleteApplication(ctx context.Context, applicationKey string) ApiDeleteApplicationRequest
	...
	*/
	DeleteApplicationVersion(ctx context.Context, applicationKey string, versionKey string) ApiDeleteApplicationVersionRequest
...
For example, use `?expand=flags` to include the `flags` field in the response. By default, this field is **not** included in the response.
	...
	*/
	GetApplication(ctx context.Context, applicationKey string) ApiGetApplicationRequest

	// GetApplicationExecute executes the request
	//  @return ApplicationRep
	GetApplicationExecute(r ApiGetApplicationRequest) (*ApplicationRep, *http.Response, error)
	...
	*/
	GetApplicationVersions(ctx context.Context, applicationKey string) ApiGetApplicationVersionsRequest

	// GetApplicationVersionsExecute executes the request
	//  @return ApplicationVersionsCollectionRep
	GetApplicationVersionsExecute(r ApiGetApplicationVersionsRequest) (*ApplicationVersionsCollectionRep, *http.Response, error)
...
For example, use `?expand=flags` to include the `flags` field in the response. By default, this field is **not** included in the response.
	...
	*/
	...
	GetApplicationsExecute(r ApiGetApplicationsRequest) (*ApplicationCollectionRep, *http.Response, error)
	...
	*/
	PatchApplication(ctx context.Context, applicationKey string) ApiPatchApplicationRequest

	// PatchApplicationExecute executes the request
	//  @return ApplicationRep
	PatchApplicationExecute(r ApiPatchApplicationRequest) (*ApplicationRep, *http.Response, error)
	...
	*/
	PatchApplicationVersion(ctx context.Context, applicationKey string, versionKey string) ApiPatchApplicationVersionRequest

	// PatchApplicationVersionExecute executes the request
	//  @return ApplicationVersionRep
	PatchApplicationVersionExecute(r ApiPatchApplicationVersionRequest) (*ApplicationVersionRep, *http.Response, error)
}
...
type ApiDeleteApplicationRequest struct {
	ctx context.Context
	ApiService ApplicationsBetaApi
