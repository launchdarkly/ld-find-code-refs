...
type ScheduledChangesApi interface {
	...
	*/
	DeleteFlagConfigScheduledChanges(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, id string) ApiDeleteFlagConfigScheduledChangesRequest

	// DeleteFlagConfigScheduledChangesExecute executes the request
	DeleteFlagConfigScheduledChangesExecute(r ApiDeleteFlagConfigScheduledChangesRequest) (*http.Response, error)
	...
	*/
	GetFeatureFlagScheduledChange(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, id string) ApiGetFeatureFlagScheduledChangeRequest

	// GetFeatureFlagScheduledChangeExecute executes the request
	//  @return FeatureFlagScheduledChange
	GetFeatureFlagScheduledChangeExecute(r ApiGetFeatureFlagScheduledChangeRequest) (*FeatureFlagScheduledChange, *http.Response, error)
	...
	*/
	GetFlagConfigScheduledChanges(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string) ApiGetFlagConfigScheduledChangesRequest

	// GetFlagConfigScheduledChangesExecute executes the request
	//  @return FeatureFlagScheduledChanges
	GetFlagConfigScheduledChangesExecute(r ApiGetFlagConfigScheduledChangesRequest) (*FeatureFlagScheduledChanges, *http.Response, error)
...
```
	...
	*/
	PatchFlagConfigScheduledChange(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, id string) ApiPatchFlagConfigScheduledChangeRequest

	// PatchFlagConfigScheduledChangeExecute executes the request
	//  @return FeatureFlagScheduledChange
	PatchFlagConfigScheduledChangeExecute(r ApiPatchFlagConfigScheduledChangeRequest) (*FeatureFlagScheduledChange, *http.Response, error)
	...
	*/
	...
	//  @return FeatureFlagScheduledChange
	PostFlagConfigScheduledChangesExecute(r ApiPostFlagConfigScheduledChangesRequest) (*FeatureFlagScheduledChange, *http.Response, error)
}
...
type ApiDeleteFlagConfigScheduledChangesRequest struct {
	ctx context.Context
	ApiService ScheduledChangesApi
	projectKey string
...
func (r ApiDeleteFlagConfigScheduledChangesRequest) Execute() (*http.Response, error) {
...
func (r ApiPatchFlagConfigScheduledChangeRequest) FlagScheduledChangesInput(flagScheduledChangesInput FlagScheduledChangesInput) ApiPatchFlagConfigScheduledChangeRequest {
	r.flagScheduledChangesInput = &flagScheduledChangesInput
	return r
}
...
func (a *ScheduledChangesApiService) PatchFlagConfigScheduledChangeExecute(r ApiPatchFlagConfigScheduledChangeRequest) (*FeatureFlagScheduledChange, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.flagScheduledChangesInput == nil {
		return localVarReturnValue, nil, reportError("flagScheduledChangesInput is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.flagScheduledChangesInput
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
...
func (r ApiPostFlagConfigScheduledChangesRequest) PostFlagScheduledChangesInput(postFlagScheduledChangesInput PostFlagScheduledChangesInput) ApiPostFlagConfigScheduledChangesRequest {
	r.postFlagScheduledChangesInput = &postFlagScheduledChangesInput
	return r
}
...
func (a *ScheduledChangesApiService) PostFlagConfigScheduledChangesExecute(r ApiPostFlagConfigScheduledChangesRequest) (*FeatureFlagScheduledChange, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.postFlagScheduledChangesInput == nil {
		return localVarReturnValue, nil, reportError("postFlagScheduledChangesInput is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.postFlagScheduledChangesInput
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
