...
type Release struct {
	...
	ReleasePipelineKey string `json:"releasePipelineKey"`
	// The release pipeline description
	ReleasePipelineDescription string `json:"releasePipelineDescription"`
	// An ordered list of the release pipeline phases
	Phases []ReleasePhase `json:"phases"`
	// The release version
	Version int32 `json:"_version"`
	// The chosen release variation ID to use across all phases of a release
	ReleaseVariationId *string `json:"_releaseVariationId,omitempty"`
	CanceledAt *int64 `json:"_canceledAt,omitempty"`
}
...
// GetReleasePipelineKeyOk returns a tuple with the ReleasePipelineKey field value
// and a boolean to check if the value has been set.
...
// GetReleaseVariationId returns the ReleaseVariationId field value if set, zero value otherwise.
func (o *Release) GetReleaseVariationId() string {
	if o == nil || o.ReleaseVariationId == nil {
		var ret string
		return ret
	}
	return *o.ReleaseVariationId
}

// GetReleaseVariationIdOk returns a tuple with the ReleaseVariationId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Release) GetReleaseVariationIdOk() (*string, bool) {
	if o == nil || o.ReleaseVariationId == nil {
		return nil, false
	}
	return o.ReleaseVariationId, true
}
...
// SetReleaseVariationId gets a reference to the given string and assigns it to the ReleaseVariationId field.
func (o *Release) SetReleaseVariationId(v string) {
	o.ReleaseVariationId = &v
}
...
func (o Release) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["releasePipelineDescription"] = o.ReleasePipelineDescription
	}
	if true {
	...
	if o.ReleaseVariationId != nil {
		toSerialize["_releaseVariationId"] = o.ReleaseVariationId
	}
	if o.CanceledAt != nil {
		toSerialize["_canceledAt"] = o.CanceledAt
	}
