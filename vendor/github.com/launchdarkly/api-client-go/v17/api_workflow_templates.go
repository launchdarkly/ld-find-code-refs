...
type WorkflowTemplatesApi interface {
	...
	*/
	CreateWorkflowTemplate(ctx context.Context) ApiCreateWorkflowTemplateRequest

	// CreateWorkflowTemplateExecute executes the request
	//  @return WorkflowTemplateOutput
	CreateWorkflowTemplateExecute(r ApiCreateWorkflowTemplateRequest) (*WorkflowTemplateOutput, *http.Response, error)
	...
	*/
	...
	DeleteWorkflowTemplateExecute(r ApiDeleteWorkflowTemplateRequest) (*http.Response, error)
	...
	*/
	GetWorkflowTemplates(ctx context.Context) ApiGetWorkflowTemplatesRequest

	// GetWorkflowTemplatesExecute executes the request
	//  @return WorkflowTemplatesListingOutputRep
	GetWorkflowTemplatesExecute(r ApiGetWorkflowTemplatesRequest) (*WorkflowTemplatesListingOutputRep, *http.Response, error)
}
...
type ApiCreateWorkflowTemplateRequest struct {
	ctx context.Context
	ApiService WorkflowTemplatesApi
...
func (r ApiCreateWorkflowTemplateRequest) CreateWorkflowTemplateInput(createWorkflowTemplateInput CreateWorkflowTemplateInput) ApiCreateWorkflowTemplateRequest {
	r.createWorkflowTemplateInput = &createWorkflowTemplateInput
	return r
}
...
func (a *WorkflowTemplatesApiService) CreateWorkflowTemplateExecute(r ApiCreateWorkflowTemplateRequest) (*WorkflowTemplateOutput, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *WorkflowTemplateOutput
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowTemplatesApiService.CreateWorkflowTemplate")
	if err != nil {
	...
	if r.createWorkflowTemplateInput == nil {
		return localVarReturnValue, nil, reportError("createWorkflowTemplateInput is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createWorkflowTemplateInput
	if r.ctx != nil {
...
func (a *WorkflowTemplatesApiService) DeleteWorkflowTemplateExecute(r ApiDeleteWorkflowTemplateRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowTemplatesApiService.DeleteWorkflowTemplate")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/templates/{templateKey}"
	localVarPath = strings.Replace(localVarPath, "{"+"templateKey"+"}", url.PathEscape(parameterToString(r.templateKey, "")), -1)
...
func (a *WorkflowTemplatesApiService) GetWorkflowTemplatesExecute(r ApiGetWorkflowTemplatesRequest) (*WorkflowTemplatesListingOutputRep, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *WorkflowTemplatesListingOutputRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowTemplatesApiService.GetWorkflowTemplates")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
