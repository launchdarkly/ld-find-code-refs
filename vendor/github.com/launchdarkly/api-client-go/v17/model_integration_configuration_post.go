...
// IntegrationConfigurationPost struct for IntegrationConfigurationPost
type IntegrationConfigurationPost struct {
	...
	CapabilityConfig *CapabilityConfigPost `json:"capabilityConfig,omitempty"`
}
...
func NewIntegrationConfigurationPost(name string, configValues map[string]interface{}) *IntegrationConfigurationPost {
	this := IntegrationConfigurationPost{}
	this.Name = name
...
// GetConfigValues returns the ConfigValues field value
...
// GetConfigValuesOk returns a tuple with the ConfigValues field value
// and a boolean to check if the value has been set.
...
// SetConfigValues sets field value
...
// SetCapabilityConfig gets a reference to the given CapabilityConfigPost and assigns it to the CapabilityConfig field.
func (o *IntegrationConfigurationPost) SetCapabilityConfig(v CapabilityConfigPost) {
	o.CapabilityConfig = &v
}

func (o IntegrationConfigurationPost) MarshalJSON() ([]byte, error) {
...
type NullableIntegrationConfigurationPost struct {
	value *IntegrationConfigurationPost
	isSet bool
}

func (v NullableIntegrationConfigurationPost) Get() *IntegrationConfigurationPost {
	return v.value
}

func (v *NullableIntegrationConfigurationPost) Set(val *IntegrationConfigurationPost) {
	v.value = val
	v.isSet = true
}

func (v NullableIntegrationConfigurationPost) IsSet() bool {
	return v.isSet
}

func (v *NullableIntegrationConfigurationPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIntegrationConfigurationPost(val *IntegrationConfigurationPost) *NullableIntegrationConfigurationPost {
	return &NullableIntegrationConfigurationPost{value: val, isSet: true}
}

func (v NullableIntegrationConfigurationPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIntegrationConfigurationPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
