...
// AIConfigPatch struct for AIConfigPatch
...
func (o AIConfigPatch) MarshalJSON() ([]byte, error) {
...
type NullableAIConfigPatch struct {
	value *AIConfigPatch
	isSet bool
}

func (v NullableAIConfigPatch) Get() *AIConfigPatch {
	return v.value
}

func (v *NullableAIConfigPatch) Set(val *AIConfigPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableAIConfigPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableAIConfigPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAIConfigPatch(val *AIConfigPatch) *NullableAIConfigPatch {
	return &NullableAIConfigPatch{value: val, isSet: true}
}

func (v NullableAIConfigPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAIConfigPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
