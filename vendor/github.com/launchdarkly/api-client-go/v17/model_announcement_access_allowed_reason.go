...
// AnnouncementAccessAllowedReason struct for AnnouncementAccessAllowedReason
type AnnouncementAccessAllowedReason struct {
...
func NewAnnouncementAccessAllowedReason(effect string) *AnnouncementAccessAllowedReason {
	this := AnnouncementAccessAllowedReason{}
	this.Effect = effect
	return &this
}
...
func (o AnnouncementAccessAllowedReason) MarshalJSON() ([]byte, error) {
...
type NullableAnnouncementAccessAllowedReason struct {
	value *AnnouncementAccessAllowedReason
	isSet bool
}

func (v NullableAnnouncementAccessAllowedReason) Get() *AnnouncementAccessAllowedReason {
	return v.value
}

func (v *NullableAnnouncementAccessAllowedReason) Set(val *AnnouncementAccessAllowedReason) {
	v.value = val
	v.isSet = true
}

func (v NullableAnnouncementAccessAllowedReason) IsSet() bool {
	return v.isSet
}

func (v *NullableAnnouncementAccessAllowedReason) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnnouncementAccessAllowedReason(val *AnnouncementAccessAllowedReason) *NullableAnnouncementAccessAllowedReason {
	return &NullableAnnouncementAccessAllowedReason{value: val, isSet: true}
}

func (v NullableAnnouncementAccessAllowedReason) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAnnouncementAccessAllowedReason) UnmarshalJSON(src []byte) error {
	v.isSet = true
