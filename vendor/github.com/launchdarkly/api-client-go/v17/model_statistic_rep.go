...
type StatisticRep struct {
	...
	LatestCommitTime *int64 `json:"latestCommitTime,omitempty"`
}
...
// GetLatestCommitTime returns the LatestCommitTime field value if set, zero value otherwise.
func (o *StatisticRep) GetLatestCommitTime() int64 {
	if o == nil || o.LatestCommitTime == nil {
		var ret int64
		return ret
	}
	return *o.LatestCommitTime
}

// GetLatestCommitTimeOk returns a tuple with the LatestCommitTime field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StatisticRep) GetLatestCommitTimeOk() (*int64, bool) {
	if o == nil || o.LatestCommitTime == nil {
		return nil, false
	}
	return o.LatestCommitTime, true
}
...
// SetLatestCommitTime gets a reference to the given int64 and assigns it to the LatestCommitTime field.
func (o *StatisticRep) SetLatestCommitTime(v int64) {
	o.LatestCommitTime = &v
}
...
func (o StatisticRep) MarshalJSON() ([]byte, error) {
	...
	if o.LatestCommitTime != nil {
		toSerialize["latestCommitTime"] = o.LatestCommitTime
	}
...
func NewNullableStatisticRep(val *StatisticRep) *NullableStatisticRep {
	return &NullableStatisticRep{value: val, isSet: true}
}
