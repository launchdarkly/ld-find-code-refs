...
type UserSettingsApi interface {
	...
	Deprecated
	*/
	GetExpiringFlagsForUser(ctx context.Context, projectKey string, userKey string, environmentKey string) ApiGetExpiringFlagsForUserRequest

	// GetExpiringFlagsForUserExecute executes the request
	//  @return ExpiringUserTargetGetResponse
	// Deprecated
	GetExpiringFlagsForUserExecute(r ApiGetExpiringFlagsForUserRequest) (*ExpiringUserTargetGetResponse, *http.Response, error)
	...
	Deprecated
	*/
	GetUserFlagSetting(ctx context.Context, projectKey string, environmentKey string, userKey string, featureFlagKey string) ApiGetUserFlagSettingRequest

	// GetUserFlagSettingExecute executes the request
	//  @return UserFlagSetting
	// Deprecated
	GetUserFlagSettingExecute(r ApiGetUserFlagSettingRequest) (*UserFlagSetting, *http.Response, error)
	...
	Deprecated
	*/
	GetUserFlagSettings(ctx context.Context, projectKey string, environmentKey string, userKey string) ApiGetUserFlagSettingsRequest

	// GetUserFlagSettingsExecute executes the request
	//  @return UserFlagSettings
	// Deprecated
	GetUserFlagSettingsExecute(r ApiGetUserFlagSettingsRequest) (*UserFlagSettings, *http.Response, error)
...
* `variationId`: ID of a variation on the flag
	...
	Deprecated
	*/
	PatchExpiringFlagsForUser(ctx context.Context, projectKey string, userKey string, environmentKey string) ApiPatchExpiringFlagsForUserRequest

	// PatchExpiringFlagsForUserExecute executes the request
	//  @return ExpiringUserTargetPatchResponse
	// Deprecated
	PatchExpiringFlagsForUserExecute(r ApiPatchExpiringFlagsForUserRequest) (*ExpiringUserTargetPatchResponse, *http.Response, error)
...
If you previously patched the flag, and the patch included the user's data, LaunchDarkly continues to use that data. If LaunchDarkly has never encountered the user's key before, it calculates the flag values based on the user key alone.
	...
	Deprecated
	*/
	PutFlagSetting(ctx context.Context, projectKey string, environmentKey string, userKey string, featureFlagKey string) ApiPutFlagSettingRequest

	// PutFlagSettingExecute executes the request
	// Deprecated
	PutFlagSettingExecute(r ApiPutFlagSettingRequest) (*http.Response, error)
}
...
func (r ApiGetExpiringFlagsForUserRequest) Execute() (*ExpiringUserTargetGetResponse, *http.Response, error) {
	return r.ApiService.GetExpiringFlagsForUserExecute(r)
}
...
func (a *UserSettingsApiService) GetExpiringFlagsForUserExecute(r ApiGetExpiringFlagsForUserRequest) (*ExpiringUserTargetGetResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserSettingsApiService.GetExpiringFlagsForUser")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/users/{projectKey}/{userKey}/expiring-user-targets/{environmentKey}"
...
func (a *UserSettingsApiService) GetUserFlagSettingExecute(r ApiGetUserFlagSettingRequest) (*UserFlagSetting, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/users/{projectKey}/{environmentKey}/{userKey}/flags/{featureFlagKey}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterToString(r.projectKey, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", url.PathEscape(parameterToString(r.environmentKey, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"userKey"+"}", url.PathEscape(parameterToString(r.userKey, "")), -1)
...
func (a *UserSettingsApiService) GetUserFlagSettingsExecute(r ApiGetUserFlagSettingsRequest) (*UserFlagSettings, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/users/{projectKey}/{environmentKey}/{userKey}/flags"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterToString(r.projectKey, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", url.PathEscape(parameterToString(r.environmentKey, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"userKey"+"}", url.PathEscape(parameterToString(r.userKey, "")), -1)
...
func (a *UserSettingsApiService) PatchExpiringFlagsForUserExecute(r ApiPatchExpiringFlagsForUserRequest) (*ExpiringUserTargetPatchResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserSettingsApiService.PatchExpiringFlagsForUser")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.patchUsersRequest == nil {
		return localVarReturnValue, nil, reportError("patchUsersRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.patchUsersRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
...
func (a *UserSettingsApiService) PutFlagSettingExecute(r ApiPutFlagSettingRequest) (*http.Response, error) {
	...
	localVarFormParams := url.Values{}
	if r.valuePut == nil {
		return nil, reportError("valuePut is required and must be specified")
	}
