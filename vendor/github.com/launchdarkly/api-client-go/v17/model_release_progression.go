...
// ReleaseProgression struct for ReleaseProgression
type ReleaseProgression struct {
	CreatedAt int64 `json:"_createdAt"`
	CompletedAt *int64 `json:"_completedAt,omitempty"`
	// The flag key
...
// GetActivePhaseId returns the ActivePhaseId field value if set, zero value otherwise.
func (o *ReleaseProgression) GetActivePhaseId() string {
	if o == nil || o.ActivePhaseId == nil {
		var ret string
		return ret
	}
	return *o.ActivePhaseId
}

// GetActivePhaseIdOk returns a tuple with the ActivePhaseId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReleaseProgression) GetActivePhaseIdOk() (*string, bool) {
	if o == nil || o.ActivePhaseId == nil {
		return nil, false
	}
	return o.ActivePhaseId, true
}
...
// SetActivePhaseId gets a reference to the given string and assigns it to the ActivePhaseId field.
...
func (o ReleaseProgression) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["_createdAt"] = o.CreatedAt
	}
	if o.CompletedAt != nil {
		toSerialize["_completedAt"] = o.CompletedAt
	}
	if true {
		toSerialize["flagKey"] = o.FlagKey
	}
	if o.ActivePhaseId != nil {
		toSerialize["activePhaseId"] = o.ActivePhaseId
	}
	if true {
...
type NullableReleaseProgression struct {
	value *ReleaseProgression
	isSet bool
}

func (v NullableReleaseProgression) Get() *ReleaseProgression {
	return v.value
}

func (v *NullableReleaseProgression) Set(val *ReleaseProgression) {
	v.value = val
	v.isSet = true
}

func (v NullableReleaseProgression) IsSet() bool {
	return v.isSet
}

func (v *NullableReleaseProgression) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReleaseProgression(val *ReleaseProgression) *NullableReleaseProgression {
	return &NullableReleaseProgression{value: val, isSet: true}
}

func (v NullableReleaseProgression) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReleaseProgression) UnmarshalJSON(src []byte) error {
	v.isSet = true
