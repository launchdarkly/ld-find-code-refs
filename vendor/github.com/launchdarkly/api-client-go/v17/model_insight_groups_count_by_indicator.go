...
type InsightGroupsCountByIndicator struct {
	...
	NeedsAttention int32 `json:"needsAttention"`
	// The number of insight groups with a not calculated indicator
	NotCalculated int32 `json:"notCalculated"`
...
func NewInsightGroupsCountByIndicator(excellent int32, good int32, fair int32, needsAttention int32, notCalculated int32, unknown int32, total int32) *InsightGroupsCountByIndicator {
	this := InsightGroupsCountByIndicator{}
...
// GetExcellentOk returns a tuple with the Excellent field value
// and a boolean to check if the value has been set.
func (o *InsightGroupsCountByIndicator) GetExcellentOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Excellent, true
}
...
// GetFairOk returns a tuple with the Fair field value
// and a boolean to check if the value has been set.
...
func (o *InsightGroupsCountByIndicator) GetNotCalculated() int32 {
	...
	return o.NotCalculated
}

// GetNotCalculatedOk returns a tuple with the NotCalculated field value
// and a boolean to check if the value has been set.
func (o *InsightGroupsCountByIndicator) GetNotCalculatedOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.NotCalculated, true
}
...
func (o InsightGroupsCountByIndicator) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["excellent"] = o.Excellent
	}
	if true {
	...
	if true {
		toSerialize["notCalculated"] = o.NotCalculated
	}
	if true {
...
type NullableInsightGroupsCountByIndicator struct {
	value *InsightGroupsCountByIndicator
	isSet bool
}
...
func NewNullableInsightGroupsCountByIndicator(val *InsightGroupsCountByIndicator) *NullableInsightGroupsCountByIndicator {
	return &NullableInsightGroupsCountByIndicator{value: val, isSet: true}
}
