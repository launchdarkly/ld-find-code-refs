...
// FormVariable struct for FormVariable
...
// GetDynamicOptions returns the DynamicOptions field value if set, zero value otherwise.
func (o *FormVariable) GetDynamicOptions() DynamicOptions {
	if o == nil || o.DynamicOptions == nil {
		var ret DynamicOptions
		return ret
	}
	return *o.DynamicOptions
}

// GetDynamicOptionsOk returns a tuple with the DynamicOptions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FormVariable) GetDynamicOptionsOk() (*DynamicOptions, bool) {
	if o == nil || o.DynamicOptions == nil {
		return nil, false
	}
	return o.DynamicOptions, true
}
...
// SetDynamicOptions gets a reference to the given DynamicOptions and assigns it to the DynamicOptions field.
func (o *FormVariable) SetDynamicOptions(v DynamicOptions) {
	o.DynamicOptions = &v
}

func (o FormVariable) MarshalJSON() ([]byte, error) {
	...
	if o.DynamicOptions != nil {
		toSerialize["dynamicOptions"] = o.DynamicOptions
	}
	return json.Marshal(toSerialize)
}

type NullableFormVariable struct {
	value *FormVariable
	isSet bool
}

func (v NullableFormVariable) Get() *FormVariable {
	return v.value
}

func (v *NullableFormVariable) Set(val *FormVariable) {
	v.value = val
	v.isSet = true
}

func (v NullableFormVariable) IsSet() bool {
	return v.isSet
}

func (v *NullableFormVariable) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFormVariable(val *FormVariable) *NullableFormVariable {
	return &NullableFormVariable{value: val, isSet: true}
}

func (v NullableFormVariable) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFormVariable) UnmarshalJSON(src []byte) error {
	v.isSet = true
