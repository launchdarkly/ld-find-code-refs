...
type InsightsScoresBetaApi interface {
	...
	@return ApiCreateInsightGroupRequest
	*/
	CreateInsightGroup(ctx context.Context) ApiCreateInsightGroupRequest

	// CreateInsightGroupExecute executes the request
	//  @return InsightGroup
	CreateInsightGroupExecute(r ApiCreateInsightGroupRequest) (*InsightGroup, *http.Response, error)
	...
	@return ApiDeleteInsightGroupRequest
	*/
	DeleteInsightGroup(ctx context.Context, insightGroupKey string) ApiDeleteInsightGroupRequest

	// DeleteInsightGroupExecute executes the request
	DeleteInsightGroupExecute(r ApiDeleteInsightGroupRequest) (*http.Response, error)
...
For example, use `?expand=scores` to include the `scores` field in the response. By default, this field is **not** included in the response.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param insightGroupKey The insight group key
	@return ApiGetInsightGroupRequest
	*/
	GetInsightGroup(ctx context.Context, insightGroupKey string) ApiGetInsightGroupRequest

	// GetInsightGroupExecute executes the request
	//  @return InsightGroup
	GetInsightGroupExecute(r ApiGetInsightGroupRequest) (*InsightGroup, *http.Response, error)
...
For example, use `?expand=scores` to include the `scores` field in the response. By default, this field is **not** included in the response.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetInsightGroupsRequest
	*/
	GetInsightGroups(ctx context.Context) ApiGetInsightGroupsRequest

	// GetInsightGroupsExecute executes the request
	//  @return InsightGroupCollection
	GetInsightGroupsExecute(r ApiGetInsightGroupsRequest) (*InsightGroupCollection, *http.Response, error)
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetInsightsScoresRequest
	*/
	GetInsightsScores(ctx context.Context) ApiGetInsightsScoresRequest

	// GetInsightsScoresExecute executes the request
	//  @return InsightScores
	GetInsightsScoresExecute(r ApiGetInsightsScoresRequest) (*InsightScores, *http.Response, error)
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param insightGroupKey The insight group key
	@return ApiPatchInsightGroupRequest
	*/
	PatchInsightGroup(ctx context.Context, insightGroupKey string) ApiPatchInsightGroupRequest

	// PatchInsightGroupExecute executes the request
	//  @return InsightGroup
	PatchInsightGroupExecute(r ApiPatchInsightGroupRequest) (*InsightGroup, *http.Response, error)
}

// InsightsScoresBetaApiService InsightsScoresBetaApi service
type InsightsScoresBetaApiService service

type ApiCreateInsightGroupRequest struct {
	ctx context.Context
	ApiService InsightsScoresBetaApi
...
func (r ApiCreateInsightGroupRequest) PostInsightGroupParams(postInsightGroupParams PostInsightGroupParams) ApiCreateInsightGroupRequest {
	r.postInsightGroupParams = &postInsightGroupParams
	return r
}

func (r ApiCreateInsightGroupRequest) Execute() (*InsightGroup, *http.Response, error) {
	return r.ApiService.CreateInsightGroupExecute(r)
}
...
func (a *InsightsScoresBetaApiService) CreateInsightGroupExecute(r ApiCreateInsightGroupRequest) (*InsightGroup, *http.Response, error) {
	var (
		...
		formFiles            []formFile
		localVarReturnValue  *InsightGroup
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InsightsScoresBetaApiService.CreateInsightGroup")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/engineering-insights/insights/group"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.postInsightGroupParams == nil {
		return localVarReturnValue, nil, reportError("postInsightGroupParams is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.postInsightGroupParams
	if r.ctx != nil {
...
type ApiDeleteInsightGroupRequest struct {
	ctx context.Context
	ApiService InsightsScoresBetaApi
	insightGroupKey string
}

func (r ApiDeleteInsightGroupRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteInsightGroupExecute(r)
}
...
func (a *InsightsScoresBetaApiService) DeleteInsightGroupExecute(r ApiDeleteInsightGroupRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InsightsScoresBetaApiService.DeleteInsightGroup")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/engineering-insights/insights/groups/{insightGroupKey}"
	localVarPath = strings.Replace(localVarPath, "{"+"insightGroupKey"+"}", url.PathEscape(parameterToString(r.insightGroupKey, "")), -1)
...
type ApiGetInsightGroupRequest struct {
	ctx context.Context
	ApiService InsightsScoresBetaApi
	insightGroupKey string
	expand *string
...
func (r ApiGetInsightGroupRequest) Execute() (*InsightGroup, *http.Response, error) {
	return r.ApiService.GetInsightGroupExecute(r)
}
...
func (a *InsightsScoresBetaApiService) GetInsightGroupExecute(r ApiGetInsightGroupRequest) (*InsightGroup, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InsightsScoresBetaApiService.GetInsightGroup")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetInsightGroupsRequest struct {
	ctx context.Context
	ApiService InsightsScoresBetaApi
	limit *int64
	offset *int64
...
func (r ApiGetInsightGroupsRequest) Execute() (*InsightGroupCollection, *http.Response, error) {
	return r.ApiService.GetInsightGroupsExecute(r)
}
...
func (a *InsightsScoresBetaApiService) GetInsightGroupsExecute(r ApiGetInsightGroupsRequest) (*InsightGroupCollection, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *InsightGroupCollection
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InsightsScoresBetaApiService.GetInsightGroups")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/engineering-insights/insights/groups"
...
type ApiGetInsightsScoresRequest struct {
	ctx context.Context
	ApiService InsightsScoresBetaApi
	projectKey *string
...
func (r ApiGetInsightsScoresRequest) Execute() (*InsightScores, *http.Response, error) {
	return r.ApiService.GetInsightsScoresExecute(r)
}
...
func (a *InsightsScoresBetaApiService) GetInsightsScoresExecute(r ApiGetInsightsScoresRequest) (*InsightScores, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *InsightScores
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InsightsScoresBetaApiService.GetInsightsScores")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/engineering-insights/insights/scores"
...
type ApiPatchInsightGroupRequest struct {
	ctx context.Context
	ApiService InsightsScoresBetaApi
	insightGroupKey string
...
func (r ApiPatchInsightGroupRequest) Execute() (*InsightGroup, *http.Response, error) {
	return r.ApiService.PatchInsightGroupExecute(r)
}
...
func (a *InsightsScoresBetaApiService) PatchInsightGroupExecute(r ApiPatchInsightGroupRequest) (*InsightGroup, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InsightsScoresBetaApiService.PatchInsightGroup")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
