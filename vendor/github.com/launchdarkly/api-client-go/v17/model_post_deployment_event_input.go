...
type PostDeploymentEventInput struct {
	// The project key
	...
	DeploymentMetadata map[string]interface{} `json:"deploymentMetadata,omitempty"`
}
...
func (o *PostDeploymentEventInput) GetApplicationKind() string {
	if o == nil || o.ApplicationKind == nil {
		var ret string
		return ret
	}
	return *o.ApplicationKind
}

// GetApplicationKindOk returns a tuple with the ApplicationKind field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PostDeploymentEventInput) GetApplicationKindOk() (*string, bool) {
	if o == nil || o.ApplicationKind == nil {
		return nil, false
	}
	return o.ApplicationKind, true
}
...
func (o *PostDeploymentEventInput) GetDeploymentMetadata() map[string]interface{} {
	if o == nil || o.DeploymentMetadata == nil {
		var ret map[string]interface{}
		return ret
	}
...
func (o PostDeploymentEventInput) MarshalJSON() ([]byte, error) {
	...
	if o.ApplicationKind != nil {
		toSerialize["applicationKind"] = o.ApplicationKind
	}
	if true {
...
type NullablePostDeploymentEventInput struct {
	value *PostDeploymentEventInput
	isSet bool
}
...
func NewNullablePostDeploymentEventInput(val *PostDeploymentEventInput) *NullablePostDeploymentEventInput {
	return &NullablePostDeploymentEventInput{value: val, isSet: true}
}
