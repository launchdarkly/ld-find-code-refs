...
// ModelConfigPost struct for ModelConfigPost
type ModelConfigPost struct {
...
// GetCostPerInputToken returns the CostPerInputToken field value if set, zero value otherwise.
func (o *ModelConfigPost) GetCostPerInputToken() float64 {
	if o == nil || o.CostPerInputToken == nil {
		var ret float64
		return ret
	}
	return *o.CostPerInputToken
}

// GetCostPerInputTokenOk returns a tuple with the CostPerInputToken field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ModelConfigPost) GetCostPerInputTokenOk() (*float64, bool) {
	if o == nil || o.CostPerInputToken == nil {
		return nil, false
	}
	return o.CostPerInputToken, true
}
...
// SetCostPerInputToken gets a reference to the given float64 and assigns it to the CostPerInputToken field.
func (o *ModelConfigPost) SetCostPerInputToken(v float64) {
	o.CostPerInputToken = &v
}

// GetCostPerOutputToken returns the CostPerOutputToken field value if set, zero value otherwise.
func (o *ModelConfigPost) GetCostPerOutputToken() float64 {
	if o == nil || o.CostPerOutputToken == nil {
		var ret float64
		return ret
	}
	return *o.CostPerOutputToken
}

// GetCostPerOutputTokenOk returns a tuple with the CostPerOutputToken field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ModelConfigPost) GetCostPerOutputTokenOk() (*float64, bool) {
	if o == nil || o.CostPerOutputToken == nil {
		return nil, false
	}
	return o.CostPerOutputToken, true
}
...
// SetCostPerOutputToken gets a reference to the given float64 and assigns it to the CostPerOutputToken field.
func (o *ModelConfigPost) SetCostPerOutputToken(v float64) {
	o.CostPerOutputToken = &v
}

func (o ModelConfigPost) MarshalJSON() ([]byte, error) {
	...
	if o.CostPerInputToken != nil {
		toSerialize["costPerInputToken"] = o.CostPerInputToken
	}
	if o.CostPerOutputToken != nil {
		toSerialize["costPerOutputToken"] = o.CostPerOutputToken
	}
	return json.Marshal(toSerialize)
}

type NullableModelConfigPost struct {
	value *ModelConfigPost
	isSet bool
}

func (v NullableModelConfigPost) Get() *ModelConfigPost {
	return v.value
}

func (v *NullableModelConfigPost) Set(val *ModelConfigPost) {
	v.value = val
	v.isSet = true
}

func (v NullableModelConfigPost) IsSet() bool {
	return v.isSet
}

func (v *NullableModelConfigPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelConfigPost(val *ModelConfigPost) *NullableModelConfigPost {
	return &NullableModelConfigPost{value: val, isSet: true}
}

func (v NullableModelConfigPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelConfigPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
