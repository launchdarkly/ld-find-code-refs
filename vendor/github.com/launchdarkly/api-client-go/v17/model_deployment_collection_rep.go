...
type DeploymentCollectionRep struct {
	// The total number of deployments
	TotalCount int32 `json:"totalCount"`
	// A list of deployments
	Items []DeploymentRep `json:"items"`
...
func NewNullableDeploymentCollectionRep(val *DeploymentCollectionRep) *NullableDeploymentCollectionRep {
	return &NullableDeploymentCollectionRep{value: val, isSet: true}
}
