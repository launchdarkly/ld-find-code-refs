...
// IntegrationConfigurationsRep struct for IntegrationConfigurationsRep
type IntegrationConfigurationsRep struct {
	...
	CapabilityConfig *CapabilityConfigRep `json:"capabilityConfig,omitempty"`
}
...
func NewIntegrationConfigurationsRep(links map[string]Link, id string, name string) *IntegrationConfigurationsRep {
	this := IntegrationConfigurationsRep{}
	this.Links = links
	this.Id = id
	this.Name = name
	return &this
...
// GetConfigValues returns the ConfigValues field value if set, zero value otherwise.
func (o *IntegrationConfigurationsRep) GetConfigValues() map[string]interface{} {
	if o == nil || o.ConfigValues == nil {
		var ret map[string]interface{}
		return ret
	}
	return o.ConfigValues
}

// GetConfigValuesOk returns a tuple with the ConfigValues field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IntegrationConfigurationsRep) GetConfigValuesOk() (map[string]interface{}, bool) {
	if o == nil || o.ConfigValues == nil {
		return nil, false
	}
	return o.ConfigValues, true
}
...
// SetConfigValues gets a reference to the given map[string]interface{} and assigns it to the ConfigValues field.
func (o *IntegrationConfigurationsRep) SetConfigValues(v map[string]interface{}) {
	o.ConfigValues = v
}

// GetCapabilityConfig returns the CapabilityConfig field value if set, zero value otherwise.
func (o *IntegrationConfigurationsRep) GetCapabilityConfig() CapabilityConfigRep {
	if o == nil || o.CapabilityConfig == nil {
		var ret CapabilityConfigRep
		return ret
	}
	return *o.CapabilityConfig
}

// GetCapabilityConfigOk returns a tuple with the CapabilityConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IntegrationConfigurationsRep) GetCapabilityConfigOk() (*CapabilityConfigRep, bool) {
	if o == nil || o.CapabilityConfig == nil {
		return nil, false
	}
	return o.CapabilityConfig, true
}
...
// SetCapabilityConfig gets a reference to the given CapabilityConfigRep and assigns it to the CapabilityConfig field.
func (o *IntegrationConfigurationsRep) SetCapabilityConfig(v CapabilityConfigRep) {
	o.CapabilityConfig = &v
}

func (o IntegrationConfigurationsRep) MarshalJSON() ([]byte, error) {
	...
	if o.CreatedAt != nil {
		toSerialize["_createdAt"] = o.CreatedAt
	}
	if o.IntegrationKey != nil {
		toSerialize["_integrationKey"] = o.IntegrationKey
	}
	if o.Tags != nil {
	...
	if o.ConfigValues != nil {
		toSerialize["configValues"] = o.ConfigValues
	}
	if o.CapabilityConfig != nil {
		toSerialize["capabilityConfig"] = o.CapabilityConfig
	}
	return json.Marshal(toSerialize)
}

type NullableIntegrationConfigurationsRep struct {
	value *IntegrationConfigurationsRep
	isSet bool
}

func (v NullableIntegrationConfigurationsRep) Get() *IntegrationConfigurationsRep {
	return v.value
}

func (v *NullableIntegrationConfigurationsRep) Set(val *IntegrationConfigurationsRep) {
	v.value = val
	v.isSet = true
}

func (v NullableIntegrationConfigurationsRep) IsSet() bool {
	return v.isSet
}

func (v *NullableIntegrationConfigurationsRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIntegrationConfigurationsRep(val *IntegrationConfigurationsRep) *NullableIntegrationConfigurationsRep {
	return &NullableIntegrationConfigurationsRep{value: val, isSet: true}
}

func (v NullableIntegrationConfigurationsRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIntegrationConfigurationsRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
