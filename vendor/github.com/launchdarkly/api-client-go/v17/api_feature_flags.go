...
If you provide the optional `currentVersion` of a flag, this operation tests to ensure that the current flag version in the environment matches the version you've specified. The operation rejects attempts to copy flag settings if the environment's current version  of the flag does not match the version you've specified. You can use this to enforce optimistic locking on copy attempts.
	...
	*/
	CopyFeatureFlag(ctx context.Context, projectKey string, featureFlagKey string) ApiCopyFeatureFlagRequest

	// CopyFeatureFlagExecute executes the request
	//  @return FeatureFlag
	CopyFeatureFlagExecute(r ApiCopyFeatureFlagRequest) (*FeatureFlag, *http.Response, error)
	...
	*/
	DeleteFeatureFlag(ctx context.Context, projectKey string, featureFlagKey string) ApiDeleteFeatureFlagRequest

	// DeleteFeatureFlagExecute executes the request
	DeleteFeatureFlagExecute(r ApiDeleteFeatureFlagRequest) (*http.Response, error)
	...
	*/
	GetExpiringContextTargets(ctx context.Context, projectKey string, environmentKey string, featureFlagKey string) ApiGetExpiringContextTargetsRequest

	// GetExpiringContextTargetsExecute executes the request
	//  @return ExpiringTargetGetResponse
	GetExpiringContextTargetsExecute(r ApiGetExpiringContextTargetsRequest) (*ExpiringTargetGetResponse, *http.Response, error)
...
Get a list of user targets on a feature flag that are scheduled for removal.
	...
	*/
	GetExpiringUserTargets(ctx context.Context, projectKey string, environmentKey string, featureFlagKey string) ApiGetExpiringUserTargetsRequest

	// GetExpiringUserTargetsExecute executes the request
	//  @return ExpiringUserTargetGetResponse
	GetExpiringUserTargetsExecute(r ApiGetExpiringUserTargetsRequest) (*ExpiringUserTargetGetResponse, *http.Response, error)
...
For example, `expand=evaluation` includes the `evaluation` field in the response.
	...
	*/
	GetFeatureFlag(ctx context.Context, projectKey string, featureFlagKey string) ApiGetFeatureFlagRequest

	// GetFeatureFlagExecute executes the request
	//  @return FeatureFlag
	GetFeatureFlagExecute(r ApiGetFeatureFlagRequest) (*FeatureFlag, *http.Response, error)
	...
	*/
	...
	GetFeatureFlagStatusExecute(r ApiGetFeatureFlagStatusRequest) (*FlagStatusRep, *http.Response, error)
	...
	*/
	GetFeatureFlagStatusAcrossEnvironments(ctx context.Context, projectKey string, featureFlagKey string) ApiGetFeatureFlagStatusAcrossEnvironmentsRequest

	// GetFeatureFlagStatusAcrossEnvironmentsExecute executes the request
	//  @return FeatureFlagStatusAcrossEnvironments
	GetFeatureFlagStatusAcrossEnvironmentsExecute(r ApiGetFeatureFlagStatusAcrossEnvironmentsRequest) (*FeatureFlagStatusAcrossEnvironments, *http.Response, error)
...
To learn more, read [Flag statuses](https://launchdarkly.com/docs/home/observability/flag-status).
	...
	*/
	GetFeatureFlagStatuses(ctx context.Context, projectKey string, environmentKey string) ApiGetFeatureFlagStatusesRequest

	// GetFeatureFlagStatusesExecute executes the request
	//  @return FeatureFlagStatuses
	GetFeatureFlagStatusesExecute(r ApiGetFeatureFlagStatusesRequest) (*FeatureFlagStatuses, *http.Response, error)
...
To learn more, read [Migration Flags](https://launchdarkly.com/docs/home/flags/migration).
	...
	*/
	GetFeatureFlags(ctx context.Context, projectKey string) ApiGetFeatureFlagsRequest

	// GetFeatureFlagsExecute executes the request
	//  @return FeatureFlags
	GetFeatureFlagsExecute(r ApiGetFeatureFlagsRequest) (*FeatureFlags, *http.Response, error)
...
```
	...
	*/
	PatchExpiringTargets(ctx context.Context, projectKey string, environmentKey string, featureFlagKey string) ApiPatchExpiringTargetsRequest

	// PatchExpiringTargetsExecute executes the request
	//  @return ExpiringTargetPatchResponse
	PatchExpiringTargetsExecute(r ApiPatchExpiringTargetsRequest) (*ExpiringTargetPatchResponse, *http.Response, error)
...
* `userKey`: The user key for the user to remove from individual targeting
	...
	*/
	PatchExpiringUserTargets(ctx context.Context, projectKey string, environmentKey string, featureFlagKey string) ApiPatchExpiringUserTargetsRequest

	// PatchExpiringUserTargetsExecute executes the request
	//  @return ExpiringUserTargetPatchResponse
	PatchExpiringUserTargetsExecute(r ApiPatchExpiringUserTargetsRequest) (*ExpiringUserTargetPatchResponse, *http.Response, error)
...
To learn more, read [Migration flags](https://launchdarkly.com/docs/home/flags/migration).
	...
	*/
	PatchFeatureFlag(ctx context.Context, projectKey string, featureFlagKey string) ApiPatchFeatureFlagRequest

	// PatchFeatureFlagExecute executes the request
	//  @return FeatureFlag
	PatchFeatureFlagExecute(r ApiPatchFeatureFlagRequest) (*FeatureFlag, *http.Response, error)
...
To learn more, read [Migration Flags](https://launchdarkly.com/docs/home/flags/migration).
	...
	*/
	PostFeatureFlag(ctx context.Context, projectKey string) ApiPostFeatureFlagRequest

	// PostFeatureFlagExecute executes the request
	//  @return FeatureFlag
	PostFeatureFlagExecute(r ApiPostFeatureFlagRequest) (*FeatureFlag, *http.Response, error)
	...
	@param environmentKey The environment key
	@return ApiPostMigrationSafetyIssuesRequest
	*/
	PostMigrationSafetyIssues(ctx context.Context, projectKey string, flagKey string, environmentKey string) ApiPostMigrationSafetyIssuesRequest

	// PostMigrationSafetyIssuesExecute executes the request
	//  @return []MigrationSafetyIssueRep
	PostMigrationSafetyIssuesExecute(r ApiPostMigrationSafetyIssuesRequest) ([]MigrationSafetyIssueRep, *http.Response, error)
}
...
type ApiPostMigrationSafetyIssuesRequest struct {
	ctx context.Context
	ApiService FeatureFlagsApi
	projectKey string
	flagKey string
...
Returns the migration safety issues that are associated with the POSTed flag patch. The patch must use the semantic patch format for updating feature flags.
 ...
 @return ApiPostMigrationSafetyIssuesRequest
*/
func (a *FeatureFlagsApiService) PostMigrationSafetyIssues(ctx context.Context, projectKey string, flagKey string, environmentKey string) ApiPostMigrationSafetyIssuesRequest {
	return ApiPostMigrationSafetyIssuesRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return []MigrationSafetyIssueRep
func (a *FeatureFlagsApiService) PostMigrationSafetyIssuesExecute(r ApiPostMigrationSafetyIssuesRequest) ([]MigrationSafetyIssueRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []MigrationSafetyIssueRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FeatureFlagsApiService.PostMigrationSafetyIssues")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/projects/{projectKey}/flags/{flagKey}/environments/{environmentKey}/migration-safety-issues"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterToString(r.projectKey, "")), -1)
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.flagSempatch == nil {
		return localVarReturnValue, nil, reportError("flagSempatch is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.flagSempatch
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
