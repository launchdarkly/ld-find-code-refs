...
type WebhooksApi interface {
	...
	*/
	GetAllWebhooks(ctx context.Context) ApiGetAllWebhooksRequest

	// GetAllWebhooksExecute executes the request
	//  @return Webhooks
	GetAllWebhooksExecute(r ApiGetAllWebhooksRequest) (*Webhooks, *http.Response, error)
	...
	*/
	...
	//  @return Webhook
	GetWebhookExecute(r ApiGetWebhookRequest) (*Webhook, *http.Response, error)
	...
	*/
	PatchWebhook(ctx context.Context, id string) ApiPatchWebhookRequest

	// PatchWebhookExecute executes the request
	//  @return Webhook
	PatchWebhookExecute(r ApiPatchWebhookRequest) (*Webhook, *http.Response, error)
	...
	*/
	PostWebhook(ctx context.Context) ApiPostWebhookRequest

	// PostWebhookExecute executes the request
	//  @return Webhook
	PostWebhookExecute(r ApiPostWebhookRequest) (*Webhook, *http.Response, error)
}
...
func (r ApiGetAllWebhooksRequest) Execute() (*Webhooks, *http.Response, error) {
...
func (a *WebhooksApiService) GetAllWebhooksExecute(r ApiGetAllWebhooksRequest) (*Webhooks, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WebhooksApiService.GetAllWebhooks")
	if err != nil {
...
func (a *WebhooksApiService) PostWebhookExecute(r ApiPostWebhookRequest) (*Webhook, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.webhookPost == nil {
		return localVarReturnValue, nil, reportError("webhookPost is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.webhookPost
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
