...
type PullRequestLeadTimeRep struct {
	// The coding duration in milliseconds
	CodingDurationMs int64 `json:"codingDurationMs"`
	// The review duration in milliseconds
	ReviewDurationMs *int64 `json:"reviewDurationMs,omitempty"`
	// The max wait duration between merge time and deploy start time in milliseconds
	MaxWaitDurationMs *int64 `json:"maxWaitDurationMs,omitempty"`
	// The average wait duration between merge time and deploy start time in milliseconds
	AvgWaitDurationMs *int64 `json:"avgWaitDurationMs,omitempty"`
	// The max deploy duration in milliseconds
	MaxDeployDurationMs *int64 `json:"maxDeployDurationMs,omitempty"`
	// The average deploy duration in milliseconds
	AvgDeployDurationMs *int64 `json:"avgDeployDurationMs,omitempty"`
	// The max total lead time in milliseconds
	MaxTotalLeadTimeMs *int64 `json:"maxTotalLeadTimeMs,omitempty"`
	// The average total lead time in milliseconds
	AvgTotalLeadTimeMs *int64 `json:"avgTotalLeadTimeMs,omitempty"`
}
...
func (o *PullRequestLeadTimeRep) GetReviewDurationMs() int64 {
	if o == nil || o.ReviewDurationMs == nil {
		var ret int64
		return ret
	}
	return *o.ReviewDurationMs
}

// GetReviewDurationMsOk returns a tuple with the ReviewDurationMs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PullRequestLeadTimeRep) GetReviewDurationMsOk() (*int64, bool) {
	if o == nil || o.ReviewDurationMs == nil {
		return nil, false
	}
	return o.ReviewDurationMs, true
}
...
func (o *PullRequestLeadTimeRep) GetMaxWaitDurationMs() int64 {
	if o == nil || o.MaxWaitDurationMs == nil {
		var ret int64
		return ret
	}
	return *o.MaxWaitDurationMs
}

// GetMaxWaitDurationMsOk returns a tuple with the MaxWaitDurationMs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PullRequestLeadTimeRep) GetMaxWaitDurationMsOk() (*int64, bool) {
	if o == nil || o.MaxWaitDurationMs == nil {
		return nil, false
	}
	return o.MaxWaitDurationMs, true
}
...
func (o *PullRequestLeadTimeRep) GetAvgWaitDurationMs() int64 {
	if o == nil || o.AvgWaitDurationMs == nil {
		var ret int64
		return ret
	}
	return *o.AvgWaitDurationMs
}

// GetAvgWaitDurationMsOk returns a tuple with the AvgWaitDurationMs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PullRequestLeadTimeRep) GetAvgWaitDurationMsOk() (*int64, bool) {
	if o == nil || o.AvgWaitDurationMs == nil {
		return nil, false
	}
	return o.AvgWaitDurationMs, true
}
...
func (o *PullRequestLeadTimeRep) GetMaxDeployDurationMs() int64 {
	if o == nil || o.MaxDeployDurationMs == nil {
		var ret int64
		return ret
	}
	return *o.MaxDeployDurationMs
}

// GetMaxDeployDurationMsOk returns a tuple with the MaxDeployDurationMs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PullRequestLeadTimeRep) GetMaxDeployDurationMsOk() (*int64, bool) {
	if o == nil || o.MaxDeployDurationMs == nil {
		return nil, false
	}
	return o.MaxDeployDurationMs, true
}
...
func (o *PullRequestLeadTimeRep) GetAvgDeployDurationMs() int64 {
	if o == nil || o.AvgDeployDurationMs == nil {
		var ret int64
		return ret
	}
	return *o.AvgDeployDurationMs
}

// GetAvgDeployDurationMsOk returns a tuple with the AvgDeployDurationMs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PullRequestLeadTimeRep) GetAvgDeployDurationMsOk() (*int64, bool) {
	if o == nil || o.AvgDeployDurationMs == nil {
		return nil, false
	}
	return o.AvgDeployDurationMs, true
}
...
func (o *PullRequestLeadTimeRep) GetMaxTotalLeadTimeMs() int64 {
	if o == nil || o.MaxTotalLeadTimeMs == nil {
		var ret int64
		return ret
	}
	return *o.MaxTotalLeadTimeMs
}

// GetMaxTotalLeadTimeMsOk returns a tuple with the MaxTotalLeadTimeMs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PullRequestLeadTimeRep) GetMaxTotalLeadTimeMsOk() (*int64, bool) {
	if o == nil || o.MaxTotalLeadTimeMs == nil {
		return nil, false
	}
	return o.MaxTotalLeadTimeMs, true
}
...
func (o *PullRequestLeadTimeRep) GetAvgTotalLeadTimeMs() int64 {
	if o == nil || o.AvgTotalLeadTimeMs == nil {
		var ret int64
		return ret
	}
	return *o.AvgTotalLeadTimeMs
}

// GetAvgTotalLeadTimeMsOk returns a tuple with the AvgTotalLeadTimeMs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PullRequestLeadTimeRep) GetAvgTotalLeadTimeMsOk() (*int64, bool) {
	if o == nil || o.AvgTotalLeadTimeMs == nil {
		return nil, false
	}
	return o.AvgTotalLeadTimeMs, true
}
...
func (o *PullRequestLeadTimeRep) SetAvgTotalLeadTimeMs(v int64) {
	o.AvgTotalLeadTimeMs = &v
}

func (o PullRequestLeadTimeRep) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["codingDurationMs"] = o.CodingDurationMs
	}
	if o.ReviewDurationMs != nil {
		toSerialize["reviewDurationMs"] = o.ReviewDurationMs
	}
	if o.MaxWaitDurationMs != nil {
		toSerialize["maxWaitDurationMs"] = o.MaxWaitDurationMs
	}
	if o.AvgWaitDurationMs != nil {
		toSerialize["avgWaitDurationMs"] = o.AvgWaitDurationMs
	}
	if o.MaxDeployDurationMs != nil {
		toSerialize["maxDeployDurationMs"] = o.MaxDeployDurationMs
	}
	if o.AvgDeployDurationMs != nil {
		toSerialize["avgDeployDurationMs"] = o.AvgDeployDurationMs
	}
	if o.MaxTotalLeadTimeMs != nil {
		toSerialize["maxTotalLeadTimeMs"] = o.MaxTotalLeadTimeMs
	}
	if o.AvgTotalLeadTimeMs != nil {
		toSerialize["avgTotalLeadTimeMs"] = o.AvgTotalLeadTimeMs
	}
	return json.Marshal(toSerialize)
}

type NullablePullRequestLeadTimeRep struct {
	value *PullRequestLeadTimeRep
	isSet bool
}
...
func NewNullablePullRequestLeadTimeRep(val *PullRequestLeadTimeRep) *NullablePullRequestLeadTimeRep {
	return &NullablePullRequestLeadTimeRep{value: val, isSet: true}
}
