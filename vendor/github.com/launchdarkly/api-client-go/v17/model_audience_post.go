...
type AudiencePost struct {
	...
	Configuration *AudienceConfiguration `json:"configuration,omitempty"`
}
...
// SetConfiguration gets a reference to the given AudienceConfiguration and assigns it to the Configuration field.
...
func NewNullableAudiencePost(val *AudiencePost) *NullableAudiencePost {
	return &NullableAudiencePost{value: val, isSet: true}
}
