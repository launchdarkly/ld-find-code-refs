...
type LayerRep struct {
	...
	Environments *map[string]LayerConfigurationRep `json:"environments,omitempty"`
}
...
func (o *LayerRep) GetEnvironments() map[string]LayerConfigurationRep {
	if o == nil || o.Environments == nil {
		var ret map[string]LayerConfigurationRep
		return ret
	}
...
// SetEnvironments gets a reference to the given map[string]LayerConfigurationRep and assigns it to the Environments field.
func (o *LayerRep) SetEnvironments(v map[string]LayerConfigurationRep) {
	o.Environments = &v
}

func (o LayerRep) MarshalJSON() ([]byte, error) {
...
type NullableLayerRep struct {
	value *LayerRep
	isSet bool
}

func (v NullableLayerRep) Get() *LayerRep {
	return v.value
}

func (v *NullableLayerRep) Set(val *LayerRep) {
	v.value = val
	v.isSet = true
}

func (v NullableLayerRep) IsSet() bool {
	return v.isSet
}

func (v *NullableLayerRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLayerRep(val *LayerRep) *NullableLayerRep {
	return &NullableLayerRep{value: val, isSet: true}
}

func (v NullableLayerRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLayerRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
