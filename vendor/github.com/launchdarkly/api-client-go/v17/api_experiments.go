...
To learn more, read [Creating experiments](https://launchdarkly.com/docs/home/experimentation/create).
	...
	*/
	CreateExperiment(ctx context.Context, projectKey string, environmentKey string) ApiCreateExperimentRequest

	// CreateExperimentExecute executes the request
	//  @return Experiment
	CreateExperimentExecute(r ApiCreateExperimentRequest) (*Experiment, *http.Response, error)
...
To learn more, read [Start experiment iterations](https://launchdarkly.com/docs/home/experimentation/feature#start-experiment-iterations).
	...
	*/
	CreateIteration(ctx context.Context, projectKey string, environmentKey string, experimentKey string) ApiCreateIterationRequest

	// CreateIterationExecute executes the request
	//  @return IterationRep
	CreateIterationExecute(r ApiCreateIterationRequest) (*IterationRep, *http.Response, error)
...
For example, `expand=draftIteration,treatments` includes the `draftIteration` and `treatments` fields in the response. If fields that you request with the `expand` query parameter are empty, they are not included in the response.
	...
	*/
	GetExperiment(ctx context.Context, projectKey string, environmentKey string, experimentKey string) ApiGetExperimentRequest

	// GetExperimentExecute executes the request
	//  @return Experiment
	GetExperimentExecute(r ApiGetExperimentRequest) (*Experiment, *http.Response, error)

	/*
	GetExperimentResults Get experiment results (Deprecated)
...
For example, `expand=traffic` includes the `traffic` field for the project in the response.
	...
	Deprecated
	*/
	GetExperimentResults(ctx context.Context, projectKey string, environmentKey string, experimentKey string, metricKey string) ApiGetExperimentResultsRequest

	// GetExperimentResultsExecute executes the request
	//  @return ExperimentBayesianResultsRep
	// Deprecated
	GetExperimentResultsExecute(r ApiGetExperimentResultsRequest) (*ExperimentBayesianResultsRep, *http.Response, error)

	/*
	GetExperimentResultsForMetricGroup Get experiment results for metric group (Deprecated)
	...
	Deprecated
	*/
	GetExperimentResultsForMetricGroup(ctx context.Context, projectKey string, environmentKey string, experimentKey string, metricGroupKey string) ApiGetExperimentResultsForMetricGroupRequest

	// GetExperimentResultsForMetricGroupExecute executes the request
	//  @return MetricGroupResultsRep
	// Deprecated
	GetExperimentResultsForMetricGroupExecute(r ApiGetExperimentResultsForMetricGroupRequest) (*MetricGroupResultsRep, *http.Response, error)
	...
	*/
	GetExperimentationSettings(ctx context.Context, projectKey string) ApiGetExperimentationSettingsRequest

	// GetExperimentationSettingsExecute executes the request
	//  @return RandomizationSettingsRep
	GetExperimentationSettingsExecute(r ApiGetExperimentationSettingsRequest) (*RandomizationSettingsRep, *http.Response, error)
...
For example, `expand=draftIteration,treatments` includes the `draftIteration` and `treatments` fields in the response. If fields that you request with the `expand` query parameter are empty, they are not included in the response.
	...
	*/
	GetExperiments(ctx context.Context, projectKey string, environmentKey string) ApiGetExperimentsRequest

	// GetExperimentsExecute executes the request
	//  @return ExperimentCollectionRep
	GetExperimentsExecute(r ApiGetExperimentsRequest) (*ExperimentCollectionRep, *http.Response, error)
...
```
	...
	*/
	PatchExperiment(ctx context.Context, projectKey string, environmentKey string, experimentKey string) ApiPatchExperimentRequest

	// PatchExperimentExecute executes the request
	//  @return Experiment
	PatchExperimentExecute(r ApiPatchExperimentRequest) (*Experiment, *http.Response, error)
	...
	*/
	PutExperimentationSettings(ctx context.Context, projectKey string) ApiPutExperimentationSettingsRequest

	// PutExperimentationSettingsExecute executes the request
	//  @return RandomizationSettingsRep
	PutExperimentationSettingsExecute(r ApiPutExperimentationSettingsRequest) (*RandomizationSettingsRep, *http.Response, error)
}
...
To learn more, read [Creating experiments](https://launchdarkly.com/docs/home/experimentation/create).
 ...
 @return ApiCreateExperimentRequest
*/
func (a *ExperimentsApiService) CreateExperiment(ctx context.Context, projectKey string, environmentKey string) ApiCreateExperimentRequest {
	return ApiCreateExperimentRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return Experiment
func (a *ExperimentsApiService) CreateExperimentExecute(r ApiCreateExperimentRequest) (*Experiment, *http.Response, error) {
	var (
...
To learn more, read [Start experiment iterations](https://launchdarkly.com/docs/home/experimentation/feature#start-experiment-iterations).
 ...
 @return ApiCreateIterationRequest
*/
func (a *ExperimentsApiService) CreateIteration(ctx context.Context, projectKey string, environmentKey string, experimentKey string) ApiCreateIterationRequest {
	return ApiCreateIterationRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return IterationRep
func (a *ExperimentsApiService) CreateIterationExecute(r ApiCreateIterationRequest) (*IterationRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExperimentsApiService.CreateIteration")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
For example, `expand=draftIteration,treatments` includes the `draftIteration` and `treatments` fields in the response. If fields that you request with the `expand` query parameter are empty, they are not included in the response.
 ...
 @return ApiGetExperimentRequest
*/
func (a *ExperimentsApiService) GetExperiment(ctx context.Context, projectKey string, environmentKey string, experimentKey string) ApiGetExperimentRequest {
	return ApiGetExperimentRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return Experiment
func (a *ExperimentsApiService) GetExperimentExecute(r ApiGetExperimentRequest) (*Experiment, *http.Response, error) {
	var (
...
Deprecated
*/
func (a *ExperimentsApiService) GetExperimentResults(ctx context.Context, projectKey string, environmentKey string, experimentKey string, metricKey string) ApiGetExperimentResultsRequest {
	return ApiGetExperimentResultsRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
//  @return ExperimentBayesianResultsRep
// Deprecated
func (a *ExperimentsApiService) GetExperimentResultsExecute(r ApiGetExperimentResultsRequest) (*ExperimentBayesianResultsRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
Deprecated
*/
func (a *ExperimentsApiService) GetExperimentResultsForMetricGroup(ctx context.Context, projectKey string, environmentKey string, experimentKey string, metricGroupKey string) ApiGetExperimentResultsForMetricGroupRequest {
	return ApiGetExperimentResultsForMetricGroupRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
//  @return MetricGroupResultsRep
// Deprecated
func (a *ExperimentsApiService) GetExperimentResultsForMetricGroupExecute(r ApiGetExperimentResultsForMetricGroupRequest) (*MetricGroupResultsRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExperimentsApiService.GetExperimentResultsForMetricGroup")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
Get current experimentation settings for the given project
 ...
 @return ApiGetExperimentationSettingsRequest
*/
func (a *ExperimentsApiService) GetExperimentationSettings(ctx context.Context, projectKey string) ApiGetExperimentationSettingsRequest {
	return ApiGetExperimentationSettingsRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return RandomizationSettingsRep
func (a *ExperimentsApiService) GetExperimentationSettingsExecute(r ApiGetExperimentationSettingsRequest) (*RandomizationSettingsRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExperimentsApiService.GetExperimentationSettings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
For example, `expand=draftIteration,treatments` includes the `draftIteration` and `treatments` fields in the response. If fields that you request with the `expand` query parameter are empty, they are not included in the response.
 ...
 @return ApiGetExperimentsRequest
*/
func (a *ExperimentsApiService) GetExperiments(ctx context.Context, projectKey string, environmentKey string) ApiGetExperimentsRequest {
	return ApiGetExperimentsRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return ExperimentCollectionRep
func (a *ExperimentsApiService) GetExperimentsExecute(r ApiGetExperimentsRequest) (*ExperimentCollectionRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
```
 ...
 @return ApiPatchExperimentRequest
*/
func (a *ExperimentsApiService) PatchExperiment(ctx context.Context, projectKey string, environmentKey string, experimentKey string) ApiPatchExperimentRequest {
	return ApiPatchExperimentRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return Experiment
func (a *ExperimentsApiService) PatchExperimentExecute(r ApiPatchExperimentRequest) (*Experiment, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExperimentsApiService.PatchExperiment")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
Update experimentation settings for the given project
 ...
 @return ApiPutExperimentationSettingsRequest
*/
func (a *ExperimentsApiService) PutExperimentationSettings(ctx context.Context, projectKey string) ApiPutExperimentationSettingsRequest {
	return ApiPutExperimentationSettingsRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return RandomizationSettingsRep
func (a *ExperimentsApiService) PutExperimentationSettingsExecute(r ApiPutExperimentationSettingsRequest) (*RandomizationSettingsRep, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExperimentsApiService.PutExperimentationSettings")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
