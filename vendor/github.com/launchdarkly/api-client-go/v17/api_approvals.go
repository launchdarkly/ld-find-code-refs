...
type ApprovalsApi interface {
	...
	*/
	DeleteApprovalRequest(ctx context.Context, id string) ApiDeleteApprovalRequestRequest

	// DeleteApprovalRequestExecute executes the request
	DeleteApprovalRequestExecute(r ApiDeleteApprovalRequestRequest) (*http.Response, error)
	...
	@return ApiDeleteApprovalRequestForFlagRequest
	*/
	DeleteApprovalRequestForFlag(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, id string) ApiDeleteApprovalRequestForFlagRequest

	// DeleteApprovalRequestForFlagExecute executes the request
	DeleteApprovalRequestForFlagExecute(r ApiDeleteApprovalRequestForFlagRequest) (*http.Response, error)
	...
	*/
	GetApprovalForFlag(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, id string) ApiGetApprovalForFlagRequest

	// GetApprovalForFlagExecute executes the request
	//  @return FlagConfigApprovalRequestResponse
	GetApprovalForFlagExecute(r ApiGetApprovalForFlagRequest) (*FlagConfigApprovalRequestResponse, *http.Response, error)
...
For example, `expand=project,flag` includes the `project` and `flag` fields in the response.
	...
	*/
	GetApprovalRequest(ctx context.Context, id string) ApiGetApprovalRequestRequest

	// GetApprovalRequestExecute executes the request
	//  @return ExpandableApprovalRequestResponse
	GetApprovalRequestExecute(r ApiGetApprovalRequestRequest) (*ExpandableApprovalRequestResponse, *http.Response, error)
...
For example, `expand=project,flag` includes the `project` and `flag` fields in the response.
	...
	*/
	GetApprovalRequests(ctx context.Context) ApiGetApprovalRequestsRequest

	// GetApprovalRequestsExecute executes the request
	//  @return ExpandableApprovalRequestsResponse
	GetApprovalRequestsExecute(r ApiGetApprovalRequestsRequest) (*ExpandableApprovalRequestsResponse, *http.Response, error)
	...
	*/
	GetApprovalsForFlag(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string) ApiGetApprovalsForFlagRequest

	// GetApprovalsForFlagExecute executes the request
	//  @return FlagConfigApprovalRequestsResponse
	GetApprovalsForFlagExecute(r ApiGetApprovalsForFlagRequest) (*FlagConfigApprovalRequestsResponse, *http.Response, error)
...
If you are creating an approval request for a segment, you can use the following read [Patch segment](https://launchdarkly.com/docs/api/segments/patch-segment) for details on the available `instructions`.
	...
	*/
	PostApprovalRequest(ctx context.Context) ApiPostApprovalRequestRequest

	// PostApprovalRequestExecute executes the request
	//  @return ApprovalRequestResponse
	PostApprovalRequestExecute(r ApiPostApprovalRequestRequest) (*ApprovalRequestResponse, *http.Response, error)
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id The approval request ID
	@return ApiPostApprovalRequestApplyRequest
	*/
	PostApprovalRequestApply(ctx context.Context, id string) ApiPostApprovalRequestApplyRequest

	// PostApprovalRequestApplyExecute executes the request
	//  @return ApprovalRequestResponse
	PostApprovalRequestApplyExecute(r ApiPostApprovalRequestApplyRequest) (*ApprovalRequestResponse, *http.Response, error)
	...
	*/
	...
	// PostApprovalRequestApplyForFlagExecute executes the request
	//  @return FlagConfigApprovalRequestResponse
	PostApprovalRequestApplyForFlagExecute(r ApiPostApprovalRequestApplyForFlagRequest) (*FlagConfigApprovalRequestResponse, *http.Response, error)
	...
	@param featureFlagKey The feature flag key
	@param environmentKey The environment key
	@return ApiPostApprovalRequestForFlagRequest
	*/
	PostApprovalRequestForFlag(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string) ApiPostApprovalRequestForFlagRequest

	// PostApprovalRequestForFlagExecute executes the request
	//  @return FlagConfigApprovalRequestResponse
	PostApprovalRequestForFlagExecute(r ApiPostApprovalRequestForFlagRequest) (*FlagConfigApprovalRequestResponse, *http.Response, error)
	...
	*/
	PostApprovalRequestReview(ctx context.Context, id string) ApiPostApprovalRequestReviewRequest

	// PostApprovalRequestReviewExecute executes the request
	//  @return ApprovalRequestResponse
	PostApprovalRequestReviewExecute(r ApiPostApprovalRequestReviewRequest) (*ApprovalRequestResponse, *http.Response, error)
	...
	@param environmentKey The environment key
	@param id The feature flag approval request ID
	@return ApiPostApprovalRequestReviewForFlagRequest
	*/
	PostApprovalRequestReviewForFlag(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, id string) ApiPostApprovalRequestReviewForFlagRequest

	// PostApprovalRequestReviewForFlagExecute executes the request
	//  @return FlagConfigApprovalRequestResponse
	PostApprovalRequestReviewForFlagExecute(r ApiPostApprovalRequestReviewForFlagRequest) (*FlagConfigApprovalRequestResponse, *http.Response, error)
	...
	*/
	PostFlagCopyConfigApprovalRequest(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string) ApiPostFlagCopyConfigApprovalRequestRequest

	// PostFlagCopyConfigApprovalRequestExecute executes the request
	//  @return FlagConfigApprovalRequestResponse
	PostFlagCopyConfigApprovalRequestExecute(r ApiPostFlagCopyConfigApprovalRequestRequest) (*FlagConfigApprovalRequestResponse, *http.Response, error)
}
...
func (r ApiDeleteApprovalRequestRequest) Execute() (*http.Response, error) {
...
func (a *ApprovalsApiService) DeleteApprovalRequestExecute(r ApiDeleteApprovalRequestRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/approval-requests/{id}"
...
type ApiDeleteApprovalRequestForFlagRequest struct {
	ctx context.Context
	ApiService ApprovalsApi
	projectKey string
...
func (r ApiDeleteApprovalRequestForFlagRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteApprovalRequestForFlagExecute(r)
}
...
func (a *ApprovalsApiService) DeleteApprovalRequestForFlagExecute(r ApiDeleteApprovalRequestForFlagRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApprovalsApiService.DeleteApprovalRequestForFlag")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetApprovalForFlagRequest) Execute() (*FlagConfigApprovalRequestResponse, *http.Response, error) {
	return r.ApiService.GetApprovalForFlagExecute(r)
}
...
func (a *ApprovalsApiService) GetApprovalForFlagExecute(r ApiGetApprovalForFlagRequest) (*FlagConfigApprovalRequestResponse, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *FlagConfigApprovalRequestResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApprovalsApiService.GetApprovalForFlag")
	if err != nil {
...
func (a *ApprovalsApiService) GetApprovalRequestExecute(r ApiGetApprovalRequestRequest) (*ExpandableApprovalRequestResponse, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ExpandableApprovalRequestResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApprovalsApiService.GetApprovalRequest")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (a *ApprovalsApiService) GetApprovalRequestsExecute(r ApiGetApprovalRequestsRequest) (*ExpandableApprovalRequestsResponse, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ExpandableApprovalRequestsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApprovalsApiService.GetApprovalRequests")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/approval-requests"
...
func (r ApiGetApprovalsForFlagRequest) Execute() (*FlagConfigApprovalRequestsResponse, *http.Response, error) {
	return r.ApiService.GetApprovalsForFlagExecute(r)
}
...
func (a *ApprovalsApiService) GetApprovalsForFlagExecute(r ApiGetApprovalsForFlagRequest) (*FlagConfigApprovalRequestsResponse, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *FlagConfigApprovalRequestsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApprovalsApiService.GetApprovalsForFlag")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiPostApprovalRequestApplyRequest struct {
	ctx context.Context
	ApiService ApprovalsApi
	id string
...
func (r ApiPostApprovalRequestApplyRequest) PostApprovalRequestApplyRequest(postApprovalRequestApplyRequest PostApprovalRequestApplyRequest) ApiPostApprovalRequestApplyRequest {
	r.postApprovalRequestApplyRequest = &postApprovalRequestApplyRequest
	return r
}

func (r ApiPostApprovalRequestApplyRequest) Execute() (*ApprovalRequestResponse, *http.Response, error) {
	return r.ApiService.PostApprovalRequestApplyExecute(r)
}
...
func (a *ApprovalsApiService) PostApprovalRequestApplyExecute(r ApiPostApprovalRequestApplyRequest) (*ApprovalRequestResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApprovalsApiService.PostApprovalRequestApply")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/approval-requests/{id}/apply"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterToString(r.id, "")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.postApprovalRequestApplyRequest == nil {
		return localVarReturnValue, nil, reportError("postApprovalRequestApplyRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.postApprovalRequestApplyRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
...
type ApiPostApprovalRequestApplyForFlagRequest struct {
	ctx context.Context
	ApiService ApprovalsApi
	projectKey string
	featureFlagKey string
...
func (r ApiPostApprovalRequestApplyForFlagRequest) Execute() (*FlagConfigApprovalRequestResponse, *http.Response, error) {
	return r.ApiService.PostApprovalRequestApplyForFlagExecute(r)
}
...
func (a *ApprovalsApiService) PostApprovalRequestApplyForFlagExecute(r ApiPostApprovalRequestApplyForFlagRequest) (*FlagConfigApprovalRequestResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApprovalsApiService.PostApprovalRequestApplyForFlag")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiPostApprovalRequestForFlagRequest struct {
	ctx context.Context
	ApiService ApprovalsApi
	projectKey string
	featureFlagKey string
...
func (r ApiPostApprovalRequestForFlagRequest) CreateFlagConfigApprovalRequestRequest(createFlagConfigApprovalRequestRequest CreateFlagConfigApprovalRequestRequest) ApiPostApprovalRequestForFlagRequest {
	r.createFlagConfigApprovalRequestRequest = &createFlagConfigApprovalRequestRequest
	return r
}

func (r ApiPostApprovalRequestForFlagRequest) Execute() (*FlagConfigApprovalRequestResponse, *http.Response, error) {
	return r.ApiService.PostApprovalRequestForFlagExecute(r)
}
...
func (a *ApprovalsApiService) PostApprovalRequestForFlagExecute(r ApiPostApprovalRequestForFlagRequest) (*FlagConfigApprovalRequestResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApprovalsApiService.PostApprovalRequestForFlag")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createFlagConfigApprovalRequestRequest == nil {
		return localVarReturnValue, nil, reportError("createFlagConfigApprovalRequestRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createFlagConfigApprovalRequestRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
...
func (r ApiPostApprovalRequestReviewRequest) PostApprovalRequestReviewRequest(postApprovalRequestReviewRequest PostApprovalRequestReviewRequest) ApiPostApprovalRequestReviewRequest {
	r.postApprovalRequestReviewRequest = &postApprovalRequestReviewRequest
	return r
}
...
func (a *ApprovalsApiService) PostApprovalRequestReviewExecute(r ApiPostApprovalRequestReviewRequest) (*ApprovalRequestResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/approval-requests/{id}/reviews"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterToString(r.id, "")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.postApprovalRequestReviewRequest == nil {
		return localVarReturnValue, nil, reportError("postApprovalRequestReviewRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.postApprovalRequestReviewRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
...
type ApiPostApprovalRequestReviewForFlagRequest struct {
	ctx context.Context
	ApiService ApprovalsApi
	projectKey string
	featureFlagKey string
...
func (r ApiPostApprovalRequestReviewForFlagRequest) Execute() (*FlagConfigApprovalRequestResponse, *http.Response, error) {
	return r.ApiService.PostApprovalRequestReviewForFlagExecute(r)
}
...
func (a *ApprovalsApiService) PostApprovalRequestReviewForFlagExecute(r ApiPostApprovalRequestReviewForFlagRequest) (*FlagConfigApprovalRequestResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApprovalsApiService.PostApprovalRequestReviewForFlag")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiPostFlagCopyConfigApprovalRequestRequest) CreateCopyFlagConfigApprovalRequestRequest(createCopyFlagConfigApprovalRequestRequest CreateCopyFlagConfigApprovalRequestRequest) ApiPostFlagCopyConfigApprovalRequestRequest {
	r.createCopyFlagConfigApprovalRequestRequest = &createCopyFlagConfigApprovalRequestRequest
	return r
}

func (r ApiPostFlagCopyConfigApprovalRequestRequest) Execute() (*FlagConfigApprovalRequestResponse, *http.Response, error) {
	return r.ApiService.PostFlagCopyConfigApprovalRequestExecute(r)
}
...
func (a *ApprovalsApiService) PostFlagCopyConfigApprovalRequestExecute(r ApiPostFlagCopyConfigApprovalRequestRequest) (*FlagConfigApprovalRequestResponse, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApprovalsApiService.PostFlagCopyConfigApprovalRequest")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests-flag-copy"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterToString(r.projectKey, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagKey"+"}", url.PathEscape(parameterToString(r.featureFlagKey, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", url.PathEscape(parameterToString(r.environmentKey, "")), -1)
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createCopyFlagConfigApprovalRequestRequest == nil {
		return localVarReturnValue, nil, reportError("createCopyFlagConfigApprovalRequestRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createCopyFlagConfigApprovalRequestRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
