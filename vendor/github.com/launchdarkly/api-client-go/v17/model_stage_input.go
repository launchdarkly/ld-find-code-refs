...
func (o *StageInput) GetExecuteConditionsInSequence() bool {
	if o == nil || o.ExecuteConditionsInSequence == nil {
		var ret bool
		return ret
	}
	return *o.ExecuteConditionsInSequence
}

// GetExecuteConditionsInSequenceOk returns a tuple with the ExecuteConditionsInSequence field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StageInput) GetExecuteConditionsInSequenceOk() (*bool, bool) {
	if o == nil || o.ExecuteConditionsInSequence == nil {
		return nil, false
	}
	return o.ExecuteConditionsInSequence, true
}
...
func (o StageInput) MarshalJSON() ([]byte, error) {
	...
	if o.ExecuteConditionsInSequence != nil {
		toSerialize["executeConditionsInSequence"] = o.ExecuteConditionsInSequence
	}
	if o.Conditions != nil {
...
func NewNullableStageInput(val *StageInput) *NullableStageInput {
	return &NullableStageInput{value: val, isSet: true}
}
