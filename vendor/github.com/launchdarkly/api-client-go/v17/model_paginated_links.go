...
type PaginatedLinks struct {
	First *AiConfigsLink `json:"first,omitempty"`
	Last *AiConfigsLink `json:"last,omitempty"`
	Next *AiConfigsLink `json:"next,omitempty"`
	Prev *AiConfigsLink `json:"prev,omitempty"`
	Self AiConfigsLink `json:"self"`
}
...
// SetFirst gets a reference to the given AiConfigsLink and assigns it to the First field.
...
// SetLast gets a reference to the given AiConfigsLink and assigns it to the Last field.
...
// SetNext gets a reference to the given AiConfigsLink and assigns it to the Next field.
...
// SetPrev gets a reference to the given AiConfigsLink and assigns it to the Prev field.
