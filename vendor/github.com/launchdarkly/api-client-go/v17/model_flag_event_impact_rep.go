...
type FlagEventImpactRep struct {
	...
	EvaluationsSummary *EvaluationsSummary `json:"evaluationsSummary,omitempty"`
}
...
func (o *FlagEventImpactRep) GetEvaluationsSummary() EvaluationsSummary {
	if o == nil || o.EvaluationsSummary == nil {
		var ret EvaluationsSummary
		return ret
	}
	return *o.EvaluationsSummary
}

// GetEvaluationsSummaryOk returns a tuple with the EvaluationsSummary field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FlagEventImpactRep) GetEvaluationsSummaryOk() (*EvaluationsSummary, bool) {
	if o == nil || o.EvaluationsSummary == nil {
		return nil, false
	}
	return o.EvaluationsSummary, true
}
...
func (o FlagEventImpactRep) MarshalJSON() ([]byte, error) {
	...
	if o.EvaluationsSummary != nil {
		toSerialize["evaluationsSummary"] = o.EvaluationsSummary
	}
	return json.Marshal(toSerialize)
}

type NullableFlagEventImpactRep struct {
	value *FlagEventImpactRep
	isSet bool
}
...
func NewNullableFlagEventImpactRep(val *FlagEventImpactRep) *NullableFlagEventImpactRep {
	return &NullableFlagEventImpactRep{value: val, isSet: true}
}
