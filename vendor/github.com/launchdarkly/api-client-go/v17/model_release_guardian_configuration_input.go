...
// ReleaseGuardianConfigurationInput struct for ReleaseGuardianConfigurationInput
type ReleaseGuardianConfigurationInput struct {
	// The monitoring window in milliseconds
	MonitoringWindowMilliseconds *int64 `json:"monitoringWindowMilliseconds,omitempty"`
	// The rollout weight
	RolloutWeight *int32 `json:"rolloutWeight,omitempty"`
...
func NewReleaseGuardianConfigurationInput() *ReleaseGuardianConfigurationInput {
	this := ReleaseGuardianConfigurationInput{}
	return &this
}
...
// GetMonitoringWindowMilliseconds returns the MonitoringWindowMilliseconds field value if set, zero value otherwise.
func (o *ReleaseGuardianConfigurationInput) GetMonitoringWindowMilliseconds() int64 {
	if o == nil || o.MonitoringWindowMilliseconds == nil {
		var ret int64
		return ret
	}
	return *o.MonitoringWindowMilliseconds
}

// GetMonitoringWindowMillisecondsOk returns a tuple with the MonitoringWindowMilliseconds field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReleaseGuardianConfigurationInput) GetMonitoringWindowMillisecondsOk() (*int64, bool) {
	if o == nil || o.MonitoringWindowMilliseconds == nil {
		return nil, false
	}
	return o.MonitoringWindowMilliseconds, true
}
...
// SetMonitoringWindowMilliseconds gets a reference to the given int64 and assigns it to the MonitoringWindowMilliseconds field.
func (o *ReleaseGuardianConfigurationInput) SetMonitoringWindowMilliseconds(v int64) {
	o.MonitoringWindowMilliseconds = &v
}

// GetRolloutWeight returns the RolloutWeight field value if set, zero value otherwise.
func (o *ReleaseGuardianConfigurationInput) GetRolloutWeight() int32 {
	if o == nil || o.RolloutWeight == nil {
		var ret int32
		return ret
	}
	return *o.RolloutWeight
}

// GetRolloutWeightOk returns a tuple with the RolloutWeight field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReleaseGuardianConfigurationInput) GetRolloutWeightOk() (*int32, bool) {
	if o == nil || o.RolloutWeight == nil {
		return nil, false
	}
	return o.RolloutWeight, true
}
...
// SetRolloutWeight gets a reference to the given int32 and assigns it to the RolloutWeight field.
...
func (o *ReleaseGuardianConfigurationInput) GetRollbackOnRegression() bool {
	if o == nil || o.RollbackOnRegression == nil {
		var ret bool
		return ret
	}
...
func (o ReleaseGuardianConfigurationInput) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.MonitoringWindowMilliseconds != nil {
		toSerialize["monitoringWindowMilliseconds"] = o.MonitoringWindowMilliseconds
	}
	if o.RolloutWeight != nil {
		toSerialize["rolloutWeight"] = o.RolloutWeight
	}
	if o.RollbackOnRegression != nil {
...
type NullableReleaseGuardianConfigurationInput struct {
	value *ReleaseGuardianConfigurationInput
	isSet bool
}

func (v NullableReleaseGuardianConfigurationInput) Get() *ReleaseGuardianConfigurationInput {
	return v.value
}

func (v *NullableReleaseGuardianConfigurationInput) Set(val *ReleaseGuardianConfigurationInput) {
	v.value = val
	v.isSet = true
}

func (v NullableReleaseGuardianConfigurationInput) IsSet() bool {
	return v.isSet
}

func (v *NullableReleaseGuardianConfigurationInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReleaseGuardianConfigurationInput(val *ReleaseGuardianConfigurationInput) *NullableReleaseGuardianConfigurationInput {
	return &NullableReleaseGuardianConfigurationInput{value: val, isSet: true}
}

func (v NullableReleaseGuardianConfigurationInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReleaseGuardianConfigurationInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
