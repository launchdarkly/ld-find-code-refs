...
// SimpleHoldoutRep struct for SimpleHoldoutRep
type SimpleHoldoutRep struct {
...
func (o SimpleHoldoutRep) MarshalJSON() ([]byte, error) {
...
type NullableSimpleHoldoutRep struct {
	value *SimpleHoldoutRep
	isSet bool
}

func (v NullableSimpleHoldoutRep) Get() *SimpleHoldoutRep {
	return v.value
}

func (v *NullableSimpleHoldoutRep) Set(val *SimpleHoldoutRep) {
	v.value = val
	v.isSet = true
}

func (v NullableSimpleHoldoutRep) IsSet() bool {
	return v.isSet
}

func (v *NullableSimpleHoldoutRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSimpleHoldoutRep(val *SimpleHoldoutRep) *NullableSimpleHoldoutRep {
	return &NullableSimpleHoldoutRep{value: val, isSet: true}
}

func (v NullableSimpleHoldoutRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSimpleHoldoutRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
