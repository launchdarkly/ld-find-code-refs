...
type FeatureFlagBody struct {
	...
	InitialPrerequisites []FlagPrerequisitePost `json:"initialPrerequisites,omitempty"`
}
...
// GetInitialPrerequisites returns the InitialPrerequisites field value if set, zero value otherwise.
func (o *FeatureFlagBody) GetInitialPrerequisites() []FlagPrerequisitePost {
	if o == nil || o.InitialPrerequisites == nil {
		var ret []FlagPrerequisitePost
		return ret
	}
	return o.InitialPrerequisites
}

// GetInitialPrerequisitesOk returns a tuple with the InitialPrerequisites field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FeatureFlagBody) GetInitialPrerequisitesOk() ([]FlagPrerequisitePost, bool) {
	if o == nil || o.InitialPrerequisites == nil {
		return nil, false
	}
	return o.InitialPrerequisites, true
}
...
// SetInitialPrerequisites gets a reference to the given []FlagPrerequisitePost and assigns it to the InitialPrerequisites field.
func (o *FeatureFlagBody) SetInitialPrerequisites(v []FlagPrerequisitePost) {
	o.InitialPrerequisites = v
}
...
func (o FeatureFlagBody) MarshalJSON() ([]byte, error) {
	...
	if o.InitialPrerequisites != nil {
		toSerialize["initialPrerequisites"] = o.InitialPrerequisites
	}
