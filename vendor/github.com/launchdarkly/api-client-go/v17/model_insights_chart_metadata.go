...
type InsightsChartMetadata struct {
	Summary map[string]interface{} `json:"summary"`
	// Name of the chart
	Name *string `json:"name,omitempty"`
	Metrics *map[string]InsightsChartMetric `json:"metrics,omitempty"`
	XAxis InsightsChartSeriesMetadataAxis `json:"xAxis"`
	YAxis InsightsChartSeriesMetadataAxis `json:"yAxis"`
}
...
func (o *InsightsChartMetadata) GetMetrics() map[string]InsightsChartMetric {
	if o == nil || o.Metrics == nil {
		var ret map[string]InsightsChartMetric
		return ret
	}
	return *o.Metrics
}
...
func (o *InsightsChartMetadata) GetXAxis() InsightsChartSeriesMetadataAxis {
	if o == nil {
		var ret InsightsChartSeriesMetadataAxis
		return ret
	}
...
func NewNullableInsightsChartMetadata(val *InsightsChartMetadata) *NullableInsightsChartMetadata {
	return &NullableInsightsChartMetadata{value: val, isSet: true}
}
