...
type InsightGroupScores struct {
	Overall InsightsMetricScore `json:"overall"`
	DeploymentFrequency InsightsMetricScore `json:"deploymentFrequency"`
	DeploymentFailureRate InsightsMetricScore `json:"deploymentFailureRate"`
	LeadTime InsightsMetricScore `json:"leadTime"`
	ImpactSize InsightsMetricScore `json:"impactSize"`
	ExperimentationCoverage InsightsMetricScore `json:"experimentationCoverage"`
	FlagHealth InsightsMetricScore `json:"flagHealth"`
	Velocity InsightsMetricScore `json:"velocity"`
	Risk InsightsMetricScore `json:"risk"`
	Efficiency InsightsMetricScore `json:"efficiency"`
...
// GetImpactSizeOk returns a tuple with the ImpactSize field value
// and a boolean to check if the value has been set.
func (o *InsightGroupScores) GetImpactSizeOk() (*InsightsMetricScore, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ImpactSize, true
}
...
// GetFlagHealthOk returns a tuple with the FlagHealth field value
// and a boolean to check if the value has been set.
func (o *InsightGroupScores) GetFlagHealthOk() (*InsightsMetricScore, bool) {
	if o == nil {
		return nil, false
	}
	return &o.FlagHealth, true
}
...
func (o *InsightGroupScores) GetCreationRatio() InsightsMetricScore {
	if o == nil || o.CreationRatio == nil {
		var ret InsightsMetricScore
		return ret
	}
	return *o.CreationRatio
}

// GetCreationRatioOk returns a tuple with the CreationRatio field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InsightGroupScores) GetCreationRatioOk() (*InsightsMetricScore, bool) {
	if o == nil || o.CreationRatio == nil {
		return nil, false
	}
	return o.CreationRatio, true
}
...
func (o InsightGroupScores) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["deploymentFrequency"] = o.DeploymentFrequency
	}
	if true {
		toSerialize["deploymentFailureRate"] = o.DeploymentFailureRate
	}
	if true {
		toSerialize["leadTime"] = o.LeadTime
	}
	if true {
		toSerialize["impactSize"] = o.ImpactSize
	}
	if true {
		toSerialize["experimentationCoverage"] = o.ExperimentationCoverage
	}
	if true {
		toSerialize["flagHealth"] = o.FlagHealth
	}
	if true {
	...
	if o.CreationRatio != nil {
		toSerialize["creationRatio"] = o.CreationRatio
	}
	return json.Marshal(toSerialize)
}

type NullableInsightGroupScores struct {
	value *InsightGroupScores
	isSet bool
}
...
func NewNullableInsightGroupScores(val *InsightGroupScores) *NullableInsightGroupScores {
	return &NullableInsightGroupScores{value: val, isSet: true}
}
