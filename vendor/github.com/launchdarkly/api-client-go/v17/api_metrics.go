...
type MetricsApi interface {
	...
	*/
	DeleteMetric(ctx context.Context, projectKey string, metricKey string) ApiDeleteMetricRequest

	// DeleteMetricExecute executes the request
	DeleteMetricExecute(r ApiDeleteMetricRequest) (*http.Response, error)
...
For example, `expand=experiments` includes the `experiments` field in the response.
	...
	*/
	GetMetric(ctx context.Context, projectKey string, metricKey string) ApiGetMetricRequest

	// GetMetricExecute executes the request
	//  @return MetricRep
	GetMetricExecute(r ApiGetMetricRequest) (*MetricRep, *http.Response, error)
...
For example, `expand=experimentCount` includes the `experimentCount` field for each metric in the response.
	...
	*/
	GetMetrics(ctx context.Context, projectKey string) ApiGetMetricsRequest

	// GetMetricsExecute executes the request
	//  @return MetricCollectionRep
	GetMetricsExecute(r ApiGetMetricsRequest) (*MetricCollectionRep, *http.Response, error)
	...
	*/
	PatchMetric(ctx context.Context, projectKey string, metricKey string) ApiPatchMetricRequest

	// PatchMetricExecute executes the request
	//  @return MetricRep
	PatchMetricExecute(r ApiPatchMetricRequest) (*MetricRep, *http.Response, error)
	...
	*/
	PostMetric(ctx context.Context, projectKey string) ApiPostMetricRequest

	// PostMetricExecute executes the request
	//  @return MetricRep
	PostMetricExecute(r ApiPostMetricRequest) (*MetricRep, *http.Response, error)
}
...
func (a *MetricsApiService) DeleteMetricExecute(r ApiDeleteMetricRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/metrics/{projectKey}/{metricKey}"
...
func (r ApiGetMetricsRequest) Limit(limit int64) ApiGetMetricsRequest {
	r.limit = &limit
	return r
}
...
func (r ApiGetMetricsRequest) Offset(offset int64) ApiGetMetricsRequest {
	r.offset = &offset
	return r
}
...
func (r ApiGetMetricsRequest) Sort(sort string) ApiGetMetricsRequest {
	r.sort = &sort
	return r
}
...
func (a *MetricsApiService) PostMetricExecute(r ApiPostMetricRequest) (*MetricRep, *http.Response, error) {
	...
	localVarFormParams := url.Values{}
	if r.metricPost == nil {
		return localVarReturnValue, nil, reportError("metricPost is required and must be specified")
	}
