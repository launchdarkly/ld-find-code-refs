...
type ContextAttributeName struct {
...
func NewNullableContextAttributeName(val *ContextAttributeName) *NullableContextAttributeName {
	return &NullableContextAttributeName{value: val, isSet: true}
}
