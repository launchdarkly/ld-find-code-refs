...
type ContextInstanceEvaluationReason struct {
...
func NewContextInstanceEvaluationReason(kind string) *ContextInstanceEvaluationReason {
	this := ContextInstanceEvaluationReason{}
	this.Kind = kind
	return &this
}
...
func (o *ContextInstanceEvaluationReason) GetPrerequisiteKey() string {
	if o == nil || o.PrerequisiteKey == nil {
		var ret string
		return ret
	}
	return *o.PrerequisiteKey
}

// GetPrerequisiteKeyOk returns a tuple with the PrerequisiteKey field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ContextInstanceEvaluationReason) GetPrerequisiteKeyOk() (*string, bool) {
	if o == nil || o.PrerequisiteKey == nil {
		return nil, false
	}
	return o.PrerequisiteKey, true
}
...
func (o *ContextInstanceEvaluationReason) GetInExperiment() bool {
	if o == nil || o.InExperiment == nil {
		var ret bool
		return ret
	}
	return *o.InExperiment
}

// GetInExperimentOk returns a tuple with the InExperiment field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ContextInstanceEvaluationReason) GetInExperimentOk() (*bool, bool) {
	if o == nil || o.InExperiment == nil {
		return nil, false
	}
	return o.InExperiment, true
}
...
// GetErrorKindOk returns a tuple with the ErrorKind field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ContextInstanceEvaluationReason) GetErrorKindOk() (*string, bool) {
	if o == nil || o.ErrorKind == nil {
		return nil, false
	}
	return o.ErrorKind, true
}
...
func (o ContextInstanceEvaluationReason) MarshalJSON() ([]byte, error) {
	...
	if o.PrerequisiteKey != nil {
		toSerialize["prerequisiteKey"] = o.PrerequisiteKey
	}
	if o.InExperiment != nil {
		toSerialize["inExperiment"] = o.InExperiment
	}
	if o.ErrorKind != nil {
		toSerialize["errorKind"] = o.ErrorKind
	}
	return json.Marshal(toSerialize)
}

type NullableContextInstanceEvaluationReason struct {
	value *ContextInstanceEvaluationReason
	isSet bool
}
...
func NewNullableContextInstanceEvaluationReason(val *ContextInstanceEvaluationReason) *NullableContextInstanceEvaluationReason {
	return &NullableContextInstanceEvaluationReason{value: val, isSet: true}
}
