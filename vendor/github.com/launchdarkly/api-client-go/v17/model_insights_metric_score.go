...
type InsightsMetricScore struct {
	...
	DiffVsLastPeriod *int32 `json:"diffVsLastPeriod,omitempty"`
	Indicator string `json:"indicator"`
	IndicatorRange InsightsMetricIndicatorRange `json:"indicatorRange"`
	LastPeriod *InsightsMetricScore `json:"lastPeriod,omitempty"`
}
...
func (o *InsightsMetricScore) GetAggregateOf() []string {
	if o == nil || o.AggregateOf == nil {
		var ret []string
		return ret
	}
	return o.AggregateOf
}

// GetAggregateOfOk returns a tuple with the AggregateOf field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InsightsMetricScore) GetAggregateOfOk() ([]string, bool) {
	if o == nil || o.AggregateOf == nil {
		return nil, false
	}
	return o.AggregateOf, true
}
...
func (o *InsightsMetricScore) GetDiffVsLastPeriod() int32 {
	if o == nil || o.DiffVsLastPeriod == nil {
		var ret int32
		return ret
	}
	return *o.DiffVsLastPeriod
}

// GetDiffVsLastPeriodOk returns a tuple with the DiffVsLastPeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InsightsMetricScore) GetDiffVsLastPeriodOk() (*int32, bool) {
	if o == nil || o.DiffVsLastPeriod == nil {
		return nil, false
	}
	return o.DiffVsLastPeriod, true
}
...
func (o *InsightsMetricScore) GetIndicatorRange() InsightsMetricIndicatorRange {
	if o == nil {
		var ret InsightsMetricIndicatorRange
		return ret
	}

	return o.IndicatorRange
}

// GetIndicatorRangeOk returns a tuple with the IndicatorRange field value
// and a boolean to check if the value has been set.
func (o *InsightsMetricScore) GetIndicatorRangeOk() (*InsightsMetricIndicatorRange, bool) {
	if o == nil {
		return nil, false
	}
	return &o.IndicatorRange, true
}
...
// GetLastPeriodOk returns a tuple with the LastPeriod field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InsightsMetricScore) GetLastPeriodOk() (*InsightsMetricScore, bool) {
	if o == nil || o.LastPeriod == nil {
		return nil, false
	}
	return o.LastPeriod, true
}
...
func (o InsightsMetricScore) MarshalJSON() ([]byte, error) {
	...
	if o.AggregateOf != nil {
		toSerialize["aggregateOf"] = o.AggregateOf
	}
	if o.DiffVsLastPeriod != nil {
		toSerialize["diffVsLastPeriod"] = o.DiffVsLastPeriod
	}
	if true {
		toSerialize["indicator"] = o.Indicator
	}
	if true {
		toSerialize["indicatorRange"] = o.IndicatorRange
	}
	if o.LastPeriod != nil {
		toSerialize["lastPeriod"] = o.LastPeriod
	}
	return json.Marshal(toSerialize)
}

type NullableInsightsMetricScore struct {
	value *InsightsMetricScore
	isSet bool
}
...
func NewNullableInsightsMetricScore(val *InsightsMetricScore) *NullableInsightsMetricScore {
	return &NullableInsightsMetricScore{value: val, isSet: true}
}
