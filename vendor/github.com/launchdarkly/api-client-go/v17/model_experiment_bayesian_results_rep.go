...
func (o *ExperimentBayesianResultsRep) GetTreatmentResultsOk() ([]TreatmentResultRep, bool) {
	...
	return o.TreatmentResults, true
}
...
func (o *ExperimentBayesianResultsRep) GetProbabilityOfMismatch() float32 {
	if o == nil || o.ProbabilityOfMismatch == nil {
		var ret float32
		return ret
	}
	return *o.ProbabilityOfMismatch
}

// GetProbabilityOfMismatchOk returns a tuple with the ProbabilityOfMismatch field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ExperimentBayesianResultsRep) GetProbabilityOfMismatchOk() (*float32, bool) {
	if o == nil || o.ProbabilityOfMismatch == nil {
		return nil, false
	}
	return o.ProbabilityOfMismatch, true
}
...
func (o ExperimentBayesianResultsRep) MarshalJSON() ([]byte, error) {
	...
	if o.TreatmentResults != nil {
		toSerialize["treatmentResults"] = o.TreatmentResults
	}
	if o.MetricSeen != nil {
...
type NullableExperimentBayesianResultsRep struct {
	value *ExperimentBayesianResultsRep
	isSet bool
}
...
func NewNullableExperimentBayesianResultsRep(val *ExperimentBayesianResultsRep) *NullableExperimentBayesianResultsRep {
	return &NullableExperimentBayesianResultsRep{value: val, isSet: true}
}
