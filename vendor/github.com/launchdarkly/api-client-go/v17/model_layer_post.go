...
// LayerPost struct for LayerPost
type LayerPost struct {
...
func (o LayerPost) MarshalJSON() ([]byte, error) {
...
type NullableLayerPost struct {
	value *LayerPost
	isSet bool
}

func (v NullableLayerPost) Get() *LayerPost {
	return v.value
}

func (v *NullableLayerPost) Set(val *LayerPost) {
	v.value = val
	v.isSet = true
}

func (v NullableLayerPost) IsSet() bool {
	return v.isSet
}

func (v *NullableLayerPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLayerPost(val *LayerPost) *NullableLayerPost {
	return &NullableLayerPost{value: val, isSet: true}
}

func (v NullableLayerPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLayerPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
