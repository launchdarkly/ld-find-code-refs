...
type CreateReleasePipelineInput struct {
	...
	IsProjectDefault *bool `json:"isProjectDefault,omitempty"`
...
func NewCreateReleasePipelineInput(key string, name string, phases []CreatePhaseInput) *CreateReleasePipelineInput {
	this := CreateReleasePipelineInput{}
	this.Key = key
	this.Name = name
	this.Phases = phases
	return &this
...
// GetIsProjectDefault returns the IsProjectDefault field value if set, zero value otherwise.
func (o *CreateReleasePipelineInput) GetIsProjectDefault() bool {
	if o == nil || o.IsProjectDefault == nil {
		var ret bool
		return ret
	}
	return *o.IsProjectDefault
}

// GetIsProjectDefaultOk returns a tuple with the IsProjectDefault field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateReleasePipelineInput) GetIsProjectDefaultOk() (*bool, bool) {
	if o == nil || o.IsProjectDefault == nil {
		return nil, false
	}
	return o.IsProjectDefault, true
}
...
// SetIsProjectDefault gets a reference to the given bool and assigns it to the IsProjectDefault field.
func (o *CreateReleasePipelineInput) SetIsProjectDefault(v bool) {
	o.IsProjectDefault = &v
}
...
func (o CreateReleasePipelineInput) MarshalJSON() ([]byte, error) {
	...
	if o.IsProjectDefault != nil {
		toSerialize["isProjectDefault"] = o.IsProjectDefault
	}
	if o.IsLegacy != nil {
...
type NullableCreateReleasePipelineInput struct {
	value *CreateReleasePipelineInput
	isSet bool
}
...
func NewNullableCreateReleasePipelineInput(val *CreateReleasePipelineInput) *NullableCreateReleasePipelineInput {
	return &NullableCreateReleasePipelineInput{value: val, isSet: true}
}
