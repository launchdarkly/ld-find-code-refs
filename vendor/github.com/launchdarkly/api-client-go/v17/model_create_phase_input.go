...
type CreatePhaseInput struct {
	...
	Audiences []AudiencePost `json:"audiences"`
...
func NewNullableCreatePhaseInput(val *CreatePhaseInput) *NullableCreatePhaseInput {
	return &NullableCreatePhaseInput{value: val, isSet: true}
}
