...
type InsightsChartMetric struct {
	...
	Tiers []InsightsMetricTierDefinition `json:"tiers"`
}
...
func (o *InsightsChartMetric) GetTiers() []InsightsMetricTierDefinition {
	if o == nil {
		var ret []InsightsMetricTierDefinition
		return ret
	}
...
func NewNullableInsightsChartMetric(val *InsightsChartMetric) *NullableInsightsChartMetric {
	return &NullableInsightsChartMetric{value: val, isSet: true}
}
