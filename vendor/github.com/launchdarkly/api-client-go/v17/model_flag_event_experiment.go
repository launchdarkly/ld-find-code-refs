...
type FlagEventExperiment struct {
	// The experiment key
	Key string `json:"key"`
	// The experiment name
	Name string `json:"name"`
	Iteration FlagEventExperimentIteration `json:"iteration"`
...
func (o *FlagEventExperiment) GetIteration() FlagEventExperimentIteration {
	if o == nil {
		var ret FlagEventExperimentIteration
		return ret
	}
...
func NewNullableFlagEventExperiment(val *FlagEventExperiment) *NullableFlagEventExperiment {
	return &NullableFlagEventExperiment{value: val, isSet: true}
}
