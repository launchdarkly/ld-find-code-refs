...
type InsightGroupCollection struct {
	// The total number of insight groups
	TotalCount int32 `json:"totalCount"`
	// A list of insight groups
	Items []InsightGroup `json:"items"`
	// The location and content type of related resources
	Links *map[string]Link `json:"_links,omitempty"`
	Metadata *InsightGroupCollectionMetadata `json:"metadata,omitempty"`
...
func (o *InsightGroupCollection) GetMetadata() InsightGroupCollectionMetadata {
	if o == nil || o.Metadata == nil {
		var ret InsightGroupCollectionMetadata
		return ret
	}
	return *o.Metadata
}
...
func (o *InsightGroupCollection) GetScoreMetadata() InsightGroupCollectionScoreMetadata {
	if o == nil || o.ScoreMetadata == nil {
		var ret InsightGroupCollectionScoreMetadata
		return ret
	}
...
func NewNullableInsightGroupCollection(val *InsightGroupCollection) *NullableInsightGroupCollection {
	return &NullableInsightGroupCollection{value: val, isSet: true}
}
