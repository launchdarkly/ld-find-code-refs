...
type ContextInstanceEvaluations struct {
	// Details on the flag evaluations for this context instance
	Items []ContextInstanceEvaluation `json:"items"`
	// The number of flags
...
func NewContextInstanceEvaluations(items []ContextInstanceEvaluation, links map[string]Link) *ContextInstanceEvaluations {
	this := ContextInstanceEvaluations{}
	this.Items = items
	this.Links = links
	return &this
}
...
func (o *ContextInstanceEvaluations) GetItems() []ContextInstanceEvaluation {
	if o == nil {
		var ret []ContextInstanceEvaluation
		return ret
	}
...
type NullableContextInstanceEvaluations struct {
	value *ContextInstanceEvaluations
	isSet bool
}
...
func NewNullableContextInstanceEvaluations(val *ContextInstanceEvaluations) *NullableContextInstanceEvaluations {
	return &NullableContextInstanceEvaluations{value: val, isSet: true}
}
