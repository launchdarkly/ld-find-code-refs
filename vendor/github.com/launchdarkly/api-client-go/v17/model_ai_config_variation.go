...
// AIConfigVariation struct for AIConfigVariation
type AIConfigVariation struct {
	Links *ParentLink `json:"_links,omitempty"`
	Key string `json:"key"`
	...
	ArchivedAt *int64 `json:"_archivedAt,omitempty"`
	PublishedAt *int64 `json:"_publishedAt,omitempty"`
}
...
// SetLinks gets a reference to the given ParentLink and assigns it to the Links field.
...
// GetModelConfigKey returns the ModelConfigKey field value if set, zero value otherwise.
func (o *AIConfigVariation) GetModelConfigKey() string {
	if o == nil || o.ModelConfigKey == nil {
		var ret string
		return ret
	}
	return *o.ModelConfigKey
}

// GetModelConfigKeyOk returns a tuple with the ModelConfigKey field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AIConfigVariation) GetModelConfigKeyOk() (*string, bool) {
	if o == nil || o.ModelConfigKey == nil {
		return nil, false
	}
	return o.ModelConfigKey, true
}
...
// SetModelConfigKey gets a reference to the given string and assigns it to the ModelConfigKey field.
...
func (o AIConfigVariation) MarshalJSON() ([]byte, error) {
	...
	if o.ModelConfigKey != nil {
		toSerialize["modelConfigKey"] = o.ModelConfigKey
	}
	if true {
	...
	if o.ArchivedAt != nil {
		toSerialize["_archivedAt"] = o.ArchivedAt
	}
	if o.PublishedAt != nil {
		toSerialize["_publishedAt"] = o.PublishedAt
	}
	return json.Marshal(toSerialize)
}

type NullableAIConfigVariation struct {
	value *AIConfigVariation
	isSet bool
}

func (v NullableAIConfigVariation) Get() *AIConfigVariation {
	return v.value
}

func (v *NullableAIConfigVariation) Set(val *AIConfigVariation) {
	v.value = val
	v.isSet = true
}

func (v NullableAIConfigVariation) IsSet() bool {
	return v.isSet
}

func (v *NullableAIConfigVariation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAIConfigVariation(val *AIConfigVariation) *NullableAIConfigVariation {
	return &NullableAIConfigVariation{value: val, isSet: true}
}

func (v NullableAIConfigVariation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAIConfigVariation) UnmarshalJSON(src []byte) error {
	v.isSet = true
