...
type AccessTokensApi interface {
	...
	*/
	GetToken(ctx context.Context, id string) ApiGetTokenRequest
	...
	*/
	...
	//  @return Tokens
	GetTokensExecute(r ApiGetTokensRequest) (*Tokens, *http.Response, error)
	...
	*/
	PatchToken(ctx context.Context, id string) ApiPatchTokenRequest

	// PatchTokenExecute executes the request
	//  @return Token
	PatchTokenExecute(r ApiPatchTokenRequest) (*Token, *http.Response, error)
	...
	*/
	PostToken(ctx context.Context) ApiPostTokenRequest

	// PostTokenExecute executes the request
	//  @return Token
	PostTokenExecute(r ApiPostTokenRequest) (*Token, *http.Response, error)
	...
	*/
	ResetToken(ctx context.Context, id string) ApiResetTokenRequest

	// ResetTokenExecute executes the request
	//  @return Token
	ResetTokenExecute(r ApiResetTokenRequest) (*Token, *http.Response, error)
}
...
func (r ApiPostTokenRequest) AccessTokenPost(accessTokenPost AccessTokenPost) ApiPostTokenRequest {
	r.accessTokenPost = &accessTokenPost
	return r
}
...
func (a *AccessTokensApiService) PostTokenExecute(r ApiPostTokenRequest) (*Token, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.accessTokenPost == nil {
		return localVarReturnValue, nil, reportError("accessTokenPost is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.accessTokenPost
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
