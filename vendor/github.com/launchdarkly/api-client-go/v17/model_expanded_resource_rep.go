...
// ExpandedResourceRep struct for ExpandedResourceRep
type ExpandedResourceRep struct {
...
// SetSegment gets a reference to the given UserSegment and assigns it to the Segment field.
func (o *ExpandedResourceRep) SetSegment(v UserSegment) {
	o.Segment = &v
}

func (o ExpandedResourceRep) MarshalJSON() ([]byte, error) {
...
type NullableExpandedResourceRep struct {
	value *ExpandedResourceRep
	isSet bool
}

func (v NullableExpandedResourceRep) Get() *ExpandedResourceRep {
	return v.value
}

func (v *NullableExpandedResourceRep) Set(val *ExpandedResourceRep) {
	v.value = val
	v.isSet = true
}

func (v NullableExpandedResourceRep) IsSet() bool {
	return v.isSet
}

func (v *NullableExpandedResourceRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpandedResourceRep(val *ExpandedResourceRep) *NullableExpandedResourceRep {
	return &NullableExpandedResourceRep{value: val, isSet: true}
}

func (v NullableExpandedResourceRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpandedResourceRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
