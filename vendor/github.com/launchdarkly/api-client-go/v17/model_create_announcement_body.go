...
func (o CreateAnnouncementBody) MarshalJSON() ([]byte, error) {
...
type NullableCreateAnnouncementBody struct {
	value *CreateAnnouncementBody
	isSet bool
}

func (v NullableCreateAnnouncementBody) Get() *CreateAnnouncementBody {
	return v.value
}

func (v *NullableCreateAnnouncementBody) Set(val *CreateAnnouncementBody) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAnnouncementBody) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAnnouncementBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAnnouncementBody(val *CreateAnnouncementBody) *NullableCreateAnnouncementBody {
	return &NullableCreateAnnouncementBody{value: val, isSet: true}
}

func (v NullableCreateAnnouncementBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAnnouncementBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
