...
func (o *BooleanDefaults) GetTrueDisplayName() string {
	if o == nil || o.TrueDisplayName == nil {
		var ret string
		return ret
	}
	return *o.TrueDisplayName
}

// GetTrueDisplayNameOk returns a tuple with the TrueDisplayName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BooleanDefaults) GetTrueDisplayNameOk() (*string, bool) {
	if o == nil || o.TrueDisplayName == nil {
		return nil, false
	}
	return o.TrueDisplayName, true
}
...
func (o *BooleanDefaults) GetFalseDisplayName() string {
	if o == nil || o.FalseDisplayName == nil {
		var ret string
		return ret
	}
	return *o.FalseDisplayName
}

// GetFalseDisplayNameOk returns a tuple with the FalseDisplayName field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BooleanDefaults) GetFalseDisplayNameOk() (*string, bool) {
	if o == nil || o.FalseDisplayName == nil {
		return nil, false
	}
	return o.FalseDisplayName, true
}
...
func (o *BooleanDefaults) GetTrueDescription() string {
	if o == nil || o.TrueDescription == nil {
		var ret string
		return ret
	}
	return *o.TrueDescription
}

// GetTrueDescriptionOk returns a tuple with the TrueDescription field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BooleanDefaults) GetTrueDescriptionOk() (*string, bool) {
	if o == nil || o.TrueDescription == nil {
		return nil, false
	}
	return o.TrueDescription, true
}
...
func (o *BooleanDefaults) GetFalseDescription() string {
	if o == nil || o.FalseDescription == nil {
		var ret string
		return ret
	}
	return *o.FalseDescription
}

// GetFalseDescriptionOk returns a tuple with the FalseDescription field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BooleanDefaults) GetFalseDescriptionOk() (*string, bool) {
	if o == nil || o.FalseDescription == nil {
		return nil, false
	}
	return o.FalseDescription, true
}
...
func (o BooleanDefaults) MarshalJSON() ([]byte, error) {
	...
	if o.TrueDisplayName != nil {
		toSerialize["trueDisplayName"] = o.TrueDisplayName
	}
	if o.FalseDisplayName != nil {
		toSerialize["falseDisplayName"] = o.FalseDisplayName
	}
	if o.TrueDescription != nil {
		toSerialize["trueDescription"] = o.TrueDescription
	}
	if o.FalseDescription != nil {
		toSerialize["falseDescription"] = o.FalseDescription
	}
...
func NewNullableBooleanDefaults(val *BooleanDefaults) *NullableBooleanDefaults {
	return &NullableBooleanDefaults{value: val, isSet: true}
}
