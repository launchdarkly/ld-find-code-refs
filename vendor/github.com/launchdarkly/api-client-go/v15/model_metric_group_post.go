...
type MetricGroupPost struct {
	...
	Metrics []MetricInMetricGroupInput `json:"metrics"`
}
...
func (o *MetricGroupPost) GetMetrics() []MetricInMetricGroupInput {
	if o == nil {
		var ret []MetricInMetricGroupInput
		return ret
	}
...
func NewNullableMetricGroupPost(val *MetricGroupPost) *NullableMetricGroupPost {
	return &NullableMetricGroupPost{value: val, isSet: true}
}
