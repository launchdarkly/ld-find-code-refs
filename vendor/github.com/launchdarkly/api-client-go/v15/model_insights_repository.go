...
type InsightsRepository struct {
	...
	Projects *ProjectSummaryCollection `json:"projects,omitempty"`
}
...
// GetMainBranchOk returns a tuple with the MainBranch field value
// and a boolean to check if the value has been set.
...
func (o *InsightsRepository) GetProjects() ProjectSummaryCollection {
	if o == nil || o.Projects == nil {
		var ret ProjectSummaryCollection
		return ret
	}
	return *o.Projects
}
...
func NewNullableInsightsRepository(val *InsightsRepository) *NullableInsightsRepository {
	return &NullableInsightsRepository{value: val, isSet: true}
}
