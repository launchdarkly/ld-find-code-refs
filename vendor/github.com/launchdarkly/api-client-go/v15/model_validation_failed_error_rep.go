...
type ValidationFailedErrorRep struct {
	// Specific error code encountered
	Code string `json:"code"`
	// Description of the error
	Message string `json:"message"`
	// List of validation errors
	Errors []FailureReasonRep `json:"errors"`
}
...
type NullableValidationFailedErrorRep struct {
	value *ValidationFailedErrorRep
	isSet bool
}
...
func NewNullableValidationFailedErrorRep(val *ValidationFailedErrorRep) *NullableValidationFailedErrorRep {
	return &NullableValidationFailedErrorRep{value: val, isSet: true}
}
