...
type ContextRecord struct {
	...
	AssociatedContexts *int32 `json:"associatedContexts,omitempty"`
}
...
func (o *ContextRecord) GetAssociatedContexts() int32 {
	if o == nil || o.AssociatedContexts == nil {
		var ret int32
		return ret
	}
	return *o.AssociatedContexts
}

// GetAssociatedContextsOk returns a tuple with the AssociatedContexts field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ContextRecord) GetAssociatedContextsOk() (*int32, bool) {
	if o == nil || o.AssociatedContexts == nil {
		return nil, false
	}
	return o.AssociatedContexts, true
}
...
func (o ContextRecord) MarshalJSON() ([]byte, error) {
	...
	if o.AssociatedContexts != nil {
		toSerialize["associatedContexts"] = o.AssociatedContexts
	}
...
func NewNullableContextRecord(val *ContextRecord) *NullableContextRecord {
	return &NullableContextRecord{value: val, isSet: true}
}
