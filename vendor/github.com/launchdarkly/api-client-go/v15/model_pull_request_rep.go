...
type PullRequestRep struct {
	...
	MergeTime *int64 `json:"mergeTime,omitempty"`
	// The pull request merge commit key
	MergeCommitKey *string `json:"mergeCommitKey,omitempty"`
	// The pull request base commit key
	BaseCommitKey string `json:"baseCommitKey"`
	// The pull request head commit key
	HeadCommitKey string `json:"headCommitKey"`
	// The number of files changed
	FilesChanged int32 `json:"filesChanged"`
	// The number of lines added
	LinesAdded int32 `json:"linesAdded"`
	// The number of lines deleted
	LinesDeleted int32 `json:"linesDeleted"`
	// The pull request URL
	Url string `json:"url"`
	Deployments *DeploymentCollectionRep `json:"deployments,omitempty"`
	FlagReferences *FlagReferenceCollectionRep `json:"flagReferences,omitempty"`
	LeadTime *PullRequestLeadTimeRep `json:"leadTime,omitempty"`
}
...
func (o *PullRequestRep) GetMergeCommitKey() string {
	if o == nil || o.MergeCommitKey == nil {
		var ret string
		return ret
	}
	return *o.MergeCommitKey
}

// GetMergeCommitKeyOk returns a tuple with the MergeCommitKey field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PullRequestRep) GetMergeCommitKeyOk() (*string, bool) {
	if o == nil || o.MergeCommitKey == nil {
		return nil, false
	}
	return o.MergeCommitKey, true
}
...
func (o *PullRequestRep) GetBaseCommitKey() string {
	...
	return o.BaseCommitKey
}

// GetBaseCommitKeyOk returns a tuple with the BaseCommitKey field value
// and a boolean to check if the value has been set.
func (o *PullRequestRep) GetBaseCommitKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.BaseCommitKey, true
}
...
func (o *PullRequestRep) GetHeadCommitKey() string {
	...
	return o.HeadCommitKey
}

// GetHeadCommitKeyOk returns a tuple with the HeadCommitKey field value
// and a boolean to check if the value has been set.
func (o *PullRequestRep) GetHeadCommitKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.HeadCommitKey, true
}
...
func (o *PullRequestRep) GetDeployments() DeploymentCollectionRep {
	if o == nil || o.Deployments == nil {
		var ret DeploymentCollectionRep
		return ret
	}
...
func (o *PullRequestRep) GetLeadTime() PullRequestLeadTimeRep {
	if o == nil || o.LeadTime == nil {
		var ret PullRequestLeadTimeRep
		return ret
	}
	return *o.LeadTime
}
...
func (o PullRequestRep) MarshalJSON() ([]byte, error) {
	...
	if o.MergeTime != nil {
		toSerialize["mergeTime"] = o.MergeTime
	}
	if o.MergeCommitKey != nil {
		toSerialize["mergeCommitKey"] = o.MergeCommitKey
	}
	if true {
		toSerialize["baseCommitKey"] = o.BaseCommitKey
	}
	if true {
		toSerialize["headCommitKey"] = o.HeadCommitKey
	}
	if true {
		toSerialize["filesChanged"] = o.FilesChanged
	}
	if true {
...
func NewNullablePullRequestRep(val *PullRequestRep) *NullablePullRequestRep {
	return &NullablePullRequestRep{value: val, isSet: true}
}
