...
type LeadTimeStagesRep struct {
	...
	TotalLeadTimeMs *int64 `json:"totalLeadTimeMs,omitempty"`
}
...
func (o *LeadTimeStagesRep) GetDeployDurationMs() int64 {
	if o == nil || o.DeployDurationMs == nil {
		var ret int64
		return ret
	}
	return *o.DeployDurationMs
}

// GetDeployDurationMsOk returns a tuple with the DeployDurationMs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LeadTimeStagesRep) GetDeployDurationMsOk() (*int64, bool) {
	if o == nil || o.DeployDurationMs == nil {
		return nil, false
	}
	return o.DeployDurationMs, true
}
...
func (o *LeadTimeStagesRep) GetTotalLeadTimeMs() int64 {
	if o == nil || o.TotalLeadTimeMs == nil {
		var ret int64
		return ret
	}
	return *o.TotalLeadTimeMs
}

// GetTotalLeadTimeMsOk returns a tuple with the TotalLeadTimeMs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LeadTimeStagesRep) GetTotalLeadTimeMsOk() (*int64, bool) {
	if o == nil || o.TotalLeadTimeMs == nil {
		return nil, false
	}
	return o.TotalLeadTimeMs, true
}
...
func (o LeadTimeStagesRep) MarshalJSON() ([]byte, error) {
	...
	if o.WaitDurationMs != nil {
		toSerialize["waitDurationMs"] = o.WaitDurationMs
	}
	if o.DeployDurationMs != nil {
		toSerialize["deployDurationMs"] = o.DeployDurationMs
	}
	if o.TotalLeadTimeMs != nil {
		toSerialize["totalLeadTimeMs"] = o.TotalLeadTimeMs
	}
	return json.Marshal(toSerialize)
}

type NullableLeadTimeStagesRep struct {
	value *LeadTimeStagesRep
	isSet bool
}
...
func NewNullableLeadTimeStagesRep(val *LeadTimeStagesRep) *NullableLeadTimeStagesRep {
	return &NullableLeadTimeStagesRep{value: val, isSet: true}
}
