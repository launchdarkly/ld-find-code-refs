...
type InsightsChartSeriesMetadata struct {
	// Name of the series
	Name string `json:"name"`
	// Aggregate count of the series values
	Count *int64 `json:"count,omitempty"`
	// Bounds for the series data
	Bounds []InsightsChartBounds `json:"bounds,omitempty"`
}
...
func NewInsightsChartSeriesMetadata(name string) *InsightsChartSeriesMetadata {
	this := InsightsChartSeriesMetadata{}
	this.Name = name
	return &this
}
...
func NewNullableInsightsChartSeriesMetadata(val *InsightsChartSeriesMetadata) *NullableInsightsChartSeriesMetadata {
	return &NullableInsightsChartSeriesMetadata{value: val, isSet: true}
}
