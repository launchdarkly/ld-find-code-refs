...
type PullRequestCollectionRep struct {
	// The total number of pull requests
	TotalCount int32 `json:"totalCount"`
	// A list of pull requests
	Items []PullRequestRep `json:"items"`
...
type NullablePullRequestCollectionRep struct {
	value *PullRequestCollectionRep
	isSet bool
}
...
func NewNullablePullRequestCollectionRep(val *PullRequestCollectionRep) *NullablePullRequestCollectionRep {
	return &NullablePullRequestCollectionRep{value: val, isSet: true}
}
