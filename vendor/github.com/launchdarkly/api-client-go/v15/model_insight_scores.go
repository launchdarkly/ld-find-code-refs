...
type InsightScores struct {
	...
	LastPeriod InsightPeriod `json:"lastPeriod"`
	Scores InsightGroupScores `json:"scores"`
...
// GetLastPeriodOk returns a tuple with the LastPeriod field value
// and a boolean to check if the value has been set.
...
func NewNullableInsightScores(val *InsightScores) *NullableInsightScores {
	return &NullableInsightScores{value: val, isSet: true}
}
