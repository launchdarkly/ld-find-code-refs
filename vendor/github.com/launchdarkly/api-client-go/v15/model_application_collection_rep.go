...
type ApplicationCollectionRep struct {
	// The location and content type of related resources
	Links *map[string]Link `json:"_links,omitempty"`
	// A list of applications
	Items []ApplicationRep `json:"items,omitempty"`
...
type NullableApplicationCollectionRep struct {
	value *ApplicationCollectionRep
	isSet bool
}
...
func NewNullableApplicationCollectionRep(val *ApplicationCollectionRep) *NullableApplicationCollectionRep {
	return &NullableApplicationCollectionRep{value: val, isSet: true}
}
