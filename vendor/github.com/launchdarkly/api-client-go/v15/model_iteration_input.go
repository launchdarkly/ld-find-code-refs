...
type IterationInput struct {
	...
	PrimarySingleMetricKey *string `json:"primarySingleMetricKey,omitempty"`
	...
	PrimaryFunnelKey *string `json:"primaryFunnelKey,omitempty"`
...
func (o *IterationInput) GetPrimarySingleMetricKey() string {
	if o == nil || o.PrimarySingleMetricKey == nil {
		var ret string
		return ret
	}
	return *o.PrimarySingleMetricKey
}

// GetPrimarySingleMetricKeyOk returns a tuple with the PrimarySingleMetricKey field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IterationInput) GetPrimarySingleMetricKeyOk() (*string, bool) {
	if o == nil || o.PrimarySingleMetricKey == nil {
		return nil, false
	}
	return o.PrimarySingleMetricKey, true
}
...
func (o *IterationInput) GetPrimaryFunnelKey() string {
	if o == nil || o.PrimaryFunnelKey == nil {
		var ret string
		return ret
	}
	return *o.PrimaryFunnelKey
}

// GetPrimaryFunnelKeyOk returns a tuple with the PrimaryFunnelKey field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IterationInput) GetPrimaryFunnelKeyOk() (*string, bool) {
	if o == nil || o.PrimaryFunnelKey == nil {
		return nil, false
	}
	return o.PrimaryFunnelKey, true
}
...
// GetTreatmentsOk returns a tuple with the Treatments field value
// and a boolean to check if the value has been set.
...
func (o IterationInput) MarshalJSON() ([]byte, error) {
	...
	if o.PrimarySingleMetricKey != nil {
		toSerialize["primarySingleMetricKey"] = o.PrimarySingleMetricKey
	}
	if o.PrimaryFunnelKey != nil {
		toSerialize["primaryFunnelKey"] = o.PrimaryFunnelKey
	}
	if true {
...
func NewNullableIterationInput(val *IterationInput) *NullableIterationInput {
	return &NullableIterationInput{value: val, isSet: true}
}
