...
type FlagEventRep struct {
	...
	AuditLogEntryId *string `json:"auditLogEntryId,omitempty"`
	Member *FlagEventMemberRep `json:"member,omitempty"`
	// The resource actions
	Actions []string `json:"actions,omitempty"`
	Impact FlagEventImpactRep `json:"impact"`
	Experiments *FlagEventExperimentCollection `json:"experiments,omitempty"`
}
...
func (o *FlagEventRep) GetAuditLogEntryId() string {
	if o == nil || o.AuditLogEntryId == nil {
		var ret string
		return ret
	}
	return *o.AuditLogEntryId
}

// GetAuditLogEntryIdOk returns a tuple with the AuditLogEntryId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FlagEventRep) GetAuditLogEntryIdOk() (*string, bool) {
	if o == nil || o.AuditLogEntryId == nil {
		return nil, false
	}
	return o.AuditLogEntryId, true
}
...
func (o *FlagEventRep) GetExperiments() FlagEventExperimentCollection {
	if o == nil || o.Experiments == nil {
		var ret FlagEventExperimentCollection
		return ret
	}
...
func (o FlagEventRep) MarshalJSON() ([]byte, error) {
	...
	if o.AuditLogEntryId != nil {
		toSerialize["auditLogEntryId"] = o.AuditLogEntryId
	}
	if o.Member != nil {
...
func NewNullableFlagEventRep(val *FlagEventRep) *NullableFlagEventRep {
	return &NullableFlagEventRep{value: val, isSet: true}
}
