...
type FlagReferenceRep struct {
	// The project key
	ProjectKey string `json:"projectKey"`
	// The flag key
	FlagKey string `json:"flagKey"`
	// The number of references added
	ReferencesAdded int32 `json:"referencesAdded"`
	// The number of references removed
	ReferencesRemoved int32 `json:"referencesRemoved"`
}
...
func (o *FlagReferenceRep) GetReferencesAdded() int32 {
	...
	return o.ReferencesAdded
}

// GetReferencesAddedOk returns a tuple with the ReferencesAdded field value
// and a boolean to check if the value has been set.
func (o *FlagReferenceRep) GetReferencesAddedOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ReferencesAdded, true
}
...
func (o *FlagReferenceRep) GetReferencesRemoved() int32 {
	...
	return o.ReferencesRemoved
}

// GetReferencesRemovedOk returns a tuple with the ReferencesRemoved field value
// and a boolean to check if the value has been set.
func (o *FlagReferenceRep) GetReferencesRemovedOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ReferencesRemoved, true
}

// SetReferencesRemoved sets field value
func (o *FlagReferenceRep) SetReferencesRemoved(v int32) {
	o.ReferencesRemoved = v
}
...
func (o FlagReferenceRep) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["referencesAdded"] = o.ReferencesAdded
	}
	if true {
		toSerialize["referencesRemoved"] = o.ReferencesRemoved
	}
	return json.Marshal(toSerialize)
}

type NullableFlagReferenceRep struct {
	value *FlagReferenceRep
	isSet bool
}
...
func NewNullableFlagReferenceRep(val *FlagReferenceRep) *NullableFlagReferenceRep {
	return &NullableFlagReferenceRep{value: val, isSet: true}
}
