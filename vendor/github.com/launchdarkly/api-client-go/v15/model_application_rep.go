...
type ApplicationRep struct {
	Flags *ApplicationFlagCollectionRep `json:"flags,omitempty"`
	...
	Maintainer *MaintainerRep `json:"_maintainer,omitempty"`
...
func (o *ApplicationRep) GetFlags() ApplicationFlagCollectionRep {
	if o == nil || o.Flags == nil {
		var ret ApplicationFlagCollectionRep
		return ret
	}
	return *o.Flags
}
...
// GetAutoAddedOk returns a tuple with the AutoAdded field value
// and a boolean to check if the value has been set.
func (o *ApplicationRep) GetAutoAddedOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.AutoAdded, true
}
...
func (o ApplicationRep) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["autoAdded"] = o.AutoAdded
	}
...
func NewNullableApplicationRep(val *ApplicationRep) *NullableApplicationRep {
	return &NullableApplicationRep{value: val, isSet: true}
}
