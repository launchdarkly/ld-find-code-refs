...
// GetRfc3339Ok returns a tuple with the Rfc3339 field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TimestampRep) GetRfc3339Ok() (*string, bool) {
	if o == nil || o.Rfc3339 == nil {
		return nil, false
	}
	return o.Rfc3339, true
}
...
func NewNullableTimestampRep(val *TimestampRep) *NullableTimestampRep {
	return &NullableTimestampRep{value: val, isSet: true}
}
