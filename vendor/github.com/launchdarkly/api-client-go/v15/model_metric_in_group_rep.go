...
type MetricInGroupRep struct {
	...
	NameInGroup *string `json:"nameInGroup,omitempty"`
...
func (o *MetricInGroupRep) GetNameInGroup() string {
	if o == nil || o.NameInGroup == nil {
		var ret string
		return ret
	}
	return *o.NameInGroup
}

// GetNameInGroupOk returns a tuple with the NameInGroup field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MetricInGroupRep) GetNameInGroupOk() (*string, bool) {
	if o == nil || o.NameInGroup == nil {
		return nil, false
	}
	return o.NameInGroup, true
}
...
func (o MetricInGroupRep) MarshalJSON() ([]byte, error) {
	...
	if o.NameInGroup != nil {
		toSerialize["nameInGroup"] = o.NameInGroup
	}
...
func NewNullableMetricInGroupRep(val *MetricInGroupRep) *NullableMetricInGroupRep {
	return &NullableMetricInGroupRep{value: val, isSet: true}
}
