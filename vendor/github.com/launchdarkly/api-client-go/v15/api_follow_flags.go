...
func (r ApiDeleteFlagFollowersRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteFlagFollowersExecute(r)
}
...
func (a *FollowFlagsApiService) DeleteFlagFollowersExecute(r ApiDeleteFlagFollowersRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FollowFlagsApiService.DeleteFlagFollowers")
	if err != nil {
...
func (r ApiPutFlagFollowersRequest) Execute() (*http.Response, error) {
	return r.ApiService.PutFlagFollowersExecute(r)
}
...
func (a *FollowFlagsApiService) PutFlagFollowersExecute(r ApiPutFlagFollowersRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FollowFlagsApiService.PutFlagFollowers")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
