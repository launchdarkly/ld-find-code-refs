...
type DependentMetricGroupRep struct {
...
func NewNullableDependentMetricGroupRep(val *DependentMetricGroupRep) *NullableDependentMetricGroupRep {
	return &NullableDependentMetricGroupRep{value: val, isSet: true}
}
