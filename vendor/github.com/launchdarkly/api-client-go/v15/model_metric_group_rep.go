...
type MetricGroupRep struct {
	...
	LastModified int64 `json:"_lastModified"`
	Maintainer MaintainerRep `json:"maintainer"`
	// An ordered list of the metrics in this metric group
	Metrics []MetricInGroupRep `json:"metrics"`
...
func (o MetricGroupRep) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["_lastModified"] = o.LastModified
	}
	if true {
...
func NewNullableMetricGroupRep(val *MetricGroupRep) *NullableMetricGroupRep {
	return &NullableMetricGroupRep{value: val, isSet: true}
}
