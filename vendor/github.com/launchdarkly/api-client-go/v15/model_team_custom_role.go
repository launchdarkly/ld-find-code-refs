...
// GetAppliedOnOk returns a tuple with the AppliedOn field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
func NewNullableTeamCustomRole(val *TeamCustomRole) *NullableTeamCustomRole {
	return &NullableTeamCustomRole{value: val, isSet: true}
}
