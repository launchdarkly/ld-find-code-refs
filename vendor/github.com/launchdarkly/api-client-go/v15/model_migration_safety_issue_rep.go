...
type MigrationSafetyIssueRep struct {
	// The ID of the rule which caused this issue
	CausingRuleId *string `json:"causingRuleId,omitempty"`
	...
	AffectedRuleIds []string `json:"affectedRuleIds,omitempty"`
	...
	OldSystemAffected *bool `json:"oldSystemAffected,omitempty"`
}
...
func (o *MigrationSafetyIssueRep) GetCausingRuleId() string {
	if o == nil || o.CausingRuleId == nil {
		var ret string
		return ret
	}
	return *o.CausingRuleId
}

// GetCausingRuleIdOk returns a tuple with the CausingRuleId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MigrationSafetyIssueRep) GetCausingRuleIdOk() (*string, bool) {
	if o == nil || o.CausingRuleId == nil {
		return nil, false
	}
	return o.CausingRuleId, true
}
...
func (o *MigrationSafetyIssueRep) GetAffectedRuleIds() []string {
	if o == nil || o.AffectedRuleIds == nil {
		var ret []string
		return ret
	}
	return o.AffectedRuleIds
}

// GetAffectedRuleIdsOk returns a tuple with the AffectedRuleIds field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MigrationSafetyIssueRep) GetAffectedRuleIdsOk() ([]string, bool) {
	if o == nil || o.AffectedRuleIds == nil {
		return nil, false
	}
	return o.AffectedRuleIds, true
}
...
func (o *MigrationSafetyIssueRep) GetOldSystemAffected() bool {
	if o == nil || o.OldSystemAffected == nil {
		var ret bool
		return ret
	}
	return *o.OldSystemAffected
}

// GetOldSystemAffectedOk returns a tuple with the OldSystemAffected field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MigrationSafetyIssueRep) GetOldSystemAffectedOk() (*bool, bool) {
	if o == nil || o.OldSystemAffected == nil {
		return nil, false
	}
	return o.OldSystemAffected, true
}
...
func (o *MigrationSafetyIssueRep) SetOldSystemAffected(v bool) {
	o.OldSystemAffected = &v
}

func (o MigrationSafetyIssueRep) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.CausingRuleId != nil {
		toSerialize["causingRuleId"] = o.CausingRuleId
	}
	if o.AffectedRuleIds != nil {
		toSerialize["affectedRuleIds"] = o.AffectedRuleIds
	}
	if o.Issue != nil {
		toSerialize["issue"] = o.Issue
	}
	if o.OldSystemAffected != nil {
		toSerialize["oldSystemAffected"] = o.OldSystemAffected
	}
	return json.Marshal(toSerialize)
}

type NullableMigrationSafetyIssueRep struct {
	value *MigrationSafetyIssueRep
	isSet bool
}
...
func NewNullableMigrationSafetyIssueRep(val *MigrationSafetyIssueRep) *NullableMigrationSafetyIssueRep {
	return &NullableMigrationSafetyIssueRep{value: val, isSet: true}
}
