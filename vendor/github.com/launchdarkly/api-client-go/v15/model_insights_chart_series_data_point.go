...
type InsightsChartSeriesDataPoint struct {
	// X-axis value
	X int64 `json:"x"`
	// Y-axis value
	Y int64 `json:"y"`
...
func NewInsightsChartSeriesDataPoint(x int64, y int64) *InsightsChartSeriesDataPoint {
	this := InsightsChartSeriesDataPoint{}
	this.X = x
	this.Y = y
	return &this
}
...
type NullableInsightsChartSeriesDataPoint struct {
	value *InsightsChartSeriesDataPoint
	isSet bool
}
...
func NewNullableInsightsChartSeriesDataPoint(val *InsightsChartSeriesDataPoint) *NullableInsightsChartSeriesDataPoint {
	return &NullableInsightsChartSeriesDataPoint{value: val, isSet: true}
}
