...
// GetSelOk returns a tuple with the Sel field value
// and a boolean to check if the value has been set.
...
func (o *FeatureFlagConfig) GetContextTargets() []Target {
	if o == nil || o.ContextTargets == nil {
		var ret []Target
		return ret
	}
	return o.ContextTargets
}

// GetContextTargetsOk returns a tuple with the ContextTargets field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FeatureFlagConfig) GetContextTargetsOk() ([]Target, bool) {
	if o == nil || o.ContextTargets == nil {
		return nil, false
	}
	return o.ContextTargets, true
}
...
// GetTrackEventsOk returns a tuple with the TrackEvents field value
// and a boolean to check if the value has been set.
...
// GetTrackEventsFallthroughOk returns a tuple with the TrackEventsFallthrough field value
// and a boolean to check if the value has been set.
...
func (o *FeatureFlagConfig) GetMigrationSettings() FlagConfigMigrationSettingsRep {
	if o == nil || o.MigrationSettings == nil {
		var ret FlagConfigMigrationSettingsRep
		return ret
	}
...
func (o FeatureFlagConfig) MarshalJSON() ([]byte, error) {
	...
	if o.ContextTargets != nil {
		toSerialize["contextTargets"] = o.ContextTargets
	}
	if o.Rules != nil {
