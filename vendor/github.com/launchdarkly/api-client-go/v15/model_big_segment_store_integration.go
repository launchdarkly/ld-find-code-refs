...
type BigSegmentStoreIntegration struct {
	Links BigSegmentStoreIntegrationLinks `json:"_links"`
	// The integration ID
	Id string `json:"_id"`
	// The integration key
	...
	Status BigSegmentStoreStatus `json:"_status"`
}
...
func (o *BigSegmentStoreIntegration) GetLinks() BigSegmentStoreIntegrationLinks {
	if o == nil {
		var ret BigSegmentStoreIntegrationLinks
		return ret
	}
...
type NullableBigSegmentStoreIntegration struct {
	value *BigSegmentStoreIntegration
	isSet bool
}
...
func NewNullableBigSegmentStoreIntegration(val *BigSegmentStoreIntegration) *NullableBigSegmentStoreIntegration {
	return &NullableBigSegmentStoreIntegration{value: val, isSet: true}
}
