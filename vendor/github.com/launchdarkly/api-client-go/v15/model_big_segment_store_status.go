...
type BigSegmentStoreStatus struct {
	...
	PotentiallyStale *bool `json:"potentiallyStale,omitempty"`
	LastSync *int64 `json:"lastSync,omitempty"`
	LastError *int64 `json:"lastError,omitempty"`
	Errors []StoreIntegrationError `json:"errors,omitempty"`
}
...
func (o *BigSegmentStoreStatus) GetPotentiallyStale() bool {
	if o == nil || o.PotentiallyStale == nil {
		var ret bool
		return ret
	}
	return *o.PotentiallyStale
}

// GetPotentiallyStaleOk returns a tuple with the PotentiallyStale field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BigSegmentStoreStatus) GetPotentiallyStaleOk() (*bool, bool) {
	if o == nil || o.PotentiallyStale == nil {
		return nil, false
	}
	return o.PotentiallyStale, true
}
...
func (o BigSegmentStoreStatus) MarshalJSON() ([]byte, error) {
	...
	if o.PotentiallyStale != nil {
		toSerialize["potentiallyStale"] = o.PotentiallyStale
	}
	if o.LastSync != nil {
...
func NewNullableBigSegmentStoreStatus(val *BigSegmentStoreStatus) *NullableBigSegmentStoreStatus {
	return &NullableBigSegmentStoreStatus{value: val, isSet: true}
}
