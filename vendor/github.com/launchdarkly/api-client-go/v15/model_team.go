...
// GetIdpSyncedOk returns a tuple with the IdpSynced field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Team) GetIdpSyncedOk() (*bool, bool) {
	if o == nil || o.IdpSynced == nil {
		return nil, false
	}
	return o.IdpSynced, true
}
...
func (o Team) MarshalJSON() ([]byte, error) {
	...
	if o.IdpSynced != nil {
		toSerialize["_idpSynced"] = o.IdpSynced
	}
	if o.Roles != nil {
