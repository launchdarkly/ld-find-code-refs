...
type ExpiringTargetPatchResponse struct {
	// A list of the results from each instruction
	Items []ExpiringTarget `json:"items"`
...
func NewExpiringTargetPatchResponse(items []ExpiringTarget) *ExpiringTargetPatchResponse {
	this := ExpiringTargetPatchResponse{}
	this.Items = items
	return &this
}
...
type NullableExpiringTargetPatchResponse struct {
	value *ExpiringTargetPatchResponse
	isSet bool
}
...
func NewNullableExpiringTargetPatchResponse(val *ExpiringTargetPatchResponse) *NullableExpiringTargetPatchResponse {
	return &NullableExpiringTargetPatchResponse{value: val, isSet: true}
}
