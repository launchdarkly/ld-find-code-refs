...
type ApplicationFlagCollectionRep struct {
	// A list of the flags that have been evaluated by the application
	Items []FlagListingRep `json:"items,omitempty"`
...
func NewApplicationFlagCollectionRep() *ApplicationFlagCollectionRep {
	this := ApplicationFlagCollectionRep{}
	return &this
}
...
type NullableApplicationFlagCollectionRep struct {
	value *ApplicationFlagCollectionRep
	isSet bool
}
...
func NewNullableApplicationFlagCollectionRep(val *ApplicationFlagCollectionRep) *NullableApplicationFlagCollectionRep {
	return &NullableApplicationFlagCollectionRep{value: val, isSet: true}
}
