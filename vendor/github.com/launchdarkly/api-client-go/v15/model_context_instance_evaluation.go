...
type ContextInstanceEvaluation struct {
	// Name of the flag.
	...
	Reason *ContextInstanceEvaluationReason `json:"reason,omitempty"`
...
func NewContextInstanceEvaluation(name string, key string, value interface{}, links map[string]Link) *ContextInstanceEvaluation {
	this := ContextInstanceEvaluation{}
	this.Name = name
	this.Key = key
	this.Value = value
	this.Links = links
...
func (o *ContextInstanceEvaluation) GetReason() ContextInstanceEvaluationReason {
	if o == nil || o.Reason == nil {
		var ret ContextInstanceEvaluationReason
		return ret
	}
	return *o.Reason
}
...
type NullableContextInstanceEvaluation struct {
	value *ContextInstanceEvaluation
	isSet bool
}
...
func NewNullableContextInstanceEvaluation(val *ContextInstanceEvaluation) *NullableContextInstanceEvaluation {
	return &NullableContextInstanceEvaluation{value: val, isSet: true}
}
