...
func (o *VersionsRep) GetValidVersions() []int32 {
	...
	return o.ValidVersions
}

// GetValidVersionsOk returns a tuple with the ValidVersions field value
// and a boolean to check if the value has been set.
func (o *VersionsRep) GetValidVersionsOk() ([]int32, bool) {
	if o == nil {
		return nil, false
	}
	return o.ValidVersions, true
}
...
func (o VersionsRep) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["validVersions"] = o.ValidVersions
	}
	if true {
...
func NewNullableVersionsRep(val *VersionsRep) *NullableVersionsRep {
	return &NullableVersionsRep{value: val, isSet: true}
}
