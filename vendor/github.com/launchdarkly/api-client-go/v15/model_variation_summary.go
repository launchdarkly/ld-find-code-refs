...
type VariationSummary struct {
	...
	ContextTargets int32 `json:"contextTargets"`
...
// GetNullRulesOk returns a tuple with the NullRules field value
// and a boolean to check if the value has been set.
...
// GetContextTargetsOk returns a tuple with the ContextTargets field value
// and a boolean to check if the value has been set.
