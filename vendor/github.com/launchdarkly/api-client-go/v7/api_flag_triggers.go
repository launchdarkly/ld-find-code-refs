...
func (a *FlagTriggersApiService) CreateTriggerWorkflowExecute(r ApiCreateTriggerWorkflowRequest) (TriggerWorkflowRep, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/flags/{projKey}/{flagKey}/triggers/{envKey}"
...
func (r ApiDeleteTriggerWorkflowRequest) Execute() (*_nethttp.Response, error) {
...
func (a *FlagTriggersApiService) DeleteTriggerWorkflowExecute(r ApiDeleteTriggerWorkflowRequest) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/flags/{projKey}/{flagKey}/triggers/{envKey}/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"projKey"+"}", _neturl.PathEscape(parameterToString(r.projKey, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"envKey"+"}", _neturl.PathEscape(parameterToString(r.envKey, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"flagKey"+"}", _neturl.PathEscape(parameterToString(r.flagKey, "")), -1)
