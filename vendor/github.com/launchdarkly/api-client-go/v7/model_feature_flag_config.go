...
// GetFallthroughOk returns a tuple with the Fallthrough field value
// and a boolean to check if the value has been set.
...
// GetPrerequisitesOk returns a tuple with the Prerequisites field value
// and a boolean to check if the value has been set.
