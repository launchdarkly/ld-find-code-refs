...
func NewNullableConditionOutputRep(val *ConditionOutputRep) *NullableConditionOutputRep {
	return &NullableConditionOutputRep{value: val, isSet: true}
}
