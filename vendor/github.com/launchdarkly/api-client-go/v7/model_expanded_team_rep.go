...
func (o *ExpandedTeamRep) GetTeamMaintainers() []MemberSummaryRep {
	if o == nil || o.TeamMaintainers == nil {
		var ret []MemberSummaryRep
		return ret
	}
	return *o.TeamMaintainers
}

// GetTeamMaintainersOk returns a tuple with the TeamMaintainers field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ExpandedTeamRep) GetTeamMaintainersOk() (*[]MemberSummaryRep, bool) {
	if o == nil || o.TeamMaintainers == nil {
		return nil, false
	}
	return o.TeamMaintainers, true
}
...
func (o *ExpandedTeamRep) GetProjectKeys() []string {
	if o == nil || o.ProjectKeys == nil {
		var ret []string
		return ret
	}
	return *o.ProjectKeys
}

// GetProjectKeysOk returns a tuple with the ProjectKeys field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ExpandedTeamRep) GetProjectKeysOk() (*[]string, bool) {
	if o == nil || o.ProjectKeys == nil {
		return nil, false
	}
	return o.ProjectKeys, true
}
...
func (o ExpandedTeamRep) MarshalJSON() ([]byte, error) {
	...
	if o.TeamMaintainers != nil {
		toSerialize["teamMaintainers"] = o.TeamMaintainers
	}
	...
	if o.ProjectKeys != nil {
		toSerialize["projectKeys"] = o.ProjectKeys
	}
	if o.Access != nil {
	...
	if o.UpdatedAt != nil {
		toSerialize["_updatedAt"] = o.UpdatedAt
	}
	if o.Version != nil {
...
func NewNullableExpandedTeamRep(val *ExpandedTeamRep) *NullableExpandedTeamRep {
	return &NullableExpandedTeamRep{value: val, isSet: true}
}
