...
func (a *TeamsBetaApiService) DeleteTeamExecute(r ApiDeleteTeamRequest) (*_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TeamsBetaApiService.DeleteTeam")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/teams/{key}"
...
func (a *TeamsBetaApiService) GetTeamsExecute(r ApiGetTeamsRequest) (TeamCollectionRep, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TeamsBetaApiService.GetTeams")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (a *TeamsBetaApiService) PostTeamExecute(r ApiPostTeamRequest) (TeamRep, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TeamsBetaApiService.PostTeam")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
