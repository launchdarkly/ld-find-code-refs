...
func (a *WorkflowsBetaApiService) DeleteWorkflowExecute(r ApiDeleteWorkflowRequest) (*_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsBetaApiService.DeleteWorkflow")
	if err != nil {
...
func (a *WorkflowsBetaApiService) GetCustomWorkflowExecute(r ApiGetCustomWorkflowRequest) (CustomWorkflowOutputRep, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  CustomWorkflowOutputRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsBetaApiService.GetCustomWorkflow")
	if err != nil {
...
func (a *WorkflowsBetaApiService) GetWorkflowsExecute(r ApiGetWorkflowsRequest) (CustomWorkflowsListingOutputRep, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  CustomWorkflowsListingOutputRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsBetaApiService.GetWorkflows")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiPostWorkflowRequest) CustomWorkflowInputRep(customWorkflowInputRep CustomWorkflowInputRep) ApiPostWorkflowRequest {
	r.customWorkflowInputRep = &customWorkflowInputRep
	return r
}
...
func (a *WorkflowsBetaApiService) PostWorkflowExecute(r ApiPostWorkflowRequest) (CustomWorkflowOutputRep, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowsBetaApiService.PostWorkflow")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if r.customWorkflowInputRep == nil {
		return localVarReturnValue, nil, reportError("customWorkflowInputRep is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.customWorkflowInputRep
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
