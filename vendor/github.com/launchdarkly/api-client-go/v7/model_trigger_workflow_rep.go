...
func (o *TriggerWorkflowRep) GetRecentTriggerBodies() []RecentTriggerBody {
	if o == nil || o.RecentTriggerBodies == nil {
		var ret []RecentTriggerBody
		return ret
	}
	return *o.RecentTriggerBodies
}

// GetRecentTriggerBodiesOk returns a tuple with the RecentTriggerBodies field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TriggerWorkflowRep) GetRecentTriggerBodiesOk() (*[]RecentTriggerBody, bool) {
	if o == nil || o.RecentTriggerBodies == nil {
		return nil, false
	}
	return o.RecentTriggerBodies, true
}
...
func (o TriggerWorkflowRep) MarshalJSON() ([]byte, error) {
	...
	if o.LastTriggeredAt != nil {
		toSerialize["_lastTriggeredAt"] = o.LastTriggeredAt
	}
	if o.RecentTriggerBodies != nil {
		toSerialize["_recentTriggerBodies"] = o.RecentTriggerBodies
	}
	if o.TriggerCount != nil {
		toSerialize["_triggerCount"] = o.TriggerCount
	}
	if o.TriggerURL != nil {
		toSerialize["triggerURL"] = o.TriggerURL
	}
	if o.Links != nil {
...
func NewNullableTriggerWorkflowRep(val *TriggerWorkflowRep) *NullableTriggerWorkflowRep {
	return &NullableTriggerWorkflowRep{value: val, isSet: true}
}
