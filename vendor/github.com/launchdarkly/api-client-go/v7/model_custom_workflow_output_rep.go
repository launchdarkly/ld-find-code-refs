...
func NewNullableCustomWorkflowOutputRep(val *CustomWorkflowOutputRep) *NullableCustomWorkflowOutputRep {
	return &NullableCustomWorkflowOutputRep{value: val, isSet: true}
}
