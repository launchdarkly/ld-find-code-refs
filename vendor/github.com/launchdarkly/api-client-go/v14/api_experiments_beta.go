...
func (r ApiGetExperimentationSettingsRequest) Execute() (*ExperimentationSettingsRep, *http.Response, error) {
...
func (a *ExperimentsBetaApiService) GetExperimentationSettingsExecute(r ApiGetExperimentationSettingsRequest) (*ExperimentationSettingsRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ExperimentationSettingsRep
	)
...
func (r ApiPutExperimentationSettingsRequest) ExperimentationSettingsPut(experimentationSettingsPut ExperimentationSettingsPut) ApiPutExperimentationSettingsRequest {
	r.experimentationSettingsPut = &experimentationSettingsPut
	return r
}

func (r ApiPutExperimentationSettingsRequest) Execute() (*ExperimentationSettingsRep, *http.Response, error) {
...
// Execute executes the request
//  @return ExperimentationSettingsRep
func (a *ExperimentsBetaApiService) PutExperimentationSettingsExecute(r ApiPutExperimentationSettingsRequest) (*ExperimentationSettingsRep, *http.Response, error) {
	var (
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.experimentationSettingsPut == nil {
		return localVarReturnValue, nil, reportError("experimentationSettingsPut is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.experimentationSettingsPut
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
...
func (a *ExperimentsBetaApiService) ResetExperimentExecute(r ApiResetExperimentRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExperimentsBetaApiService.ResetExperiment")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/flags/{projectKey}/{featureFlagKey}/experiments/{environmentKey}/{metricKey}/results"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterToString(r.projectKey, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagKey"+"}", url.PathEscape(parameterToString(r.featureFlagKey, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", url.PathEscape(parameterToString(r.environmentKey, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"metricKey"+"}", url.PathEscape(parameterToString(r.metricKey, "")), -1)
