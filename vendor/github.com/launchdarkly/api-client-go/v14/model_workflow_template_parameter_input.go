...
func NewWorkflowTemplateParameterInput() *WorkflowTemplateParameterInput {
	this := WorkflowTemplateParameterInput{}
	return &this
}
...
type NullableWorkflowTemplateParameterInput struct {
	value *WorkflowTemplateParameterInput
	isSet bool
}

func (v NullableWorkflowTemplateParameterInput) Get() *WorkflowTemplateParameterInput {
	return v.value
}

func (v *NullableWorkflowTemplateParameterInput) Set(val *WorkflowTemplateParameterInput) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkflowTemplateParameterInput) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkflowTemplateParameterInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkflowTemplateParameterInput(val *WorkflowTemplateParameterInput) *NullableWorkflowTemplateParameterInput {
	return &NullableWorkflowTemplateParameterInput{value: val, isSet: true}
}
