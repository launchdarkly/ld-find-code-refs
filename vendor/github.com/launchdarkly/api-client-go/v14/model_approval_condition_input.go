...
type NullableApprovalConditionInput struct {
	value *ApprovalConditionInput
	isSet bool
}

func (v NullableApprovalConditionInput) Get() *ApprovalConditionInput {
	return v.value
}

func (v *NullableApprovalConditionInput) Set(val *ApprovalConditionInput) {
	v.value = val
	v.isSet = true
}

func (v NullableApprovalConditionInput) IsSet() bool {
	return v.isSet
}
...
func NewNullableApprovalConditionInput(val *ApprovalConditionInput) *NullableApprovalConditionInput {
	return &NullableApprovalConditionInput{value: val, isSet: true}
}
