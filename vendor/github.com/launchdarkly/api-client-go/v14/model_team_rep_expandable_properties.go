...
func NewTeamRepExpandableProperties() *TeamRepExpandableProperties {
	this := TeamRepExpandableProperties{}
	return &this
}
...
type NullableTeamRepExpandableProperties struct {
	value *TeamRepExpandableProperties
	isSet bool
}

func (v NullableTeamRepExpandableProperties) Get() *TeamRepExpandableProperties {
	return v.value
}

func (v *NullableTeamRepExpandableProperties) Set(val *TeamRepExpandableProperties) {
	v.value = val
	v.isSet = true
}

func (v NullableTeamRepExpandableProperties) IsSet() bool {
	return v.isSet
}

func (v *NullableTeamRepExpandableProperties) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTeamRepExpandableProperties(val *TeamRepExpandableProperties) *NullableTeamRepExpandableProperties {
	return &NullableTeamRepExpandableProperties{value: val, isSet: true}
}
