...
type NullableApprovalConditionOutput struct {
	value *ApprovalConditionOutput
	isSet bool
}

func (v NullableApprovalConditionOutput) Get() *ApprovalConditionOutput {
	return v.value
}

func (v *NullableApprovalConditionOutput) Set(val *ApprovalConditionOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableApprovalConditionOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableApprovalConditionOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApprovalConditionOutput(val *ApprovalConditionOutput) *NullableApprovalConditionOutput {
	return &NullableApprovalConditionOutput{value: val, isSet: true}
}
