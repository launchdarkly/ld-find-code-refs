...
// CustomRoleSummary struct for CustomRoleSummary
...
func (o CustomRoleSummary) MarshalJSON() ([]byte, error) {
...
type NullableCustomRoleSummary struct {
	value *CustomRoleSummary
	isSet bool
}

func (v NullableCustomRoleSummary) Get() *CustomRoleSummary {
	return v.value
}

func (v *NullableCustomRoleSummary) Set(val *CustomRoleSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomRoleSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomRoleSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomRoleSummary(val *CustomRoleSummary) *NullableCustomRoleSummary {
	return &NullableCustomRoleSummary{value: val, isSet: true}
}

func (v NullableCustomRoleSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomRoleSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
