...
type FlagGlobalAttributesRep struct {
	...
	MaintainerTeam *MaintainerTeam `json:"_maintainerTeam,omitempty"`
...
func (o *FlagGlobalAttributesRep) GetClientSideAvailability() ClientSideAvailability {
	if o == nil || o.ClientSideAvailability == nil {
		var ret ClientSideAvailability
		return ret
	}
...
func (o *FlagGlobalAttributesRep) GetMaintainerTeam() MaintainerTeam {
	if o == nil || o.MaintainerTeam == nil {
		var ret MaintainerTeam
		return ret
	}
	return *o.MaintainerTeam
}

// GetMaintainerTeamOk returns a tuple with the MaintainerTeam field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FlagGlobalAttributesRep) GetMaintainerTeamOk() (*MaintainerTeam, bool) {
	if o == nil || o.MaintainerTeam == nil {
		return nil, false
	}
	return o.MaintainerTeam, true
}
...
func (o *FlagGlobalAttributesRep) GetPurpose() string {
...
// and a boolean to check if the value has been set.
func (o *FlagGlobalAttributesRep) GetPurposeOk() (*string, bool) {
	if o == nil || o.Purpose == nil {
		return nil, false
	}
...
func (o *FlagGlobalAttributesRep) HasPurpose() bool {
	if o != nil && o.Purpose != nil {
		return true
	}
...
func (o *FlagGlobalAttributesRep) SetPurpose(v string) {
	o.Purpose = &v
}

// GetMigrationSettings returns the MigrationSettings field value if set, zero value otherwise.
func (o *FlagGlobalAttributesRep) GetMigrationSettings() FlagMigrationSettingsRep {
	if o == nil || o.MigrationSettings == nil {
		var ret FlagMigrationSettingsRep
		return ret
	}
	return *o.MigrationSettings
}

// GetMigrationSettingsOk returns a tuple with the MigrationSettings field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FlagGlobalAttributesRep) GetMigrationSettingsOk() (*FlagMigrationSettingsRep, bool) {
	if o == nil || o.MigrationSettings == nil {
		return nil, false
	}
	return o.MigrationSettings, true
}
...
func (o *FlagGlobalAttributesRep) SetMigrationSettings(v FlagMigrationSettingsRep) {
...
func (o FlagGlobalAttributesRep) MarshalJSON() ([]byte, error) {
	...
	if o.MaintainerTeam != nil {
		toSerialize["_maintainerTeam"] = o.MaintainerTeam
	}
	if o.GoalIds != nil {
	...
	if o.Purpose != nil {
		toSerialize["_purpose"] = o.Purpose
	}
