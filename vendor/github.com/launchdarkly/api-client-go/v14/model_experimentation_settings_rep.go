...
// ExperimentationSettingsRep struct for ExperimentationSettingsRep
type ExperimentationSettingsRep struct {
	// The project ID
	ProjectId *string `json:"_projectId,omitempty"`
	// The project key
	ProjectKey *string `json:"_projectKey,omitempty"`
	// An array of the randomization units in this project
	RandomizationUnits []RandomizationUnitRep `json:"randomizationUnits,omitempty"`
...
func NewExperimentationSettingsRep() *ExperimentationSettingsRep {
	this := ExperimentationSettingsRep{}
	return &this
}
...
func (o ExperimentationSettingsRep) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.ProjectId != nil {
		toSerialize["_projectId"] = o.ProjectId
	}
	if o.ProjectKey != nil {
		toSerialize["_projectKey"] = o.ProjectKey
	}
...
type NullableExperimentationSettingsRep struct {
	value *ExperimentationSettingsRep
	isSet bool
}

func (v NullableExperimentationSettingsRep) Get() *ExperimentationSettingsRep {
	return v.value
}

func (v *NullableExperimentationSettingsRep) Set(val *ExperimentationSettingsRep) {
	v.value = val
	v.isSet = true
}

func (v NullableExperimentationSettingsRep) IsSet() bool {
	return v.isSet
}

func (v *NullableExperimentationSettingsRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExperimentationSettingsRep(val *ExperimentationSettingsRep) *NullableExperimentationSettingsRep {
	return &NullableExperimentationSettingsRep{value: val, isSet: true}
}

func (v NullableExperimentationSettingsRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExperimentationSettingsRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
