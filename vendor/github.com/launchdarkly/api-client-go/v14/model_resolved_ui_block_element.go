...
// GetIsBoldOk returns a tuple with the IsBold field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResolvedUIBlockElement) GetIsBoldOk() (*bool, bool) {
	if o == nil || o.IsBold == nil {
		return nil, false
	}
	return o.IsBold, true
}
...
func (o *ResolvedUIBlockElement) GetIsTimestamp() bool {
	if o == nil || o.IsTimestamp == nil {
		var ret bool
		return ret
	}
	return *o.IsTimestamp
}

// GetIsTimestampOk returns a tuple with the IsTimestamp field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResolvedUIBlockElement) GetIsTimestampOk() (*bool, bool) {
	if o == nil || o.IsTimestamp == nil {
		return nil, false
	}
	return o.IsTimestamp, true
}
...
func (o ResolvedUIBlockElement) MarshalJSON() ([]byte, error) {
	...
	if o.IsTimestamp != nil {
		toSerialize["isTimestamp"] = o.IsTimestamp
	}
	return json.Marshal(toSerialize)
}

type NullableResolvedUIBlockElement struct {
	value *ResolvedUIBlockElement
	isSet bool
}

func (v NullableResolvedUIBlockElement) Get() *ResolvedUIBlockElement {
	return v.value
}

func (v *NullableResolvedUIBlockElement) Set(val *ResolvedUIBlockElement) {
	v.value = val
	v.isSet = true
}

func (v NullableResolvedUIBlockElement) IsSet() bool {
	return v.isSet
}
...
func NewNullableResolvedUIBlockElement(val *ResolvedUIBlockElement) *NullableResolvedUIBlockElement {
	return &NullableResolvedUIBlockElement{value: val, isSet: true}
}
