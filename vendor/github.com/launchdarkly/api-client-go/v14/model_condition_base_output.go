...
type NullableConditionBaseOutput struct {
	value *ConditionBaseOutput
	isSet bool
}

func (v NullableConditionBaseOutput) Get() *ConditionBaseOutput {
	return v.value
}

func (v *NullableConditionBaseOutput) Set(val *ConditionBaseOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableConditionBaseOutput) IsSet() bool {
	return v.isSet
}
...
func NewNullableConditionBaseOutput(val *ConditionBaseOutput) *NullableConditionBaseOutput {
	return &NullableConditionBaseOutput{value: val, isSet: true}
}
