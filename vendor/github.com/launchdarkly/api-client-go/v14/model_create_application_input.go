...
// CreateApplicationInput struct for CreateApplicationInput
type CreateApplicationInput struct {
	...
	Maintainer *MaintainerInput `json:"maintainer,omitempty"`
...
// SetMaintainer gets a reference to the given MaintainerInput and assigns it to the Maintainer field.
...
func (o CreateApplicationInput) MarshalJSON() ([]byte, error) {
...
type NullableCreateApplicationInput struct {
	value *CreateApplicationInput
	isSet bool
}

func (v NullableCreateApplicationInput) Get() *CreateApplicationInput {
	return v.value
}

func (v *NullableCreateApplicationInput) Set(val *CreateApplicationInput) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateApplicationInput) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateApplicationInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateApplicationInput(val *CreateApplicationInput) *NullableCreateApplicationInput {
	return &NullableCreateApplicationInput{value: val, isSet: true}
}

func (v NullableCreateApplicationInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateApplicationInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
