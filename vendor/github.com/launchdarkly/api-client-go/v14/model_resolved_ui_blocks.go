...
type NullableResolvedUIBlocks struct {
	value *ResolvedUIBlocks
	isSet bool
}

func (v NullableResolvedUIBlocks) Get() *ResolvedUIBlocks {
	return v.value
}

func (v *NullableResolvedUIBlocks) Set(val *ResolvedUIBlocks) {
	v.value = val
	v.isSet = true
}
...
func NewNullableResolvedUIBlocks(val *ResolvedUIBlocks) *NullableResolvedUIBlocks {
	return &NullableResolvedUIBlocks{value: val, isSet: true}
}
