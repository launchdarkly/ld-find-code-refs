...
// ContextKind struct for ContextKind
type ContextKind struct {
	...
	// Alias for archived.
	HideInTargeting *bool `json:"hideInTargeting,omitempty"`
...
func (o *ContextKind) GetHideInTargeting() bool {
	if o == nil || o.HideInTargeting == nil {
		var ret bool
		return ret
	}
	return *o.HideInTargeting
}

// GetHideInTargetingOk returns a tuple with the HideInTargeting field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ContextKind) GetHideInTargetingOk() (*bool, bool) {
	if o == nil || o.HideInTargeting == nil {
		return nil, false
	}
	return o.HideInTargeting, true
}
...
func (o ContextKind) MarshalJSON() ([]byte, error) {
	...
	if o.HideInTargeting != nil {
		toSerialize["hideInTargeting"] = o.HideInTargeting
	}
	if o.Archived != nil {
...
type NullableContextKind struct {
	value *ContextKind
	isSet bool
}

func (v NullableContextKind) Get() *ContextKind {
	return v.value
}

func (v *NullableContextKind) Set(val *ContextKind) {
	v.value = val
	v.isSet = true
}

func (v NullableContextKind) IsSet() bool {
	return v.isSet
}

func (v *NullableContextKind) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContextKind(val *ContextKind) *NullableContextKind {
	return &NullableContextKind{value: val, isSet: true}
}

func (v NullableContextKind) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContextKind) UnmarshalJSON(src []byte) error {
	v.isSet = true
