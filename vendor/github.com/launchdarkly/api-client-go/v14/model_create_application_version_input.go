...
// CreateApplicationVersionInput struct for CreateApplicationVersionInput
...
func NewCreateApplicationVersionInput(key string, name string) *CreateApplicationVersionInput {
	this := CreateApplicationVersionInput{}
	this.Key = key
	this.Name = name
	return &this
}
...
func (o CreateApplicationVersionInput) MarshalJSON() ([]byte, error) {
...
type NullableCreateApplicationVersionInput struct {
	value *CreateApplicationVersionInput
	isSet bool
}

func (v NullableCreateApplicationVersionInput) Get() *CreateApplicationVersionInput {
	return v.value
}

func (v *NullableCreateApplicationVersionInput) Set(val *CreateApplicationVersionInput) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateApplicationVersionInput) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateApplicationVersionInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateApplicationVersionInput(val *CreateApplicationVersionInput) *NullableCreateApplicationVersionInput {
	return &NullableCreateApplicationVersionInput{value: val, isSet: true}
}

func (v NullableCreateApplicationVersionInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateApplicationVersionInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
