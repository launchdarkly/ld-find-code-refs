...
type ApiGetReleaseByFlagKeyRequest struct {
	ctx context.Context
	ApiService *ReleasesBetaApiService
	projectKey string
	flagKey string
}
...
func (r ApiPatchReleaseByFlagKeyRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *ReleasesBetaApiService) PatchReleaseByFlagKeyExecute(r ApiPatchReleaseByFlagKeyRequest) (*http.Response, error) {
	var (
