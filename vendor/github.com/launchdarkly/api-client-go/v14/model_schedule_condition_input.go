...
type NullableScheduleConditionInput struct {
	value *ScheduleConditionInput
	isSet bool
}

func (v NullableScheduleConditionInput) Get() *ScheduleConditionInput {
	return v.value
}

func (v *NullableScheduleConditionInput) Set(val *ScheduleConditionInput) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleConditionInput) IsSet() bool {
	return v.isSet
}
...
func NewNullableScheduleConditionInput(val *ScheduleConditionInput) *NullableScheduleConditionInput {
	return &NullableScheduleConditionInput{value: val, isSet: true}
}
