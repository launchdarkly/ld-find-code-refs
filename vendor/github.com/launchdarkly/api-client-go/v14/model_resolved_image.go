...
// GetIsAvatarOk returns a tuple with the IsAvatar field value if set, nil otherwise
...
// GetIsIconOk returns a tuple with the IsIcon field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResolvedImage) GetIsIconOk() (*bool, bool) {
	if o == nil || o.IsIcon == nil {
		return nil, false
	}
	return o.IsIcon, true
}
...
func (o ResolvedImage) MarshalJSON() ([]byte, error) {
	...
	if o.IsAvatar != nil {
		toSerialize["isAvatar"] = o.IsAvatar
	}
	if o.IsIcon != nil {
		toSerialize["isIcon"] = o.IsIcon
	}
	if o.SourceUrl != nil {
...
func (v NullableResolvedImage) Get() *ResolvedImage {
	return v.value
}
...
func NewNullableResolvedImage(val *ResolvedImage) *NullableResolvedImage {
	return &NullableResolvedImage{value: val, isSet: true}
}
