...
func (o *ScheduleConditionOutput) GetWaitDurationUnit() string {
	if o == nil || o.WaitDurationUnit == nil {
		var ret string
		return ret
	}
	return *o.WaitDurationUnit
}

// GetWaitDurationUnitOk returns a tuple with the WaitDurationUnit field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ScheduleConditionOutput) GetWaitDurationUnitOk() (*string, bool) {
	if o == nil || o.WaitDurationUnit == nil {
		return nil, false
	}
	return o.WaitDurationUnit, true
}
...
func (o *ScheduleConditionOutput) SetWaitDurationUnit(v string) {
	o.WaitDurationUnit = &v
}

func (o ScheduleConditionOutput) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.ScheduleKind != nil {
		toSerialize["scheduleKind"] = o.ScheduleKind
	}
	if o.ExecutionDate != nil {
		toSerialize["executionDate"] = o.ExecutionDate
	}
	if o.WaitDuration != nil {
		toSerialize["waitDuration"] = o.WaitDuration
	}
	if o.WaitDurationUnit != nil {
		toSerialize["waitDurationUnit"] = o.WaitDurationUnit
	}
	return json.Marshal(toSerialize)
}

type NullableScheduleConditionOutput struct {
	value *ScheduleConditionOutput
	isSet bool
}

func (v NullableScheduleConditionOutput) Get() *ScheduleConditionOutput {
	return v.value
}

func (v *NullableScheduleConditionOutput) Set(val *ScheduleConditionOutput) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleConditionOutput) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleConditionOutput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleConditionOutput(val *ScheduleConditionOutput) *NullableScheduleConditionOutput {
	return &NullableScheduleConditionOutput{value: val, isSet: true}
}
