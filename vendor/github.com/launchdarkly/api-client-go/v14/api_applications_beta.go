...
func (r ApiCreateApplicationRequest) CreateApplicationInput(createApplicationInput CreateApplicationInput) ApiCreateApplicationRequest {
	r.createApplicationInput = &createApplicationInput
	return r
}

func (r ApiCreateApplicationRequest) Execute() (*ApplicationRep, *http.Response, error) {
	return r.ApiService.CreateApplicationExecute(r)
}

/*
CreateApplication Post application
...
func (a *ApplicationsBetaApiService) CreateApplicationExecute(r ApiCreateApplicationRequest) (*ApplicationRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ApplicationRep
	)
	...
	if r.createApplicationInput == nil {
		return localVarReturnValue, nil, reportError("createApplicationInput is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createApplicationInput
	if r.ctx != nil {
...
func (a *ApplicationsBetaApiService) DeleteApplicationExecute(r ApiDeleteApplicationRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationsBetaApiService.DeleteApplication")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/applications/{applicationKey}"
	localVarPath = strings.Replace(localVarPath, "{"+"applicationKey"+"}", url.PathEscape(parameterToString(r.applicationKey, "")), -1)
...
func (a *ApplicationsBetaApiService) DeleteApplicationVersionExecute(r ApiDeleteApplicationVersionRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationsBetaApiService.DeleteApplicationVersion")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/applications/{applicationKey}/versions/{versionKey}"
	localVarPath = strings.Replace(localVarPath, "{"+"applicationKey"+"}", url.PathEscape(parameterToString(r.applicationKey, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"versionKey"+"}", url.PathEscape(parameterToString(r.versionKey, "")), -1)
...
func (a *ApplicationsBetaApiService) GetApplicationVersionsExecute(r ApiGetApplicationVersionsRequest) (*ApplicationVersionsCollectionRep, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ApplicationVersionsCollectionRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationsBetaApiService.GetApplicationVersions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/applications/{applicationKey}/versions"
	localVarPath = strings.Replace(localVarPath, "{"+"applicationKey"+"}", url.PathEscape(parameterToString(r.applicationKey, "")), -1)
...
func (a *ApplicationsBetaApiService) GetApplicationsExecute(r ApiGetApplicationsRequest) (*ApplicationCollectionRep, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ApplicationCollectionRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationsBetaApiService.GetApplications")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiPatchApplicationVersionRequest struct {
	ctx context.Context
	ApiService *ApplicationsBetaApiService
	applicationKey string
	versionKey string
...
func (r ApiPatchApplicationVersionRequest) Execute() (*ApplicationVersionRep, *http.Response, error) {
	return r.ApiService.PatchApplicationVersionExecute(r)
}
...
Update an application version. You can update the `supported` field. Requires a [JSON patch](https://datatracker.ietf.org/doc/html/rfc6902) representation of the desired changes to the application version. To learn more, read [Updates](/#section/Overview/Updates).
 ...
 @param applicationKey The application key
 @param versionKey The application version key
 @return ApiPatchApplicationVersionRequest
*/
...
func (a *ApplicationsBetaApiService) PatchApplicationVersionExecute(r ApiPatchApplicationVersionRequest) (*ApplicationVersionRep, *http.Response, error) {
	var (
		...
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ApplicationVersionRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationsBetaApiService.PatchApplicationVersion")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiPostApplicationVersionRequest struct {
	ctx context.Context
	ApiService *ApplicationsBetaApiService
	applicationKey string
	createApplicationVersionInput *CreateApplicationVersionInput
}

func (r ApiPostApplicationVersionRequest) CreateApplicationVersionInput(createApplicationVersionInput CreateApplicationVersionInput) ApiPostApplicationVersionRequest {
	r.createApplicationVersionInput = &createApplicationVersionInput
	return r
}

func (r ApiPostApplicationVersionRequest) Execute() (*ApplicationVersionRep, *http.Response, error) {
	return r.ApiService.PostApplicationVersionExecute(r)
}

/*
PostApplicationVersion Post application version

Create an application version

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param applicationKey The application key
 @return ApiPostApplicationVersionRequest
*/
func (a *ApplicationsBetaApiService) PostApplicationVersion(ctx context.Context, applicationKey string) ApiPostApplicationVersionRequest {
	return ApiPostApplicationVersionRequest{
		ApiService: a,
		ctx: ctx,
		applicationKey: applicationKey,
...
// Execute executes the request
//  @return ApplicationVersionRep
func (a *ApplicationsBetaApiService) PostApplicationVersionExecute(r ApiPostApplicationVersionRequest) (*ApplicationVersionRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationsBetaApiService.PostApplicationVersion")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createApplicationVersionInput == nil {
		return localVarReturnValue, nil, reportError("createApplicationVersionInput is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createApplicationVersionInput
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
