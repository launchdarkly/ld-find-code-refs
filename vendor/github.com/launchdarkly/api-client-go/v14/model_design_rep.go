...
// DesignRep struct for DesignRep
...
func (o DesignRep) MarshalJSON() ([]byte, error) {
...
type NullableDesignRep struct {
	value *DesignRep
	isSet bool
}

func (v NullableDesignRep) Get() *DesignRep {
	return v.value
}

func (v *NullableDesignRep) Set(val *DesignRep) {
	v.value = val
	v.isSet = true
}

func (v NullableDesignRep) IsSet() bool {
	return v.isSet
}

func (v *NullableDesignRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDesignRep(val *DesignRep) *NullableDesignRep {
	return &NullableDesignRep{value: val, isSet: true}
}

func (v NullableDesignRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDesignRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
