...
func (o *FlagDefaults) GetBooleanDefaults() BooleanDefaults {
	if o == nil || o.BooleanDefaults == nil {
		var ret BooleanDefaults
		return ret
	}
	return *o.BooleanDefaults
}

// GetBooleanDefaultsOk returns a tuple with the BooleanDefaults field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
func (v NullableFlagDefaults) Get() *FlagDefaults {
	return v.value
}
...
func NewNullableFlagDefaults(val *FlagDefaults) *NullableFlagDefaults {
	return &NullableFlagDefaults{value: val, isSet: true}
}
