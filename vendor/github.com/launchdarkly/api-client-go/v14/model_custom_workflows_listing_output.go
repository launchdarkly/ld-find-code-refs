...
func NewCustomWorkflowsListingOutput(items []CustomWorkflowOutput, totalCount int32, links map[string]Link) *CustomWorkflowsListingOutput {
	this := CustomWorkflowsListingOutput{}
	this.Items = items
...
type NullableCustomWorkflowsListingOutput struct {
	value *CustomWorkflowsListingOutput
	isSet bool
}
...
func NewNullableCustomWorkflowsListingOutput(val *CustomWorkflowsListingOutput) *NullableCustomWorkflowsListingOutput {
	return &NullableCustomWorkflowsListingOutput{value: val, isSet: true}
}
