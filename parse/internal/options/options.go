...
var options = optionMap{
	...
	Dir:               option{"", "Path to existing checkout of the git repo. If a cloneEndpoint is provided, this option is not required.", true},
	Exclude:           option{"", `A regular expression (PCRE) defining the files and directories which the flag parser should exclude. Example: "vendor/"`, false},
