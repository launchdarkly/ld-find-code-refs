...
This operation requires your environment to be authenticated for remote access via ssh. Branch cleanup is not currently supported when running `ld-find-code-refs` via Github actions or Bitbucket pipelines.
