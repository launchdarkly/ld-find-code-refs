...
jobs:
  launchDarklyCodeReferences:
    ...
    - name: LaunchDarkly Code References
      uses: launchdarkly/find-code-references@v2.18.2
      with:
...
jobs:
  launchDarklyCodeReferences:
    ...
    - name: LaunchDarkly Code References
      ...
      uses: launchdarkly/find-code-references/docker@v2.18.2
      with:
        accessToken: ${{ secrets.LD_ACCESS_TOKEN }}
        projKey: LD_PROJECT_KEY
        dockerImage: your.registry.example/launchdarkly/ld-find-code-refs-github-action:2.18.2
```
